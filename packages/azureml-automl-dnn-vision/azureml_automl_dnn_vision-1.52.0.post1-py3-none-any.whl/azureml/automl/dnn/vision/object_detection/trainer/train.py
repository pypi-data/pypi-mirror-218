...
def train(model, optimizer, scheduler, train_data_loader, val_data_loader,
    ...
    log_training_metrics = settings.get(CommonSettingsLiterals.LOG_TRAINING_METRICS, False)
    log_validation_loss = settings.get(CommonSettingsLiterals.LOG_VALIDATION_LOSS, False)
