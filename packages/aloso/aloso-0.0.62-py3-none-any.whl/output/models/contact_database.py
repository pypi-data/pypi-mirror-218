...
class Contacts(Base, Contact):
    ...
    sites = relationship("Sites", secondary="Sites_Contacts", overlaps="contacts", lazy="noload")
    labels = relationship("Labels", secondary="Labels_Contacts", overlaps="contacts", lazy="noload")
