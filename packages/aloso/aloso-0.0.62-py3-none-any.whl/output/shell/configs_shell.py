...
class ConfigsShell(ConfigsManagement):
    ...
    @staticmethod
    def salt_file_content(list_data: list[str] = None, salt_file: str = config.salt_file,
    ...
    @staticmethod
    def generate_salt(salt_file: str = config.salt_file, clear_salt: str = config.clear_salt):
    ...
    @staticmethod
    def desalt_file_content(my_config_value: str = config.salted_name, salt_file: str = config.salt_file):
    ...
    def delete_salt(salted_name: str, salt_file: str = config.salt_file):
        ...
        ConfigsShell.salt_file_content(new_list, salt_file=salt_file)
