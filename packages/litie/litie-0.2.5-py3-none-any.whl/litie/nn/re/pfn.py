...
from ...layers.pfn import PfnEncoder, NerUnit, ReUnit
...
def get_auto_pfn_re_model(
    ...
    class PFN(parent_model):
        ...
        def __init__(self, config):
            ...
            self.re_head = ReUnit(self.pfn_hidden_size, config.num_predicates, classifier_dropout)
            self.re_tail = ReUnit(self.pfn_hidden_size, config.num_predicates, classifier_dropout)
...
def get_pfn_re_model_config(predicates, **kwargs):
