...
@add_start_docstrings(
    """
    RoFormer Model with a spn classification head on top for extractive question-answering tasks like SQuAD (a linear
    layers on top of the hidden-states output to compute `spn start logits` and `spn end logits`).
    """,
    ROFORMER_START_DOCSTRING,
)
