...
from ...datasets.utils import tensor_to_cpu, seq_len_to_mask, tensor_to_list
from ...utils.imports import TORCH_SCATTER_AVAILABLE
...
def get_cnn_ner_model_config(labels: list, **kwargs):
