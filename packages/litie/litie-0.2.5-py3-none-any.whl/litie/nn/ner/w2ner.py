...
from ...layers import DilateConvLayer, LayerNorm
...
def get_auto_w2ner_ner_model(
    ...
    class W2Ner(parent_model):
        ...
        def __init__(self, config):
            ...
            biaffine_size, ffn_hidden_size = getattr(config, "biaffine_size", 512), getattr(config, "ffn_hidden_size",
                                                                                            288)
...
def get_w2ner_model_config(labels: list, **kwargs):
