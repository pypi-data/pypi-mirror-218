...
from ..datasets import AutoReDataModule
from ..engines import ReEngine


class AutoRelationExtractionModel(BaseModel):

    config_name = "Relation Extraction"
    ...
    def create_data_module(
        ...
        return AutoReDataModule.create(
            self.task_model_name,
            self.tokenizer,
            labels=labels,
