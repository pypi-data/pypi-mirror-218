...
class DataHandler(object):
    ...
    def plot_sleep_data(self, plot_spectral=True, plot_acc=True, plot_staging=True, plot_variables=True, savefig=None):
        ...
        fig_height = subplot_count * 5
        fig, ax = plt.subplots(subplot_count, 1, figsize=(16, fig_height))
    ...
    def sw_detect(self, hypno_mask=(0, 1), freq_sw=(0.3, 1.5), dur_neg=(0.1, 1), dur_pos=(0.3, 1.5), amp_neg=(20, 200),
                  amp_pos=(15, 150), amp_ptp=(45, 350), coupling=False, coupling_params=None):
