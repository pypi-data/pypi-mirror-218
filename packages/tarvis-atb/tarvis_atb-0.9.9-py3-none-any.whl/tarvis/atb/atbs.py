...
def run(
    ...
    try:
        ...
        def _renamed_attr(d: dict, old_name: str, new_name: str) -> any:
            old_value = d.pop(old_name, None)
            value = d.pop(new_name, None)
        ...
        if not bots:
            ...
            for bot_config in bots:
                ...
                _renamed_attr(bot_config, "quote_asset", "indicator_quote_asset")
                ...
                if config_logging:
                    logging.info(
                        ...
                        extra={"config": copy.copy(bot_config)},
                    )
