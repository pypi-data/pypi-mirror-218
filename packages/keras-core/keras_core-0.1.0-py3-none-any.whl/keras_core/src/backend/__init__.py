...
from keras_core.src.backend.common.variables import get_autocast_scope
...
from keras_core.src.backend.common.variables import standardize_shape
...
from keras_core.src.backend.config import standardize_data_format
from keras_core.src.utils.io_utils import print_msg
