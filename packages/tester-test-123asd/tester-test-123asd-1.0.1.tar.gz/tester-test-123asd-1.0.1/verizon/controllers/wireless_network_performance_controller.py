...
class WirelessNetworkPerformanceController(BaseController):
    ...
    def near_real_time_network_conditions(self,
                                          body):
        """Does a POST request to /v1/intelligence/network-conditions.
        ...
        return super().new_api_call_builder.request(
            ...
            .path('/v1/intelligence/network-conditions')
    ...
    def domestic_4_g_and_5g_nationwide_network_coverage(self,
                                                        body):
        """Does a POST request to /v1/intelligence/wireless-coverage.
        ...
        return super().new_api_call_builder.request(
            RequestBuilder().server(Server.M2M)
            .path('/v1/intelligence/wireless-coverage')
            .http_method(HttpMethodEnum.POST)
            .header_param(Parameter()
                          .key('Content-Type')
                          .value('application/json'))
    ...
    def site_proximity(self,
                       body):
        """Does a POST request to /v1/intelligence/site-proximity/action/list.
        ...
        return super().new_api_call_builder.request(
            RequestBuilder().server(Server.M2M)
            .path('/v1/intelligence/site-proximity/action/list')
            .http_method(HttpMethodEnum.POST)
            .header_param(Parameter()
                          .key('Content-Type')
                          .value('application/json'))
    ...
    def device_experience_30_days_history(self,
                                          body):
        """Does a POST request to /v1/intelligence/device-experience/history/30-days.
        ...
        return super().new_api_call_builder.request(
            RequestBuilder().server(Server.M2M)
            .path('/v1/intelligence/device-experience/history/30-days')
            .http_method(HttpMethodEnum.POST)
            .header_param(Parameter()
                          .key('Content-Type')
                          .value('application/json'))
    ...
    def device_experience_bulk_latest(self,
                                      body):
        """Does a POST request to /v1/intelligence/device-experience/bulk/latest.
        ...
        return super().new_api_call_builder.request(
            RequestBuilder().server(Server.M2M)
            .path('/v1/intelligence/device-experience/bulk/latest')
            .http_method(HttpMethodEnum.POST)
            .header_param(Parameter()
                          .key('Content-Type')
                          .value('application/json'))
