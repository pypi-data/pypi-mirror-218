    ...
    def add_user_wework_media(self, zbx_user: dict, update=False, prefix=False):
        ...
        if wework_media:
            for media in wework_media:
                ...
                if sendto and len(sendto.split("_")) == 1 and prefix:
                ...
                if sendto and len(sendto.split("_")) == 2 and \
                        sendto.split("_")[0] != self._corpid and prefix:
                    add_media.update({"mediatypeid": typeid})
                    zbx_user_medias.append(add_media)
                    ...
                    media.update(
                        {
                            ...
                            sendto and len(sendto.split("_")) == 2 else wework_userid
                        }
                    )
                    logging.info(
