...
3. Add `federated-index` to the `ckan.plugins` setting in your CKAN
...
**TODO:** Document any optional config settings here. For example:
	...
	# (optional, default: 24).
	ckanext.federated_index.some_setting = some_default_value
...
## Releasing a new version of ckanext-federated-index

If ckanext-federated-index should be available on PyPI you can follow these steps to publish a new version:
