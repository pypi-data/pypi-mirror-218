...
# postRequestCallback = Callable[[Request, TIn], TIn]
# getManyRequestCallback = Callable[[Request, Optional[Dict], Optional[int]], List[TIn]]
# getOneRequestCallback = Callable[[Request, str], TIn]
# putRequestCallback = Callable[[Request, str, Dict], TIn]
# deleteRequestCallback = Callable[[Request, str], bool]
# jsonRequestCallback = Callable[[Request, str], TIn]

requestCallback = Callable[[Request, TIn], TResp]

def request_handler(request: Request, item: TIn, callback: requestCallback, redirect_url: str=None) -> TResp:
    code = None
    msg = None
    er = None
    ret = None
    ...
    try:
        ret = callback(request, item)
        logger.info(f"Callback Successful executed for {request.method}")
...
# def post_request_handler(request: Request, item: TIn, on_post_callback: postRequestCallback) -> TIn:
#     code = None
#     msg = None
#     er = None
#
...
#
#
# def getmany_request_handler(request: Request, on_getmany_callback: getManyRequestCallback, query: Dict = None, limit: int = None) -> List[TIn]:
#     code = None
#     msg = None
#     er = None
#
...
#
#
# def getone_request_handler(id: str, request: Request, obj_type: type, on_getone_callback: getOneRequestCallback) -> List[TIn]:
#     code = None
#     msg = None
#
#     try:
