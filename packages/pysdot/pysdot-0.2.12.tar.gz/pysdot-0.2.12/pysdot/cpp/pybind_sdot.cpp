...
#include "../../ext/sdot/src/sdot/PowerDiagram/get_image_of_cell_nums.h"
...
namespace {
    ...
    template<class Domain,class Grid,class FUNC>
    pybind11::array_t<std::size_t> get_image_of_cell_nums( pybind11::array_t<TF> &positions, pybind11::array_t<TF> &weights, Domain &domain, Grid &grid, const FUNC &func, pybind11::array_t<TF> &beg, pybind11::array_t<TF> &end, pybind11::array_t<std::size_t> &nbp ) {
        auto ptr_positions = reinterpret_cast<const typename Grid::Pt *>( positions.data() );
        auto ptr_weights = reinterpret_cast<const typename Grid::TF *>( weights.data() );
        auto ptr_nbp = reinterpret_cast<const std::size_t *>( nbp.data() );
        auto ptr_beg = reinterpret_cast<const TF *>( beg.data() );
        ...
        pybind11::array_t<std::size_t> res;
        res.resize( a_nbp );

        find_radial_func( func, [&]( const auto &ft ) {
            sdot::get_image_of_cell_nums( res.mutable_data(), grid, domain, ptr_positions, ptr_weights, positions.shape( 0 ), ft, a_beg, a_end, a_nbp );
        } );
    ...
    struct PyPowerDiagramZGrid {
        ...
        #define DEF_FOR( NAME, DOMAIN, FUNC ) \
            ...
            pybind11::array_t<std::size_t> image_of_cell_nums_##NAME( pybind11::array_t<PD_TYPE> &positions, pybind11::array_t<PD_TYPE> &weights, DOMAIN<dim,TF> &domain, const FUNC &func, pybind11::array_t<TF> &beg, pybind11::array_t<TF> &end, pybind11::array_t<std::size_t> &nb_pixels ) { \
                return get_image_of_cell_nums( positions, weights, domain.bounds, grid, func, beg, end, nb_pixels ); \
            } \
...
PYBIND11_MODULE( PD_MODULE_NAME, m ) {
    ...
    pybind11::class_<PowerDiagramZGrid>( m, "PowerDiagramZGrid" )
        ...
        #define DEF_FOR( NAME, DOMAIN, FUNC ) \
                ...
                .def( "image_of_cell_nums"                                  , &PowerDiagramZGrid::image_of_cell_nums_##NAME                                  , "" ) \
