...
ENTITY_GTS_DNS_ZONE="gts-traffic-zone"

@common.transports.rbac_token_middleware("show")
def show(cli: Dingman_grpc_cli, req: Request) -> Response:
    """Processes a request on the /show endpoint for gts dns zones.

    /show?gts-traffic-zone=my-gts-traffic-zone,queue=optional
    """
...
def add(cli: Dingman_grpc_cli, req: Request) -> Response:
    """Processes a request on the /add endpoint for gts dns zones.
    """
...
def delete(cli: Dingman_grpc_cli, req: Request) -> Response:
    """Processes a request on the /delete endpoint for gts dns zones.
    """
...
def set(cli: Dingman_grpc_cli, req: Request) -> Response:
    """Processes a request on the /set endpoint for gts dns zones.
    """
