...
class Workload(Model):
    ...
    def __init__(self, name=None, workload_type=None, namespace=None, annotations=None, labels=None, replicas=None, label_selector=None, update_strategy=None, pod=None, service_name=None):  # noqa: E501
    ...
    def workload_type(self, workload_type):
        ...
        :type workload_type: str
        """
        allowed_values = ["Deployment", "StatefulSet", "DaemonSet"]  # noqa: E501
