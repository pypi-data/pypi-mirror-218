...
class CfnOrganization(
    ...
    :link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-organizations-organization.html
    :exampleMetadata: fixture=_generated
    ...
    def feature_set(self) -> typing.Optional[builtins.str]:
        ...
        :link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-organizations-organization.html#cfn-organizations-organization-featureset
        '''
