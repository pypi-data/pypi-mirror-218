...
class CfnChannel(
    ...
    def preset(self) -> typing.Optional[builtins.str]:
        ...
        :link: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ivs-channel.html#cfn-ivs-channel-preset
        '''
