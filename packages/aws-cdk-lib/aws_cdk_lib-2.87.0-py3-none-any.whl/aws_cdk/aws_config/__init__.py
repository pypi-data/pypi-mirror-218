...
class CfnConfigRule(
    ...
    .. epigraph::
       ...
       You must first create and start the AWS Config configuration recorder in order to create AWS Config managed rules with AWS CloudFormation . For more information, see `Managing the Configuration Recorder <https://docs.aws.amazon.com/config/latest/developerguide/stop-start-recorder.html>`_ .
