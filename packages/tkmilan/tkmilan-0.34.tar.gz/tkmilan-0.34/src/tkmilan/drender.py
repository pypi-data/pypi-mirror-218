...
class Renderer_TkCanvas:
    ...
    def redraw(self, _a1: typing.Any = None, _a2: typing.Any = None, *,
        ...
        redraw_bg = force or (current_size != self._previous_size)
        redraw_fg = force or True  # TODO: Implement state tracker
        if redraw_bg and redraw_fg:
            if __debug__:
    ...
    def render_Text(self, de: diagram.Text, *, extratags: typing.Sequence[str] = tuple()) -> int:
        ...
        return self.cv.create_text(  # type: ignore[call-overload, no-any-return]
            list(de.point.tuple), text=de.text,
            tags=(*de.tags, *extratags),
            # # Alignment
            anchor=de.anchor.value, justify=de.justify.value, angle=str(de.angle),
            # Font Configuration
            font=de.font,
            # Colours
