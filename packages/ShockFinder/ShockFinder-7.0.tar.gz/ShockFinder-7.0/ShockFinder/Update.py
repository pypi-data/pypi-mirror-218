...
try:
	...
	LoaderDir=os.path.join("ShockFinder","Addon","Loader")
	AnalysisToolDir=os.path.join("ShockFinder","Addon","AnalysisTool")
	PainterDir=os.path.join("ShockFinder","Addon","Painter")
	IODir=os.path.join("ShockFinder","Addon","IO")
	MultiprocessEngineDir=os.path.join("ShockFinder","Addon","MultiprocessEngine")
	GUIDir=os.path.join("ShockFinder","Addon","GUI")
except:
