...
def Equilibrium(rb,lam,mach,gamma=4/3,rs=1,eng=0,theta_inj=0,steps=10000):
	...
	quantities["Accretion_vR"]=np.array([cal_vR(math.sin(i)) for i in np.arange(quantities["Accretion_x2_beg"],quantities["Accretion_x2_end"],(quantities["Accretion_x2_end"]-quantities["Accretion_x2_beg"])/steps)])
	quantities["Accretion_InjFlux"]=Differential.integrate_sph_sur(quantities["Accretion_vR"],rb,np.arange(quantities["Accretion_x2_beg"],quantities["Accretion_x2_end"],(quantities["Accretion_x2_end"]-quantities["Accretion_x2_beg"])/steps))
...
def Unit(mass,injflux,injrho,hequantities,basic_m=Msun,basic_r=2*G/c**2,basic_v=c):
	quantities={}
	quantities["unit_r"]=mass*basic_r*basic_m
