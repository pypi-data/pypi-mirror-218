...
class WsPongHandler(WebSocketMixin, WebSocketHandler, JupyterHandler):
    """WsEchoHandler"""
...
def setup_handlers(web_app):
    ...
    route_pattern = url_path_join(base_url, "jupyter_operator", "get_example")
    echo_pattern = url_path_join(base_url, "jupyter_operator", "echo")
    handlers = [
