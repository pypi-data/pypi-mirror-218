...
class DatalayerExampleExtensionApp(ExtensionAppJinjaMixin, ExtensionApp):
    ...
    def initialize_handlers(self):
        handlers = [
            ("jupyter_operator", IndexHandler),
            (url_path_join("jupyter_operator", "get_config"), ConfigHandler),
            (url_path_join("jupyter_operator", "echo"), WsEchoHandler),
            (url_path_join("jupyter_operator", "relay"), WsRelayHandler),
            (url_path_join("jupyter_operator", "proxy"), WsProxyHandler),
            (url_path_join("jupyter_operator", "pong"), WsPongHandler),
        ]
