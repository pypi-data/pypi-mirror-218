...
class FileUnzippedBookmark(IngestBookmark):
    def __init__(
        self,
        unzipped_file: FilePath,
        unzipped_file_local_uri: URI,
        compressed_file: FilePath,
        compressed_file_local_uri: URI,
        stream_name: str,
        unzipped_file_remote_uri: URI,
        compressed_file_remote_uri: URI ,
        pipeline_name: str = "",
        ...
        additional_data = {
            ...
            "unzipped_file_remote_uri": str(unzipped_file_remote_uri) if unzipped_file_remote_uri else "",
            "unzipped_file": str(unzipped_file),
            "unzipped_file_local_uri": str(unzipped_file_local_uri)
        }

        title = f"unzip:{str(unzipped_file)}"
        super().__init__(
            title=title,
        ...
        self.unzipped_file = unzipped_file
        self.unzipped_file_local_uri = unzipped_file_local_uri
        self.unzipped_file_remote_uri = unzipped_file_remote_uri
