...
class PipeHandle:
    ...
    def __init__(self, pipeName:str=None) -> None:
        ...
        """
        # initialize instance.
        self.__fIsInvalid:bool = True
        self.__fHandle = PipeHandle.OpenPipe(pipeName)
        self.__fHResult:int = 0

        # if we made it here, then the open pipe was successful.
        self.__fIsInvalid:bool = False
