...
class OptionsParser:
    ...
    def __RaiseOptionFoundEvent(self, protocol:str, key:str, value:str) -> None:
        """
        ...
        try:
            ...
            args:OptionFoundEventArgs = OptionFoundEventArgs(protocol, key, value)
    ...
    def Parse(self, protocol:str, options:str) -> None:
        ...
        ```python
        .. include:: ../docs/include/samplecode_optionsparser.md
        ```
        </details>
        """
        if (protocol == None):
            raise ArgumentNullException("protocol")
        if (options == None):
            raise ArgumentNullException("options")
        ...
        while (i < parselen - 1):
            ...
            self.__RaiseOptionFoundEvent(protocol, key.strip(), value.strip())
