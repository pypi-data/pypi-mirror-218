...
class PipeStream(BytesIO):
    ...
    def flush(self) -> None:
        ...
        try:
            ...
            retcode, nBytesWritten = win32file.WriteFile(self.__fPipeHandle, data[0:datalen])
            ...
            # close the handle.
            if (self.__fPipeHandle != None):
                win32file.CloseHandle(self.__fPipeHandle)
    ...
    def read(self, size:int) -> bytes:
        ...
        retcode, data = win32file.ReadFile(self.__fPipeHandle, 0x2000)
