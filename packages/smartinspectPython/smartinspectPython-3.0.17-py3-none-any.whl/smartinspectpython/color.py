...
class Color:
    ...
    def __init__(self, value: int) -> None:
        ...
        # initialize instance.
        #self.__init__(value, Color._StateNameValid, "FromValue", "")
        self.__InitializeWithState(value, Color._StateNameValid, "FromValue", "")
    ...
    #            Integer value that represents the ARGB components of the color.
    #        state
    #            The state in which the Color object is to be placed at initialization.
    #        name
    ...
    #    # validations.
    #    if (value > Color._MaxValueUInt):
    #        raise ArgumentError(None, Color._InvalidEx2BoundArgument.format("value", value, 0, Color._MaxValueUInt))
    ...
    def A(self) -> int:
        ...
        """
        return ((self.__Value >> Color._ARGBAlphaShift) & Color._MaxValueByte)
    ...
    def B(self) -> int:
        ...
        """
        return ((self.__Value >> Color._ARGBBlueShift) & Color._MaxValueByte)
    ...
    def G(self) -> int:
        ...
        """
        return ((self.__Value >> Color._ARGBGreenShift) & Color._MaxValueByte)
    ...
    def R(self) -> int:
        ...
        """
        return ((self.__Value >> Color._ARGBRedShift) & Color._MaxValueByte)
    ...
    #    """
    #    if value == None:
    #        self.__Value = Color.NotDefinedValue
    #    else:
    #        self.__Value = value
    ...
    def ValueHex(self) -> int:
        ...
        """
        return "0x" + "{:08x}".format(self.__Value).upper()


    def __InitializeWithState(self, value: int, state: int, name: str, knownColor: str) -> None:
        """
        Initializes a new instance of the class.
    ...
    @staticmethod
    def __MakeArgb(alpha: int, red: int, green: int, blue: int) -> int:
        """
        ...
        """
        return (red << 16 | green << 8 | blue | alpha << 24) & Color._MaxValueUInt
    ...
    def CheckByte(value: int, name: str) -> None:
        ...
        """
        if (value < 0) or (value > Color._MaxValueByte):
            raise ArgumentError(None, Color._InvalidEx2BoundArgument.format(name, value, 0, 0xFF))
    ...
    def FromArgb(alpha: int, red: int, green: int, blue: int):
        ...
        oColor = Color(Color.__MakeArgb(alpha, red, green, blue))
        oColor.__Name = "FromArgb"
        return oColor
    ...
    def FromRgb(red: int, green: int, blue: int):
        ...
        # create color object and set properties as to how its value was derived.
        oColor = Color.FromArgb(0, red, green, blue)
        oColor.__Name = "FromRgb"
        return oColor
