...
from .connectionfoundeventargs import ConnectionFoundEventArgs
...
class ConnectionsParser:
    ...
    def __RaiseConnectionFoundEvent(self, name:str, options:str) -> None:
        """
        ...
        try:
            ...
            args:ConnectionFoundEventArgs = ConnectionFoundEventArgs(name, options)
    ...
    def Parse(self, connections:str) -> None:
        ...
        please refer to the documentation of the Protocol.connections
        property.

        <details>
            <summary>View Sample Code</summary>
        ```python
        .. include:: ../docs/include/samplecode_connectionsparser.md
        ```
        </details>
        """
        if (connections == None):
        ...
        while (i < parselen - 1):
            ...
            self.__RaiseConnectionFoundEvent(name, options)
