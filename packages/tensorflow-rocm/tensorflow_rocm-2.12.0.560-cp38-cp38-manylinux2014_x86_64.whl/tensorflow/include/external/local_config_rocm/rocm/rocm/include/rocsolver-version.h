...
#error "This file is deprecated. Use the header file from /opt/rocm-5.6.0/include/rocsolver/rocsolver-version.h by using #include <rocsolver/rocsolver-version.h>"
#else  /* ROCM_HEADER_WRAPPER_WERROR 0 */
/* give warning */
#if defined(_MSC_VER)
#pragma message(": warning:This file is deprecated. Use the header file from /opt/rocm-5.6.0/include/rocsolver/rocsolver-version.h by using #include <rocsolver/rocsolver-version.h>")
#elif defined(__GNUC__)
#warning "This file is deprecated. Use the header file from /opt/rocm-5.6.0/include/rocsolver/rocsolver-version.h by using #include <rocsolver/rocsolver-version.h>"
#endif
...
#define ROCSOLVER_VERSION_MINOR 22
#define ROCSOLVER_VERSION_PATCH 0
#define ROCSOLVER_VERSION_TWEAK a220f13
// clang-format on
