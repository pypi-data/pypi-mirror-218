#This code is originally from https://github.com/AnimaTardeb/G4Hunter.git
...
class Soft(object):
    ...
    def plot2(self,liste, repert, i):
        ...
        plt.ylabel('Score')
        plt.grid(True)
        figure.savefig(str(repert)+'Score_plot_'+str(i)+'.pdf', dpi=figure.dpi)
...
'''if __name__ == "__main__":
  ...
  # Construct the full file path
        file_path = os.path.join(inputfile, file)
        ...
        Res1file= open (outputfile +"/"+DIR+"/"+"-W"+ str(window)+"-S"+str(score)+".txt", "a")
        Res2file= open (outputfile +"/"+DIR+"/"+"-G4_Merged.txt", "a")
    #=========================================
