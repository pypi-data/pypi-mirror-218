...
API_KEY_IS_NOT_SET = "Comet API key is not set. You'll have to provide it explicitly to experiments and API"
...
REMOTE_MODEL_DOWNLOAD_FAILED = "Asset %r of the remote model '%s/%s:%s' download failed"
...
REMOTE_MODEL_DOWNLOAD_FILE_OVERWRITTEN = (
    "File %r has been overwritten by asset %s of remote model version %s"
)
