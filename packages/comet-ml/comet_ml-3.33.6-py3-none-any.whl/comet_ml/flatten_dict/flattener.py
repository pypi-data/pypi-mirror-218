...
class FlattenDictionaryOp:
    def __init__(self, separator: str, max_depth_limit: int = 10):
    ...
    def flatten(self, d: Dict[str, Any]) -> FlattenDictionaryOpResult:
        self._flatten(d, depth=1)
    ...
    def _flatten(
        self, d: Mapping, depth: int, parent_key: Optional[str] = None
    ) -> bool:
        has_child = False
...
def flatten_dict(
    d: Dict[str, Any], separator: str = DELIMITER, max_depth: int = 10
