...
class AddressShip(object):
    ...
    def __init__(self, first_name=None, last_name=None, address1=None, address2=None, county=None, city=None, state=None, country='中国', zip='.', tin=None, phone=None, country_code=None, id_card=None, email=None, company=None, ecommerce_website_user_id=None, local_vars_configuration=None):  # noqa: E501
