...
class CloudFunctionalVerificationController(BaseController):
    ...
    def verify_service(self, cloud_id: str, cloud_provider: CloudProviders) -> bool:
        ...
        with self._create_task(
            ...
            try:
                ...
                return False
            terminate_service_task.update(
                True, "[bold green]Service termination initiated.", completed=True
            )
    ...
    def start_verification(
        ...
        confirmation_message = [
            ...
            f"It will spin up one {self.get_head_node_type(cloud_provider)} instance for each function and will incur a small amount of cost.",
        ]
        ...
        if CloudFunctionalVerificationType.SERVICE in functions_to_verify:
            confirmation_message.append(
                "For service verification, it takes about 15 minutes."
            )
            ...
            for future in concurrent.futures.as_completed(futures):
                ...
                try:
                    ...
                    self._update_console(
                        ...
                        function,
                        self.task_ids[function],
                        f"Failed to verify {function.lower()}: {e}",
                        completed=True,
                    )
