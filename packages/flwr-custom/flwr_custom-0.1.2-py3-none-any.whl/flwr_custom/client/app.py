...
from flwr_custom.common import (
...
import flwr_custom.common.serde as serde
...
from flwr_custom.common.typing import (
    Code,
    EvaluateIns,
    EvaluateRes,
    FitIns,
    ...
    while True:
        ...
        with connection(
            ...
            while True:
                ...
                result_type = ""
                if 'fit_res' in str(client_message):
                    result_type = "training"
                    status_dict[ client_id, status_dict[ CURRENT_ROUND ], TRAIN, "msg" ] = client_message
                elif 'evaluate_res' in str(client_message):
                    result_type = "evaluating"
                    status_dict[ client_id, status_dict[ CURRENT_ROUND ], EVAL, "msg" ] = client_message

                if result_type != "":
                    status_dict[ LOG ] += f"{date.now_custom()}, round {status_dict[ CURRENT_ROUND ]}: client {client_id} {result_type} result sent to server\n"
