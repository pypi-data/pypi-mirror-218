...
class ConfigWindow(QDialog):
    ...
    def initUI(self):
        ...
        self.port_label = QLabel('Port for connection:', self)
        ...
        self.ip_label = QLabel('Listen IP adresses:', self)
        ...
        self.ip.insert(self.config['SETTINGS']['Listen_ip'])
    ...
    def save_server_config(self):
        ...
        try:
            ...
            message.warning(self, 'Error', 'The PORT value must be digit')
        else:
