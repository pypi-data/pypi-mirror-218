...
class Description:
    ...
    """
    class Meta:
        namespace = "https://3docx.org/fileadmin//ocx_schema//V300alpha//OCX_Schema.xsd"
...
class HeaderT:
    ...
    Attributes
        ...
        license: The OCX public license
...
class ShipDesignationT:
    ...
    Attributes
        ...
        number_imo: A unique identification of a vessel according to IMO
            ...
            on IMO ship identification number scheme on the website of
...
class TypeificationSociety(Enum):
    """
...
class RefTypeValue(Enum):
    ...
    """
    OCX_PANEL = QName("{https://3docx.org/fileadmin//ocx_schema//V300alpha//OCX_Schema.xsd}Panel")
    OCX_PLATE = QName("{https://3docx.org/fileadmin//ocx_schema//V300alpha//OCX_Schema.xsd}Plate")
    OCX_SEAM = QName("{https://3docx.org/fileadmin//ocx_schema//V300alpha//OCX_Schema.xsd}Seam")
    OCX_BRACKET = QName("{https://3docx.org/fileadmin//ocx_schema//V300alpha//OCX_Schema.xsd}Bracket")
    OCX_STIFFENER = QName("{https://3docx.org/fileadmin//ocx_schema//V300alpha//OCX_Schema.xsd}Stiffener")
    OCX_PILLAR = QName("{https://3docx.org/fileadmin//ocx_schema//V300alpha//OCX_Schema.xsd}Pillar")
    OCX_CONNECTION_CONFIGURATION = QName("{https://3docx.org/fileadmin//ocx_schema//V300alpha//OCX_Schema.xsd}ConnectionConfiguration")
    OCX_HOLE2_D = QName("{https://3docx.org/fileadmin//ocx_schema//V300alpha//OCX_Schema.xsd}Hole2D")
    OCX_GRID_REF = QName("{https://3docx.org/fileadmin//ocx_schema//V300alpha//OCX_Schema.xsd}GridRef")
    OCX_MATERIAL = QName("{https://3docx.org/fileadmin//ocx_schema//V300alpha//OCX_Schema.xsd}Material")
    OCX_BAR_SECTION = QName("{https://3docx.org/fileadmin//ocx_schema//V300alpha//OCX_Schema.xsd}BarSection")
    OCX_CELL = QName("{https://3docx.org/fileadmin//ocx_schema//V300alpha//OCX_Schema.xsd}Cell")
    OCX_VESSEL = QName("{https://3docx.org/fileadmin//ocx_schema//V300alpha//OCX_Schema.xsd}Vessel")
    OCX_FREE_EDGE_CURVE3_D = QName("{https://3docx.org/fileadmin//ocx_schema//V300alpha//OCX_Schema.xsd}FreeEdgeCurve3D")
    OCX_SURFACE = QName("{https://3docx.org/fileadmin//ocx_schema//V300alpha//OCX_Schema.xsd}Surface")
    OCX_END_CUT = QName("{https://3docx.org/fileadmin//ocx_schema//V300alpha//OCX_Schema.xsd}EndCut")
    OCX_OCCURRENCE_GROUP = QName("{https://3docx.org/fileadmin//ocx_schema//V300alpha//OCX_Schema.xsd}OccurrenceGroup")
    OCX_EDGE_REINFORCEMENT = QName("{https://3docx.org/fileadmin//ocx_schema//V300alpha//OCX_Schema.xsd}EdgeReinforcement")
    OCX_HOLE2_DCONTOUR = QName("{https://3docx.org/fileadmin//ocx_schema//V300alpha//OCX_Schema.xsd}Hole2DContour")
...
@dataclass
class TypeNotation(TypeNotationT):
    """
...
class TypeDataT:
    ...
    class_notation: Optional[TypeNotation] = field(
        default=None,
        metadata={
            "name": "ClassNotation",
            "type": "Element",
    ...
    newbuilding_society: Optional[TypeificationSociety] = field(
        default=None,
        metadata={
    ...
    society: Optional[TypeificationSociety] = field(
        default=None,
        metadata={
            "type": "Attribute",
            "namespace": "https://3docx.org/fileadmin//ocx_schema//V300alpha//OCX_Schema.xsd",
...
@dataclass
class TypeificationData(TypeDataT):
    """
    Information that specifies design and intended performance characteristics of
    the ship in accordance with classification society rules and statutory
    regulations (see ISO       10303-218, section 4.2.36).
...
class RefPlanesT(ReferencePlaneT):
    ...
    Attributes
        ...
        origin: The origin of a local or global coordinate system. If
            not given, it is assumed that the origin of the reference
...
class XrefPlanes(RefPlanesT):
    ...
    The authoring application must export ALL the RefPlane positions. If
    more than one XRefPlanes definition is exported, the authoring
    application shall identify the main reference system by setting the
    isMainSystem=true. It is also possible to give a reversed frame
...
class YrefPlanes(RefPlanesT):
    ...
    The authoring application must export ALL the RefPlane positions. If
    more than one YRefPlanes definition is exported, the authoring
    application shall identify the main reference system by setting the
    isMainSystem=true.
    """
    class Meta:
...
class ZrefPlanes(RefPlanesT):
    ...
    The authoring application must export ALL the RefPlane positions. If
    more than one ZRefPlanes definition is exported, the authoring
    application shall identify the main reference system by setting the
    sMainSystem=true.
    """
    class Meta:
...
class VesselGrid(VesselGridT):
    """
    The definition of the vessel grid system including the vessel frame table.
    """
    class Meta:
        namespace = "https://3docx.org/fileadmin//ocx_schema//V300alpha//OCX_Schema.xsd"
...
class ReferencePlanes(ReferencePlanesT):
    """
    The collection of reference planes used to limit geometries.
    """
    class Meta:
        namespace = "https://3docx.org/fileadmin//ocx_schema//V300alpha//OCX_Schema.xsd"
...
@dataclass
class TypeCatalogueT(DescriptionBaseT):
    """
...
@dataclass
class TypeCatalogue(TypeCatalogueT):
...
class VesselT(FormT):
    ...
    classification_data: Optional[TypeificationData] = field(
        default=None,
        metadata={
            "name": "ClassificationData",
            "type": "Element",
...
class OcxXmlT(DocumentBaseT):
    ...
    class_catalogue: List[TypeCatalogue] = field(
        default_factory=list,
        metadata={
            "name": "ClassCatalogue",
            "type": "Element",
