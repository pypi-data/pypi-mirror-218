...
nowrap_style = {'width': '196px', 'height': '24px', 'fontFamily': 'Noto Sans', 'fontWeight': '700', 'fontSize': '17px',
                'lineHeight': '24px', 'letterSpacing': '-0.5px', 'whiteSpace': 'nowrap', 'padding': '11px 0px 0px 0px'}

wrap_style = {'width': '270px', 'height': '48px', 'fontFamily': 'Noto Sans', 'fontWeight': '700', 'fontSize': '17px',
              'lineHeight': '24px', 'letterSpacing': '-0.5px', 'padding': '-8px 0px 12px 0px', 'margin-top': '-8px',
