...
class AmbiguousRoot(AmbiguousReference):
    """
    Raised when a root cannot be computed due to an ambiguity in the history
    """
...
class Project(Protocol[V]):
    ...
    def _tags(self, reference: str | None = None) -> Iterator[str]:
        try:
