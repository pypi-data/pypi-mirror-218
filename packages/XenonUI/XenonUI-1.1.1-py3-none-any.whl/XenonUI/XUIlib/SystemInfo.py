...
from XenonUI.XUIlib.progress import progress
cpuboxshower_logo=os.path.join("XenonUI","XUIlib","image","cpu.jpeg")
ramboxshower_logo=os.path.join("XenonUI","XUIlib","image","ram.png")
diskboxshower_logo=os.path.join("XenonUI","XUIlib","image","disk.jpeg")
def get_cpu():
