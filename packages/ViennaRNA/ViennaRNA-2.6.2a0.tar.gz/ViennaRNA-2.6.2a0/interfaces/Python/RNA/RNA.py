...
def params_load(*args, **kwargs):
    ...
    **SWIG Wrapper Notes**
        ...
        default RNA parameters, i.e. this is equivalent to calling RNA.params_load_defaults().  
...
def params_save(*args, **kwargs):
    ...
    **SWIG Wrapper Notes**
        ...
        options=RNA.PARAMETER_FORMAT_DEFAULT).  
...
def strtrim(*args, **kwargs):
    ...
    **SWIG Wrapper Notes**
        ...
        parameters `delimiters=NULL`, `keep=0`, and `options=RNA.TRIM_DEFAULT`.  
...
def db_flatten(*args):
    ...
    **SWIG Wrapper Notes**
        ...
        replacement for RNA.db_flatten_to().  
...
def ptable(*args, **kwargs):
    ...
    This function takes an input string of a secondary structure annotation in Dot-Bracket Notation
    (a.k.a. Dot-Parenthesis Notation) or dot-bracket-ext-notation, and converts it into a pair table
    representation.  
    ...
    **SWIG Wrapper Notes**
        ...
        default set is round brackets, i.e. RNA.BRACKETS_RND.  
...
def db_pk_remove(*args, **kwargs):
    ...
    **SWIG Wrapper Notes**
        ...
        parameter `options` defaults to RNA.BRACKETS_ANY.  
...
def tree_string_to_db(structure):
    ...
    See Also
    --------
    RNA.db_to_tree_string(), RNA.STRUCTURE_TREE_EXPANDED, RNA.STRUCTURE_TREE_HIT, Tree
...
def bp_distance(*args):
    ...
    **SWIG Wrapper Notes**
        ...
        RNA.ptable_from_string() for available options. (default: **RNA.BRACKETS_RND**).  
...
def aln_consensus_mis(alignment, md_p=None):
    ...
    The most informative sequence (MIS) [10] displays for each alignment column the nucleotides with
    frequency greater than the background frequency, projected into IUPAC notation. Columns where gaps
    are over-represented are in lower case.  
...
def aln_conservation_struct(alignment, structure, md=None):
    ...
    **SWIG Wrapper Notes**
        This function is available in an overloaded form where the last parameter may be omitted,
        indicating `md` = *NULL*  
...
def aln_conservation_col(*args, **kwargs):
    ...
    **SWIG Wrapper Notes**
        This function is available in an overloaded form where the last two parameters may be omitted,
        indicating `md` = *NULL*, and `options` = RNA.MEASURE_SHANNON_ENTROPY, respectively.  
...
def plot_dp_EPS(*args, **kwargs):
    ...
    **SWIG Wrapper Notes**
        ...
        = NULL, `options` = RNA.PLOT_PROBABILITIES_DEFAULT  
...
def sc_mod_read_from_jsonfile(filename, md=None):
    ...
    **SWIG Wrapper Notes**
    ...
    See Also
    --------
    RNA.sc_mod_read_from_json(), RNA.sc_mod_parameters_free(), RNA.fold_compound.sc_mod(), JSON
    Parameter Files for
    Modified Bases  
...
def sc_mod_read_from_json(json, md=None):
    ...
    **SWIG Wrapper Notes**
    ...
    See Also
    --------
    RNA.sc_mod_read_from_jsonfile(), RNA.sc_mod_parameters_free(), RNA.fold_compound.sc_mod(), JSON
    Parameter Files
    for Modified Bases  
...
def eval_structure_simple(*args):
    ...
    **SWIG Wrapper Notes**
        ...
        last two arguments for this function are optional and default to RNA.VERBOSITY_QUIET and NULL,
        respectively.  
...
def MEA_from_plist(*args):
    ...
    **SWIG Wrapper Notes**
        This function is available as overloaded function **MEA_from_plist**(gamma = 1., md = NULL).
...
def file_msa_detect_format(*args, **kwargs):
    ...
    **SWIG Wrapper Notes**
        ...
        that case, the `options` parameter defaults to RNA.FILE_FORMAT_MSA_DEFAULT.  
...
def file_msa_write(*args, **kwargs):
    ...
    **SWIG Wrapper Notes**
        ...
        default to (RNA.FILE_FORMAT_MSA_STOCKHOLM | RNA.FILE_FORMAT_MSA_APPEND).  
...
def file_msa_read(*args, **kwargs):
    ...
    **SWIG Wrapper Notes**
        ...
        C-library, are available as additional return values. Hence, a function call in python may look
        like this:  
    ...
    After successfully reading the first record, the variable `num_seq` contains the number of sequences
    in the alignment (the actual return value of the C-function), while the variables `names`, `aln`,
    `id`, and `structure` are lists of the sequence names and aligned sequences, as well as strings
    holding the alignment ID and the structure as stated in the `SS_cons` line, respectively. Note, the
    last two return values may be empty strings in case the alignment does not provide the required
    data.  

    This function exists as an overloaded version where the `options` parameter may be omitted! In that
    case, the `options` parameter defaults to RNA.FILE_FORMAT_MSA_STOCKHOLM.  
...
def seq_encode(sequence, md_p=None):
    ...
    **SWIG Wrapper Notes**
        ...
        function returns a list/tuple of integer representations of the input sequence.  
...
def enumerate_necklaces(entity_counts):
    ...
    **SWIG Wrapper Notes**
        This function is available as global function **enumerate_necklaces()** which accepts lists
...
def rotational_symmetry(*args):
    ...
    **SWIG Wrapper Notes**
        This function is available as overloaded global function **rotational_symmetry()**. It merges
        the functionalities of RNA.rotational_symmetry(), RNA.rotational_symmetry_pos(),
...
def path_options_findpath(*args, **kwargs):
    ...
    RNA.fold_compound.path_direct() API functions to use the *findpath*[8] heuristic. The parameter `width`
    specifies the width of the breadth-first search while the second parameter `type` allows one to set
    the type of the returned (re-)folding path.  
...
class fold_compound(object):
    ...
    **SWIG Wrapper Notes**
        ...
        This data structure is wrapped as an object **fold_compound** with several related functions
        attached as methods.  
    ...
    def exp_params_reset(self, md=None):
        ...
        **SWIG Wrapper Notes**
            ...
            stored within the RNA.md() object.  
    ...
    def sc_add_up(self, *args):
        ...
        **SWIG Wrapper Notes**
        ...
        :math:`1 \leq i \leq n`:  In both variants, the `options` argument is optional can may be omitted.  
    ...
    def sc_add_bp(self, *args):
        ...
        **SWIG Wrapper Notes**
        ...
        any base pair (i,j) with :math:`1 \leq i < j \leq n`:  In both variants, the `options` argument is
        optional can may be omitted.  
    ...
    def sc_mod_json(self, *args, **kwargs):
        ...
        **SWIG Wrapper Notes**
            ...
            *fold_compound* with default `options` = RNA.SC_MOD_DEFAULT  
        ...
        RNA.SC_MOD_CHECK_FALLBACK, RNA.SC_MOD_CHECK_UNMOD, RNA.SC_MOD_SILENT, RNA.SC_MOD_DEFAULT, JSON
        Parameter Files for Modified Bases  
    ...
    def sc_mod(self, *args, **kwargs):
        ...
        **SWIG Wrapper Notes**
            ...
            with default `options` = RNA.SC_MOD_DEFAULT  
    ...
    def sc_mod_m6A(self, *args, **kwargs):
        ...
        corrections are derived from [17].  

        **SWIG Wrapper Notes**
            This function is attached as overloaded method **sc_mod_m6A()** to objects of type
            *fold_compound* with default `options` = RNA.SC_MOD_DEFAULT  
    ...
    def sc_mod_pseudouridine(self, *args, **kwargs):
        ...
        parameter corrections are derived from [15].  
    ...
    def sc_mod_inosine(self, *args, **kwargs):
        ...
        mechanism. Modification sites are provided as a list of sequence positions (1-based). Energy
        parameter corrections are derived from [30] and [31].  
    ...
    def sc_mod_7DA(self, *args, **kwargs):
        ...
        Energy parameter corrections are derived from [24].  

        **SWIG Wrapper Notes**
            This function is attached as overloaded method **sc_mod_7DA()** to objects of type
            *fold_compound* with default `options` = RNA.SC_MOD_DEFAULT  
    ...
    def sc_mod_purine(self, *args, **kwargs):
        ...
        mechanism. Modification sites are provided as a list of sequence positions (1-based). Energy
        parameter corrections are derived from [16].  
    ...
    def eval_covar_structure(self, structure):
        ...
        **SWIG Wrapper Notes**
            This function is attached as method **eval_covar_structure()** to objects of type
            *fold_compound*  
    ...
    def backtrack(self, *args):
        ...
        **SWIG Wrapper Notes**
            ...
            *fold_compound* with default parameter `length` equal to the total length of the RNA.  
    ...
    def ensemble_defect(self, *args):
        ...
        **SWIG Wrapper Notes**
            ...
            Note that the SWIG wrapper takes a structure in dot-bracket notation and converts it into a pair
    ...
    def subopt(self, delta, sorted=1, nullfile=None):
        ...
        optimum, see [32]. The results are either directly written to a 'fp' (if 'fp' is not NULL), or
        (fp==NULL) returned in a RNA.subopt_solution() * list terminated by an entry were the 'structure'
        member is NULL.  
    ...
    def subopt_zuker(self):
        ...
        Compute Suboptimal structures according to M. Zuker [35] , i.e. for every possible base pair the
        minimum energy structure containing the resp. base pair. Returns a list of these structures and
        their energies.  
    ...
    def neighbors(self, *args, **kwargs):
        r"""
        neighbors(fold_compound self, varArrayShort pt, unsigned int options=(4|8)) -> MoveVector
    ...
    def path(self, *args):
        ...
        **SWIG Wrapper Notes**
            ...
            The optional parameter `options` defaults to RNA.PATH_DEFAULT if it is omitted.  
    ...
    def path_findpath_saddle(self, *args, **kwargs):
        ...
        This function uses an inplementation of the *findpath* algorithm [8] for near-optimal direct
        refolding path prediction.  
    ...
    def path_direct(self, *args, **kwargs):
        ...
        **SWIG Wrapper Notes**
            ...
            *fold_compound*. The optional parameter `maxE` defaults to #INT_MAX - 1 if it is omitted, while
            ...
            with :math:`E_{saddle} < E_{max}` it returns an empty list.  
    ...
    def heat_capacity(self, T_min=0., T_max=100., T_increment=1., mpoints=2):
        ...
        **SWIG Wrapper Notes**
            ...
            *fold_compound*. If the optional function arguments `T_min`, `T_max`, `T_increment`, and
            `mpoints` are omitted, they default to 0.0, 100.0, 1.0 and 2, respectively.  
    ...
    def subopt_cb(self, *args, **kwargs):
        ...
        al. 1999 [32]. Identical to RNA.fold_compound.subopt(), it computes all secondary structures within an energy
        band `delta` arround the MFE. However, this function does not print the resulting structures and
        their corresponding free energies to a file pointer, or returns them as a list. Instead, it calls a
        user-provided callback function which it passes the structure in dot-bracket format, the
    ...
    def pbacktrack(self, *args):
        ...
        **SWIG Wrapper Notes**
            ...
            *fold_compound*. See also Python Examples - Boltzmann Sampling  
    ...
    def move_neighbor_diff(self, *args):
        r"""
        move_neighbor_diff(self, pt, move, options=(4|8)) -> MoveVector
