...
class LayerxClient:
    ...
    def __check_sdk_version_compatibility(self):
        ...
        _datalake_client = datalake.DatalakeClient(
            self.encoded_key_secret, self.layerx_url)
    ...
    def download_dataset(self, version_id: str, export_type: str, custom_download_path: str = None):
        ...
        _dataset_client = dataset.DatasetClient(
            self.encoded_key_secret, self.layerx_url, custom_download_path)
    ...
    def upload_files_to_collection(
        ...
        upload_details = _datalake_client.file_upload(path, collection_type, collection_name, meta_data_object, application_code, meta_data_override)
    ...
    def trash_objects_from_collection(
        ...
        try:
            ...
            if (query == "" or query == None) and (filter == "" or filter == {}):
                ...
                response = self.__trash_objects(collection_id, query, filter, 0, [], True)
