...
from layerx.datalake.metadata import Metadata
...
class DatalakeClient:
    ...
    def file_upload(self, path: str, collection_type, collection_name, meta_data_object, application_code, meta_data_override):
        _upload = FileUpload(client=self, application_code=application_code)
        upload_res = _upload.file_upload_initiate(path, collection_type, collection_name, meta_data_object, meta_data_override)
        return upload_res
