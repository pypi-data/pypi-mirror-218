...
class Initializer:
    ...
    def finish(self):
        return CrossPyArray(
            ...
            device_to_blocks=self._device_to_blocks,
...
class CrossPyArray(numpy.lib.mixins.NDArrayOperatorsMixin):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._device_to_blocks = device_to_blocks
    ...
    def __getitem__(self, index: IndexType):  # -> Union[Array, List[Array]]
        ...
        if self._concat_axis == 0 and len(index) == 1:
            ...
            if isinstance(index[0], int):
                ...
                selection = self._original_data[loc][int_ - self._metadata.block_offset[loc - 1] if loc > 0 else int_]
