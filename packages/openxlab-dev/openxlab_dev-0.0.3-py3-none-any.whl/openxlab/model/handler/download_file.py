...
def download(model_repo, model_name=None, output=None, overwrite=False) -> None:
    ...
    try:
        ...
        return
    file_path_download = []
    cache_path = f'{model_cache_path}/{username}_{repository}'
...
def _download_to_local(url, file_name, path=None, overwrite=False, cache_path=None) -> str:
    """
    ...
    cache_path_file = f'{cache_path}/{file_name}'
