...
if is_mac:
    if "3.8" not in sys_version and "3.9" not in sys_version:
        ...
        print(
            "fastdup identified you are running on supported Python using unsupported OS version " + str(OS_SUBVER) + "We support 10.X to 12.X. Try to upgrade pip using `pip install -U pip` and try again.")
