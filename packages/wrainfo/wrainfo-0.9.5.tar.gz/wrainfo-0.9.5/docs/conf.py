...
# -*- coding: utf-8 -*-
#
# wrainfo documentation build configuration file, created by
...
version = wrainfo.__version__
# The full version, including alpha/beta/rc tags.
release = wrainfo.__version__
...
# top of the sidebar.
html_logo = 'images/wrainfo_logo.png'
...
latex_documents = [
    (master_doc, 'wrainfo.tex',
     'WRaINfo Documentation',
     'FernLab', 'manual'),
]
