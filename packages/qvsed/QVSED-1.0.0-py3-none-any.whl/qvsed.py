...
class QVSEDWindow(QMainWindow):
    ...
    def load_ui_file(self):
        ui_file = pkg_resources.resource_filename('qvsed', 'QVSED.ui')
        loadUi(ui_file, self)

    def generate_config(self):
        self.echo_area_update("Welcome to QVSED! Config file config.py created.")

        config_default = pkg_resources.resource_string('qvsed', 'config_default.py')
        shutil.copyfile(config_default, "config.py")
