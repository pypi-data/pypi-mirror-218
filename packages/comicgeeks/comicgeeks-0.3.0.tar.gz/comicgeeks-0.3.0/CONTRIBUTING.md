...
Welcome to `comicgeeks` contributor's guide.
...
If you experience bugs or general issues with `comicgeeks`, please have a look
...
You can help improve `comicgeeks` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`comicgeeks` documentation uses [Sphinx] as its main documentation compiler.
This means that the docs are kept in the same repository as the project code, and
that any documentation update is done in the same way was a code contribution.


>   Please notice that the [GitHub web interface] provides a quick way of
   propose changes in `comicgeeks`'s files. While this mechanism can
...
## Code Contributions
The comicgeeks clients works by using the [requests] library to make HTTP requests to the [leagueofcomicgeeks.com] web and parsing the results using the [beautifulsoup4] library.
...
```
conda create -n comicgeeks python=3 six virtualenv pytest pytest-cov
conda activate comicgeeks
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/comicgeeks.git
   cd comicgeeks
   ```
...
5. Install [pre-commit]:
   ...
   `comicgeeks` comes with a lot of hooks configured to automatically help the
...
[leagueofcomicgeeks.com]: https://leagueofcomicgeeks.com/
...
[repository]: https://github.com/pruizlezcano/comicgeeks
[issue tracker]: https://github.com/pruizlezcano/comicgeeks/issues
