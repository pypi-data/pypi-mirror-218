    ...
    def refresh(self) -> SessionInfo:
        ...
        if session_info.dnastack_schema_version < 3:
            ...
            raise ReauthenticationRequired(
                f'The stored session information does not provide enough information to refresh token. (given: {session_info})'
            )
