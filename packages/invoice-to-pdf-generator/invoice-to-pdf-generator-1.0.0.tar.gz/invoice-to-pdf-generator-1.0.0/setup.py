...
setup(
    name='invoice-to-pdf-generator',  # * Your package will have this name
    ...
    author='Subhojit Guin',  # Your name
    author_email='subhojitguin2004@gmail.com',  # Your email
    url='https://github.com/SubhojitGuin',
