...
class ExternalTransactionEvent(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class event_type(
                ...
                def EXTERNAL_TRANSACTION(cls):
                    return cls("external_transaction")
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["status"]) -> 'ExternalTransactionEventStatus': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["status"]) -> 'ExternalTransactionEventStatus': ...
