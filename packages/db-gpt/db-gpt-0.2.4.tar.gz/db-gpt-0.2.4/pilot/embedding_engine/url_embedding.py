...
from langchain.text_splitter import SpacyTextSplitter, RecursiveCharacterTextSplitter, TextSplitter
...
class URLEmbedding(SourceEmbedding):
    ...
    def __init__(self, file_path, vector_store_config, text_splitter: Optional[TextSplitter] = None):
