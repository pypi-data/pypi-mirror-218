...
class Chima:
    ...
    def generate(
        ...
        *,
        ...
        day_type: str,
        cluster_workout: str,
        cluster_challenge: str,
        last_workout_completed: str,
        last_workout_week: str,
        last_week_completed: int,
        delta_moves: str,
        notification_type: str,
        event: str,
        day: str,
        marketing_event: typing.Optional[str] = OMIT,
        ...
        _request: typing.Dict[str, typing.Any] = {
            ...
            "equipment": equipment,
            "day_type": day_type,
            "cluster_workout": cluster_workout,
            "cluster_challenge": cluster_challenge,
        ...
        if marketing_event is not OMIT:
            _request["marketing_event"] = marketing_event
        _response = httpx.request(
            "POST",
