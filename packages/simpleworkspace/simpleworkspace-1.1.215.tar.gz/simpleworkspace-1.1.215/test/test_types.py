...
class TimeTests(BaseTestCase):
    ...
    def test_TimeUnit_ArchimetricOperators(self):
        ...
        time3 = TimeUnit(1000, TimeEnum.MilliSecond)
        time1 += time2
        time1 += time3
        self.assertEqual(time1.amount, 66 )
        self.assertEqual(time1.unit, TimeEnum.Second)
    ...
    def test_time_unit_get_parts(self):
        # Test case 1
        ...
        # Test case 4
        parts = TimeUnit(86461.100, TimeEnum.Second).GetParts()
        parts[TimeEnum.MilliSecond] = round(parts[TimeEnum.MilliSecond],6) # get rid of insanely low decimals after division operations
        self.assertEqual(parts, {
