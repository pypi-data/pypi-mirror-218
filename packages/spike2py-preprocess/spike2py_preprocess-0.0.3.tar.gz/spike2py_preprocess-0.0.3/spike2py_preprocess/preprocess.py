...
def study(study_path):
    ...
    subjects = _get_subjects(study_path)
    _process_study_subjects(study_path, subjects, study_info, preprocess_info)
...
def _get_subjects(study_path):
    study_details = read_json(study_path / STUDY_INFO_FILE)
    return study_details["subjects"]


def _process_study_subjects(study_path, subjects, study_info, preprocess_info):
