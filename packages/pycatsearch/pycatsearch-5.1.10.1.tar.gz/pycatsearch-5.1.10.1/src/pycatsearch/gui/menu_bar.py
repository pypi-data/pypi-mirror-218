...
class MenuBar(QMenuBar):
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.action_copy_current: QAction = self.menu_copy_only.addAction(
            self.tr('Active &Cell'),
            'Ctrl+Shift+C'
        )
        self.menu_copy_only.addSeparator()
        self.action_copy_name: QAction = self.menu_copy_only.addAction(
            self.tr('&Substance Name'),
            'Ctrl+Shift+C, N'
        )
        self.action_copy_frequency: QAction = self.menu_copy_only.addAction(
            self.tr('&Frequency'),
            'Ctrl+Shift+C, F'
        )
        self.action_copy_intensity: QAction = self.menu_copy_only.addAction(
            self.tr('&Intensity'),
            'Ctrl+Shift+C, I'
        )
