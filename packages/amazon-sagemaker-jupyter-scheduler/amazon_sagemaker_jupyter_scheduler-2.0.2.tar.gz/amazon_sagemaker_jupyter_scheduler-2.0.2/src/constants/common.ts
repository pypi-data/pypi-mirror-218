  ...
  ScheduleNoteBook: {
    MainPanel: {
      ...
      StudioTooltips: {
        ...
        SubnetTooltip:
          'Specify or add subnet(s) that have been created for the default VPC. For better security, we recommend that you use a private VPC.',
        ...
        InitialScriptTooltip:
          'Enter the EFS file path where a local script or a lifecycle configuration script is located.',
      },
    },
  },
  ImageSelector: {
