  ...
  return (
    <div className={Styles.WidgetFieldsContainer}>
      <InputContainer
        ...
        toolTipText={pluginEnvironment.isStudio ? studioTooltipsStrings.RoleArnTooltip : tooltipsStrings.RoleArnTooltip}
      />
      ...
      <InputContainer
        ...
        toolTipText={pluginEnvironment.isStudio ? studioTooltipsStrings.InputFolderTooltip : tooltipsStrings.InputFolderTooltip}
      />
      <InputContainer
        name={'s3_output'}
        onChange={handleChange}
        ...
        onBlur={handleS3InputFieldOnBlur}
        toolTipText={pluginEnvironment.isStudio ? studioTooltipsStrings.OutputFolderTooltip : tooltipsStrings.OutputFolderTooltip}
      />
      ...
      {(isDisabled || enableJobEncryption) && (
        <>
          <InputContainer
      ...
      {((isVPCDomain && enableVPCSetting) || isDisabled) && (
        <>
      ...
      {pluginEnvironment.isStudio && <div className={Styles.AdvancedOptionsSelectContainer}>
