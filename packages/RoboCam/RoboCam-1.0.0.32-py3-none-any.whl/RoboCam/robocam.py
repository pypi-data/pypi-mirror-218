...
class RoboCam():
    def __init__(self):
        if platform.system() == "Windows" and not os.path.exists(os.path.expanduser('~') + "\\Pictures\\roborobo"):
            os.mkdir(os.path.expanduser('~') + "\\Pictures\\roborobo") 
            os.mkdir(os.path.expanduser('~') + "\\Pictures\\roborobo\\face") 
            os.mkdir(os.path.expanduser('~') + "\\Pictures\\roborobo\\sketch") 
        elif not os.path.exists(os.path.expanduser('~') + "/Pictures/roborobo"):
            os.mkdir(os.path.expanduser('~') + "/Pictures/roborobo") 
            os.mkdir(os.path.expanduser('~') + "/Pictures/roborobo/face") 
            os.mkdir(os.path.expanduser('~') + "/Pictures/roborobo/sketch") 
    ...
    def FaceCapture(self, name:str, captureCount:int=5, path:str=os.path.expanduser('~') + "\\Pictures\\roborobo\\face"):
    ...
    def TrainFaceData(self, facePath:str = os.path.expanduser('~') + "\\Pictures\\roborobo\\face"):
        # print(facePath)
        if platform.system() != "Windows":
    ...
    def DeleteFaceData(self, name:str, facePath:str=os.path.expanduser('~') + "\\Pictures\\roborobo\\face"):
        if platform.system() != "Windows":
            facePath=facePath.replace("\\","/")
        if os.path.isdir(facePath) is False:
            print(facePath +" is not directory.")
    ...
    def SketchCapture(self, name:str, captureCount:int=5, path:str=os.path.expanduser('~') + "\\Pictures\\roborobo\\sketch"):
        if platform.system() != "Windows":
            path=path.replace("\\","/")
        if bool(name) == False:
            print("Name parameter is Empty.")
    ...
    def TrainSketchData(self, sketchPath:str = os.path.expanduser('~') + "\\Pictures\\roborobo\\sketch"):
        if platform.system() != "Windows":
    ...
    def DeleteSketchData(self, name:str, sketchPath:str=os.path.expanduser('~') + "\\Pictures\\roborobo\\sketch"):
        if platform.system() != "Windows":
            sketchPath=sketchPath.replace("\\","/")
        if os.path.isdir(sketchPath) is False:
            print(sketchPath +" is not directory.")
