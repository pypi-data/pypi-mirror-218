...
if not _RELEASE:
    _component_func = components.declare_component(
        # We give the component a simple, descriptive name ("business_model_canvas"
    ...
    _component_func = components.declare_component("business_model_canvas", path=build_dir)
...
def business_model_canvas(data, key=None):
