...
More info at https://github.com/explosion/prodigy-teams/tree/main/cli
...
| Argument | Type | Description | Default |
| --- | --- | --- | --- |
| `--select` | `List[str]` | Comma-separated fields to select and show in output. Available: ['id', 'created', 'updated', 'is_running', 'is_startable', 'is_stoppable', 'broker_id', 'name', 'project_id', 'job_type', 'state', 'plan'] | `['id', 'name', 'state']` |
...
View and manage cluster secrets
...
| Argument | Type | Description | Default |
| --- | --- | --- | --- |
| `--select` | `List[str]` | Comma-separated fields to select and show in output. Available: ['id', 'created', 'updated', 'project_id', 'broker_id', 'name', 'recipe_name', 'recipe_title', 'state', 'project_name', 'is_running', 'is_startable', 'is_stoppable', 'error', 'plan', 'job_type'] | `['id', 'name', 'state']` |
...
View and manage Prodigy Teams users
