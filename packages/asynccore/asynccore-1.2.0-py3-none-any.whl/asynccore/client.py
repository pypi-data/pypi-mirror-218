...
class Client(HTTPClient):
    """
    :class:`Client` supports all services of the :class:`asynccore.user`.
    ...
    async def get_guild(self, guild_id: int) -> Optional[ClientResponse]:
        """
    ...
    async def on_guild_ban_add(self, user: UserClient, ban_data: dict) -> None:
        ...

    async def on_guild_ban_remove(self, user: UserClient, ban_data: dict) -> None:
        ...
