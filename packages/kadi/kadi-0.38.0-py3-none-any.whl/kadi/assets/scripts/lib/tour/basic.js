...
if (kadi.globals.can_create_records) {
  tour[1].steps.push({
    id: 'new-record',
    attach: true,
    clickable: true,
  ...
  tour.push({
    ...
    steps: [
      ...
      },
      {
        ...
        attach: true,
        content: $t('Additionally, access permissions can directly be granted for the newly created record, either for individual users or groups of multiple users. The latter can also be created similarly to records.'),
      },
      {
        id: 'template',
        attach: true,
        content: $t('Finally, record templates can facilitate the easy creation of records via the web interface. Templates can again be created similarly to records and may also contain other contents besides record metadata, depending on their type.'),
      },
      {
        id: 'submit',
        attach: true,
        clickable: true,
        content: $t('Once you are finished with entering the desired metadata of your record, try creating it by clicking on the highlighted button. If something goes wrong, fix any invalid metadata and simply try again.'),
      },
    ],
  });
  ...
  tour.push({
    ...
    steps: [
      ...
      },
      {
        ...
        attach: true,
        clickable: true,
        content: $t('Once you are done, navigate back to the overview page of this record by clicking on the highlighted link.'),
      },
    ],
  });
} else {
...
tour.push({
  ...
  steps: [
    ...
    },
    {
      ...
      attach: true,
      elem: '[data-tour="record"]',
      content: $t('This section focuses on the links of this record with other resources, namely collections as well as other records. Unless you already specified a linked collection while creating this record, no contents will be shown here yet.'),
    },
    {
      id: 'permissions',
      attach: true,
