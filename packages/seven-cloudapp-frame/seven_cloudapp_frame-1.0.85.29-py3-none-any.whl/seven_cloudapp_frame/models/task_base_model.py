            ...
            if invoke_result_data.success == True:
                ...
                if task_invoke_result_data.success == True:
                    ...
                    if reward_value <= 0 or task_count.now_count <= 0:
                        ...
                        if self.context:
                            self.context.logging_link_error("【领取任务奖励】" + SevenHelper.json_dumps({"config_json": config_json, "reward_value": reward_value, "task_count": task_count, "now_count": task_count.now_count}))
                        elif self.logging_link_error:
                            self.logging_link_error("【领取任务奖励】" + SevenHelper.json_dumps({"config_json": config_json, "reward_value": reward_value, "task_count": task_count, "now_count": task_count.now_count}))
                    elif task_count.now_count < satisfy_num:
                        invoke_result_data.success = False
                        invoke_result_data.error_code = "error"
