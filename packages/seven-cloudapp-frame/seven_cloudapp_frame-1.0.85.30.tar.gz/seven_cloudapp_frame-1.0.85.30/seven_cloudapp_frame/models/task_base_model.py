...
@LastEditTime: 2023-06-13 18:30:40
        ...
        try:
            ...
            if invoke_result_data.success == True:
                ...
                if task_invoke_result_data.success == True:
                    ...
                    config_json = task_info_dict["config_json"]
                    if self.context:
                        self.context.logging_link_error("【领取任务奖励1】" + SevenHelper.json_dumps({"config_json": config_json}))
                    elif self.logging_link_error:
                        self.logging_link_error("【领取任务奖励1】" + SevenHelper.json_dumps({"config_json": config_json}))
                    if task_sub_type:
                        sub_config_json = []
                        ...
                        if self.context:
                            self.context.logging_link_error("【领取任务奖励2】" + SevenHelper.json_dumps({"config_json": config_json}))
                        elif self.logging_link_error:
                            self.logging_link_error("【领取任务奖励2】" + SevenHelper.json_dumps({"config_json": config_json}))
                    else:
                        if self.context:
                            self.context.logging_link_error("【领取任务奖励3】" + SevenHelper.json_dumps({"config_json": config_json}))
                        elif self.logging_link_error:
                            self.logging_link_error("【领取任务奖励3】" + SevenHelper.json_dumps({"config_json": config_json}))
