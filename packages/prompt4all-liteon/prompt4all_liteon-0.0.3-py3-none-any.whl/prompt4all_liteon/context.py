...
class _Context:
    ...
    def get_prompt4all_dir(self):
        ...
        if 'PROMPT4ALL_HOME' in os.environ:
            ...
            if not os.access(_prompt4all_base_dir, os.W_OK):
                _prompt4all_dir = '/tmp/.prompt4all_liteon'
            else:
                _prompt4all_dir = os.path.expanduser('~/.prompt4all_liteon')
    ...
    def initial_context(self):
        ...
        _config_path = os.path.expanduser(os.path.join(self.prompt4all_dir, 'prompt4all_liteon.json'))
        _config = {}
