...
/**
 * The command IDs used by the jupyter-iam plugin.
 */
namespace CommandIDs {
  export const create = 'create-jupyter-iam-widget';
}
...
const plugin: JupyterFrontEndPlugin<void> = {
  id: '@datalayer/jupyter-iam:plugin',
  autoStart: true,
  ...
  activate: (
    ...
    console.log('JupyterLab extension @datalayer/jupyter-iam is activated!');
    if (settingRegistry) {
      settingRegistry
        .load(plugin.id)
        .then(settings => {
    ...
    connect('ws://localhost:8686/api/jupyter/jupyter_iam/echo', true);
