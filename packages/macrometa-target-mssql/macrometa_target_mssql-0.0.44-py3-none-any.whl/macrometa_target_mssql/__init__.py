...
class MicrosoftSQLServerTargetConnector(C8Connector):
    ...
    def package_name(self) -> str:
        ...
        return "macrometa-target-mssql"

    def version(self) -> str:
        """Returns the version of the connector."""
        return pkg_resources.get_distribution('macrometa_target_mssql').version
    ...
    def description(self) -> str:
        ...
        return "Send data into Microsoft's SQL Server table."
    ...
    def config(self) -> list[ConfigProperty]:
        ...
        return [
            ConfigProperty('host', 'Host', ConfigAttributeType.STRING, True, False,
                           description='Microsoft SQL Server host.',
                           placeholder_value='mssql_host'),
