...
class OAuth2PasswordRequestForm:
    ...
    def __init__(self, *, grant_type: Annotated[Union[str, None], Form(pattern='password')]=None, username: Annotated[str, Form()], password: Annotated[str, Form()], scope: Annotated[str, Form()]='', client_id: Annotated[Union[str, None], Form()]=None, client_secret: Annotated[Union[str, None], Form()]=None):
...
class OAuth2PasswordRequestFormStrict(OAuth2PasswordRequestForm):
    ...
    def __init__(self, grant_type: Annotated[str, Form(pattern='password')], username: Annotated[str, Form()], password: Annotated[str, Form()], scope: Annotated[str, Form()]='', client_id: Annotated[Union[str, None], Form()]=None, client_secret: Annotated[Union[str, None], Form()]=None):
...
class OAuth2(SecurityBase):
    ...
    def __init__(self, *, flows: Union[OAuthFlowsModel, Dict[str, Dict[str, Any]]]=OAuthFlowsModel(), scheme_name: Optional[str]=None, description: Optional[str]=None, auto_error: bool=True):
...
class OAuth2AuthorizationCodeBearer(OAuth2):
    ...
    def __init__(self, authorizationUrl: str, tokenUrl: str, refreshUrl: Optional[str]=None, scheme_name: Optional[str]=None, scopes: Optional[Dict[str, str]]=None, description: Optional[str]=None, auto_error: bool=True):
        if not scopes:
            scopes = {}
