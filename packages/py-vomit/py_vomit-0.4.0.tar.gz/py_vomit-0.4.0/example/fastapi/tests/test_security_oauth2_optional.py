...
app = FastAPI()
reusable_oauth2 = OAuth2(flows={'password': {'tokenUrl': 'token', 'scopes': {'read:users': 'Read the users', 'write:users': 'Create users'}}}, auto_error=False)
