...
def test_override_in_items_with_q_run():
    from docs_src.dependency_testing.tutorial001_py310 import test_override_in_items_with_q
    test_override_in_items_with_q()

@needs_py310
def test_override_in_items_with_params_run():
    from docs_src.dependency_testing.tutorial001_py310 import test_override_in_items_with_params
