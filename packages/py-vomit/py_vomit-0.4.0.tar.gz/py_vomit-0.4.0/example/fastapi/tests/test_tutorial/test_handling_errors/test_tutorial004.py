...
def test_get_validation_error():
    ...
    assert 'path -> item_id' in response.text or "'loc': ('path', 'item_id')" in response.text
    assert 'value is not a valid integer' in response.text or 'Input should be a valid integer, unable to parse string as an integer' in response.text
