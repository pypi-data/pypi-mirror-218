...
def test_override_in_items_with_q_run():
    from docs_src.dependency_testing.tutorial001_an_py310 import test_override_in_items_with_q
    test_override_in_items_with_q()

@needs_py310
def test_override_in_items_with_params_run():
    from docs_src.dependency_testing.tutorial001_an_py310 import test_override_in_items_with_params
...
def test_override_in_users():
    ...
    assert response.json() == {'message': 'Hello Users!', 'params': {'q': None, 'skip': 5, 'limit': 10}}
...
def test_normal_app():
    ...
    assert response.status_code == 200, response.text
    assert response.json() == {'message': 'Hello Items!', 'params': {'q': 'foo', 'skip': 100, 'limit': 200}}