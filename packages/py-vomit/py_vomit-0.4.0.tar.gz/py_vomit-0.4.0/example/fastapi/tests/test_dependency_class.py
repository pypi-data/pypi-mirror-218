...
async def get_async_callable_dependency(value: str=Depends(async_callable_dependency)):
    return value

@app.get('/async-callable-gen-dependency')
async def get_async_callable_gen_dependency(value: str=Depends(async_callable_gen_dependency)):
    return value

@app.get('/synchronous-method-dependency')
async def get_synchronous_method_dependency(value: str=Depends(methods_dependency.synchronous)):
    return value

@app.get('/synchronous-method-gen-dependency')
async def get_synchronous_method_gen_dependency(value: str=Depends(methods_dependency.synchronous_gen)):
    return value

@app.get('/asynchronous-method-dependency')
async def get_asynchronous_method_dependency(value: str=Depends(methods_dependency.asynchronous)):
    return value

@app.get('/asynchronous-method-gen-dependency')
async def get_asynchronous_method_gen_dependency(value: str=Depends(methods_dependency.asynchronous_gen)):
    return value
