...
#ifndef GOOGLE_PROTOBUF_INCLUDED_graphscope_2fproto_2fattr_5fvalue_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_graphscope_2fproto_2fattr_5fvalue_2eproto_2epb_2eh
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    descriptor_table_graphscope_2fproto_2fattr_5fvalue_2eproto;
namespace gs {
namespace rpc {
class AttrValue;
...
PROTOBUF_NAMESPACE_OPEN
template <>
::gs::rpc::AttrValue* Arena::CreateMaybeMessage<::gs::rpc::AttrValue>(Arena*);
template <>
::gs::rpc::AttrValue_ListValue* Arena::CreateMaybeMessage<::gs::rpc::AttrValue_ListValue>(Arena*);
template <>
::gs::rpc::Chunk* Arena::CreateMaybeMessage<::gs::rpc::Chunk>(Arena*);
template <>
::gs::rpc::ChunkMeta* Arena::CreateMaybeMessage<::gs::rpc::ChunkMeta>(Arena*);
template <>
::gs::rpc::ChunkMeta_AttrEntry_DoNotUse* Arena::CreateMaybeMessage<::gs::rpc::ChunkMeta_AttrEntry_DoNotUse>(Arena*);
template <>
::gs::rpc::Chunk_AttrEntry_DoNotUse* Arena::CreateMaybeMessage<::gs::rpc::Chunk_AttrEntry_DoNotUse>(Arena*);
template <>
::gs::rpc::LargeAttrValue* Arena::CreateMaybeMessage<::gs::rpc::LargeAttrValue>(Arena*);
template <>
::gs::rpc::LargeAttrValue_ChunkList* Arena::CreateMaybeMessage<::gs::rpc::LargeAttrValue_ChunkList>(Arena*);
template <>
::gs::rpc::LargeAttrValue_ChunkMetaList* Arena::CreateMaybeMessage<::gs::rpc::LargeAttrValue_ChunkMetaList>(Arena*);
template <>
::gs::rpc::NameAttrList* Arena::CreateMaybeMessage<::gs::rpc::NameAttrList>(Arena*);
template <>
::gs::rpc::NameAttrList_AttrEntry_DoNotUse* Arena::CreateMaybeMessage<::gs::rpc::NameAttrList_AttrEntry_DoNotUse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
inline const std::string& AttrValue_NullValue_Name(AttrValue_NullValue value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<AttrValue_NullValue_descriptor,
                                                 0, 0>(
...
class AttrValue_ListValue final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField<float>& f() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField<float>* mutable_f();

  private:
  float _internal_f(int index) const;
  void _internal_add_f(float value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField<float>& _internal_f() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField<float>* _internal_mutable_f();
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField<bool>& b() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField<bool>* mutable_b();

  private:
  bool _internal_b(int index) const;
  void _internal_add_b(bool value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField<bool>& _internal_b() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField<bool>* _internal_mutable_b();
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::gs::rpc::NameAttrList>& _internal_func() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::gs::rpc::NameAttrList>* _internal_mutable_func();
  public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::gs::rpc::AttrValue_ListValue>& _internal_list() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::gs::rpc::AttrValue_ListValue>* _internal_mutable_list();
  public:
...
class AttrValue final :
 ...
 public:
  ...
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* NullValue_descriptor() {
...
class NameAttrList_AttrEntry_DoNotUse final : public ::PROTOBUF_NAMESPACE_ID::internal::MapEntry<NameAttrList_AttrEntry_DoNotUse, 
...
class Chunk_AttrEntry_DoNotUse final : public ::PROTOBUF_NAMESPACE_ID::internal::MapEntry<Chunk_AttrEntry_DoNotUse, 
    ::int32_t, ::gs::rpc::AttrValue,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_INT32,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_MESSAGE> {
public:
...
class ChunkMeta_AttrEntry_DoNotUse final : public ::PROTOBUF_NAMESPACE_ID::internal::MapEntry<ChunkMeta_AttrEntry_DoNotUse, 
    ::int32_t, ::gs::rpc::AttrValue,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_INT32,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_MESSAGE> {
public:
...
class LargeAttrValue_ChunkList final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::gs::rpc::Chunk>& _internal_items() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::gs::rpc::Chunk>* _internal_mutable_items();
  public:
...
class LargeAttrValue_ChunkMetaList final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::gs::rpc::ChunkMeta>& _internal_items() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::gs::rpc::ChunkMeta>* _internal_mutable_items();
  public:
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* AttrValue_ListValue::mutable_s() {
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int64_t>& AttrValue_ListValue::i() const {
  // @@protoc_insertion_point(field_list:gs.rpc.AttrValue.ListValue.i)
  return _internal_i();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int64_t>* AttrValue_ListValue::mutable_i() {
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int64_t>& AttrValue_ListValue::_internal_i() const {
  return _impl_.i_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<::int64_t>* AttrValue_ListValue::_internal_mutable_i() {
  return &_impl_.i_;
}
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<float>& AttrValue_ListValue::f() const {
  // @@protoc_insertion_point(field_list:gs.rpc.AttrValue.ListValue.f)
  return _internal_f();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<float>* AttrValue_ListValue::mutable_f() {
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<float>& AttrValue_ListValue::_internal_f() const {
  return _impl_.f_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<float>* AttrValue_ListValue::_internal_mutable_f() {
  return &_impl_.f_;
}
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<bool>& AttrValue_ListValue::b() const {
  // @@protoc_insertion_point(field_list:gs.rpc.AttrValue.ListValue.b)
  return _internal_b();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<bool>* AttrValue_ListValue::mutable_b() {
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<bool>& AttrValue_ListValue::_internal_b() const {
  return _impl_.b_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<bool>* AttrValue_ListValue::_internal_mutable_b() {
  return &_impl_.b_;
}
...
inline ::gs::rpc::NameAttrList* AttrValue_ListValue::_internal_add_func() {
  return _internal_mutable_func()->Add();
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_graphscope_2fproto_2fattr_5fvalue_2eproto_2epb_2eh
