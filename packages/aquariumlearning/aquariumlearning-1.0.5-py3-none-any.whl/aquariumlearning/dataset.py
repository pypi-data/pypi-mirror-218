...
class LabeledFrame(BaseFrame):
    ...
    def _length_of_labels(self) -> int:
...
class Dataset:
    ...
    def __init__(
        ...
        *,
        ...
        self.experimental_streaming_v2 = experimental_streaming_v2
    ...
    def _run_flush_to_disk_if_necessary(self) -> None:
        ...
        if len(self._frames) > MAX_FRAMES_PER_BATCH or (
            self.experimental_streaming_v2
            and len(self._frames) + self._label_count_total > MAX_DATAPOINTS_PER_BATCH
        ):
            self._flush_to_disk()

            self._frames = []
            self._label_count_total = 0
    ...
    def _flush_to_disk_streaming(self) -> None:
        ...
        if crop_path:
            ...
            self._temp_crop_count_per_file_streaming.append(self._label_count_total)
    ...
    def add_frame(self, frame: LabeledFrame) -> None:
        ...
        self._label_count_total += frame._length_of_labels()
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            experimental_streaming_v2=experimental_streaming_v2,
        )
...
class UnlabeledDatasetV2(Dataset):
    ...
    def add_frame(self, frame: UnlabeledFrameV2) -> None:  # type: ignore[override]
        ...
        if frame_count >= MAX_FRAMES_PER_BATCH or label_count >= MAX_FRAMES_PER_BATCH:
            self._flush_to_disk()
