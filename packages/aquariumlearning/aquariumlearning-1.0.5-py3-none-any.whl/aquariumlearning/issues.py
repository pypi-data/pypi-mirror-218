...
class IssueManager:
    ...
    def create_issue(
        ...
        if inference_set is None:
            payload_dataset = ".".join([self.project_id, dataset])
            payload_compare_dataset = None
        else:
            payload_dataset = ".".join([self.project_id, inference_set])
            payload_compare_dataset = ".".join([self.project_id, dataset])
        ...
        issue_uuid = resp_data["id"]
        if issue_type_info.get("create_collection_campaign"):
