...
class Inferences:
    ...
    def __init__(self, experimental_streaming_v2: bool = False) -> None:
    ...
    def _run_flush_to_disk_if_necessary(self) -> None:
        ...
        ) or len(self._frames) > MAX_FRAMES_PER_BATCH:
            self._flush_to_disk()
    ...
    def _flush_to_disk(self) -> None:
        ...
        if frame_path:
            ...
            self._temp_crop_count_per_file.append(self._label_count_total)
    ...
    def add_frame(self, frame: InferencesFrame) -> None:
        ...
        self._label_count_total += len(frame)
