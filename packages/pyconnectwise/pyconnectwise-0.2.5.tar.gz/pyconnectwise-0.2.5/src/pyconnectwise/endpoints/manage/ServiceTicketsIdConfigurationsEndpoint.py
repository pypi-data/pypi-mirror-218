...
from pyconnectwise.endpoints.manage.ServiceTicketsIdConfigurationsCountEndpoint import ServiceTicketsIdConfigurationsCountEndpoint
...
class ServiceTicketsIdConfigurationsEndpoint(ConnectWiseEndpoint):
    ...
    def paginated(self, page: int, page_size: int, params: dict[str, int | str] = {}) -> PaginatedResponse[ConfigurationReferenceModel]:
        """
        Performs a GET request against the /service/tickets/{parentId}/configurations endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[ConfigurationReferenceModel]:
        """
        Performs a GET request against the /service/tickets/{parentId}/configurations endpoint.
    ...
    def post(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> ConfigurationReferenceModel:
        """
        Performs a POST request against the /service/tickets/{parentId}/configurations endpoint.
