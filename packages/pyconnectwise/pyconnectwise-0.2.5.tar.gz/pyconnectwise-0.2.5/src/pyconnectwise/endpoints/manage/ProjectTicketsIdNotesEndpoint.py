...
from pyconnectwise.models.manage.TicketNoteModel import TicketNoteModel
...
class ProjectTicketsIdNotesEndpoint(ConnectWiseEndpoint):
    ...
    def paginated(self, page: int, page_size: int, params: dict[str, int | str] = {}) -> PaginatedResponse[TicketNoteModel]:
        """
        Performs a GET request against the /project/tickets/{parentId}/notes endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[TicketNoteModel]:
        """
        Performs a GET request against the /project/tickets/{parentId}/notes endpoint.
    ...
    def post(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> TicketNoteModel:
        """
        Performs a POST request against the /project/tickets/{parentId}/notes endpoint.
