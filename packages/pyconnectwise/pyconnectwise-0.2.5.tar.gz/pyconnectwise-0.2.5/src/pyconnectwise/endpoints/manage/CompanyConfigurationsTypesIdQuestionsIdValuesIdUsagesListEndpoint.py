...
class CompanyConfigurationsTypesIdQuestionsIdValuesIdUsagesListEndpoint(ConnectWiseEndpoint):
    ...
    def paginated(self, page: int, page_size: int, params: dict[str, int | str] = {}) -> PaginatedResponse[UsageModel]:
        """
        Performs a GET request against the /company/configurations/types/{grandparentId}/questions/{parentId}/values/{id}/usages/list endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[UsageModel]:
        """
        Performs a GET request against the /company/configurations/types/{grandparentId}/questions/{parentId}/values/{id}/usages/list endpoint.
