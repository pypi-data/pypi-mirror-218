...
from pyconnectwise.endpoints.manage.FinanceTaxCodesIdTaxCodeXRefsIdTaxableXRefLevelsIdEndpoint import FinanceTaxCodesIdTaxCodeXRefsIdTaxableXRefLevelsIdEndpoint
from pyconnectwise.endpoints.manage.FinanceTaxCodesIdTaxCodeXRefsIdTaxableXRefLevelsCountEndpoint import FinanceTaxCodesIdTaxCodeXRefsIdTaxableXRefLevelsCountEndpoint
...
class FinanceTaxCodesIdTaxCodeXRefsIdTaxableXRefLevelsEndpoint(ConnectWiseEndpoint):
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[TaxableXRefLevelModel]:
        ...
        """
        return self._parse_many(TaxableXRefLevelModel, super().make_request("GET", data=data, params=params).json())
    ...
    def post(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> TaxableXRefLevelModel:
        ...
        """
        return self._parse_one(TaxableXRefLevelModel, super().make_request("POST", data=data, params=params).json())
