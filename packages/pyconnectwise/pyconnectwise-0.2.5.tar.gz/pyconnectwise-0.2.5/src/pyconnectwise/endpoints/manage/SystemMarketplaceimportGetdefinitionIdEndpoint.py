...
class SystemMarketplaceimportGetdefinitionIdEndpoint(ConnectWiseEndpoint):
    ...
    def paginated(self, page: int, page_size: int, params: dict[str, int | str] = {}) -> PaginatedResponse[MarketplaceImportModel]:
        ...
        Returns:
            PaginatedResponse[MarketplaceImportModel]: The initialized PaginatedResponse object.
        """
        params["page"] = page
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> MarketplaceImportModel:
        """
        ...
        """
        return self._parse_one(MarketplaceImportModel, super().make_request("GET", data=data, params=params).json())
