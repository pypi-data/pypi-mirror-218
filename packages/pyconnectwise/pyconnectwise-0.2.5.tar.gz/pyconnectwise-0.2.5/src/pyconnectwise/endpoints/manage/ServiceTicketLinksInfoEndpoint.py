...
from pyconnectwise.models.manage.ServiceTicketLinkInfoModel import ServiceTicketLinkInfoModel
...
class ServiceTicketLinksInfoEndpoint(ConnectWiseEndpoint):
    ...
    def paginated(self, page: int, page_size: int, params: dict[str, int | str] = {}) -> PaginatedResponse[ServiceTicketLinkInfoModel]:
        ...
        Returns:
            PaginatedResponse[ServiceTicketLinkInfoModel]: The initialized PaginatedResponse object.
        """
        params["page"] = page
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[ServiceTicketLinkInfoModel]:
        """
        ...
        Parameters:
            ...
            params (dict[str, int | str]): The parameters to send in the request query string.
        Returns:
            list[ServiceTicketLinkInfoModel]: The parsed response data.
        """
        return self._parse_many(ServiceTicketLinkInfoModel, super().make_request("GET", data=data, params=params).json())
