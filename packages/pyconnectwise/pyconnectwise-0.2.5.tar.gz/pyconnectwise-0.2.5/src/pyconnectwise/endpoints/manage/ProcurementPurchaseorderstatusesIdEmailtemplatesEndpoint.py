...
from pyconnectwise.endpoints.manage.ProcurementPurchaseorderstatusesIdEmailtemplatesIdEndpoint import ProcurementPurchaseorderstatusesIdEmailtemplatesIdEndpoint
from pyconnectwise.endpoints.manage.ProcurementPurchaseorderstatusesIdEmailtemplatesCountEndpoint import ProcurementPurchaseorderstatusesIdEmailtemplatesCountEndpoint
...
class ProcurementPurchaseorderstatusesIdEmailtemplatesEndpoint(ConnectWiseEndpoint):
    ...
    def paginated(self, page: int, page_size: int, params: dict[str, int | str] = {}) -> PaginatedResponse[PurchaseOrderStatusEmailTemplateModel]:
        """
        Performs a GET request against the /procurement/purchaseorderstatuses/{parentId}/emailtemplates/ endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[PurchaseOrderStatusEmailTemplateModel]:
        """
        Performs a GET request against the /procurement/purchaseorderstatuses/{parentId}/emailtemplates/ endpoint.
    ...
    def post(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> PurchaseOrderStatusEmailTemplateModel:
        """
        Performs a POST request against the /procurement/purchaseorderstatuses/{parentId}/emailtemplates/ endpoint.
