...
from pyconnectwise.endpoints.manage.CompanyManagementIdExecuteManagedItSyncEndpoint import CompanyManagementIdExecuteManagedItSyncEndpoint
from pyconnectwise.endpoints.manage.CompanyManagementIdLogsEndpoint import CompanyManagementIdLogsEndpoint
from pyconnectwise.endpoints.manage.CompanyManagementIdManagementReportNotificationsEndpoint import CompanyManagementIdManagementReportNotificationsEndpoint
...
class CompanyManagementIdEndpoint(ConnectWiseEndpoint):
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> ManagementModel:
        """
