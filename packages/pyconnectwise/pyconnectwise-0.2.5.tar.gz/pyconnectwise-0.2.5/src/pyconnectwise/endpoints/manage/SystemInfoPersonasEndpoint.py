...
from pyconnectwise.models.manage.PersonasInfoModel import PersonasInfoModel
...
class SystemInfoPersonasEndpoint(ConnectWiseEndpoint):
    ...
    def paginated(self, page: int, page_size: int, params: dict[str, int | str] = {}) -> PaginatedResponse[PersonasInfoModel]:
        """
        ...
        Returns:
            PaginatedResponse[PersonasInfoModel]: The initialized PaginatedResponse object.
        """
        params["page"] = page
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[PersonasInfoModel]:
        """
        ...
        Parameters:
            ...
            params (dict[str, int | str]): The parameters to send in the request query string.
        Returns:
            list[PersonasInfoModel]: The parsed response data.
        """
        return self._parse_many(PersonasInfoModel, super().make_request("GET", data=data, params=params).json())
