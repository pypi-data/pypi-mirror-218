...
class ScheduleEntriesIdDetailsEndpoint(ConnectWiseEndpoint):
    ...
    def paginated(self, page: int, page_size: int, params: dict[str, int | str] = {}) -> PaginatedResponse[ScheduleDetailModel]:
        """
        Performs a GET request against the /schedule/entries/{parentId}/details endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[ScheduleDetailModel]:
        """
        Performs a GET request against the /schedule/entries/{parentId}/details endpoint.
