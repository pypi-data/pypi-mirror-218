...
from pyconnectwise.models.manage.PurchasingDemandModel import PurchasingDemandModel
...
class ProcurementPurchasingDemandsEndpoint(ConnectWiseEndpoint):
    ...
    def post(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> PurchasingDemandModel:
        ...
        """
        return self._parse_one(PurchasingDemandModel, super().make_request("POST", data=data, params=params).json())
