...
from pyconnectwise.endpoints.manage.ProcurementWarehouseBinsInfoCountEndpoint import ProcurementWarehouseBinsInfoCountEndpoint
...
class ProcurementWarehouseBinsInfoEndpoint(ConnectWiseEndpoint):
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[WarehouseBinInfoModel]:
        """
        ...
        Parameters:
            ...
            params (dict[str, int | str]): The parameters to send in the request query string.
        Returns:
            list[WarehouseBinInfoModel]: The parsed response data.
        """
        return self._parse_many(WarehouseBinInfoModel, super().make_request("GET", data=data, params=params).json())
