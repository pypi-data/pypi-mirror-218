...
from pyconnectwise.models.manage.SchedulingMemberInfoModel import SchedulingMemberInfoModel
...
class ServiceSchedulingMembersInfoEndpoint(ConnectWiseEndpoint):
    ...
    def paginated(self, page: int, page_size: int, params: dict[str, int | str] = {}) -> PaginatedResponse[SchedulingMemberInfoModel]:
        ...
        Returns:
            PaginatedResponse[SchedulingMemberInfoModel]: The initialized PaginatedResponse object.
        """
        params["page"] = page
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[SchedulingMemberInfoModel]:
        """
        ...
        Parameters:
            ...
            params (dict[str, int | str]): The parameters to send in the request query string.
        Returns:
            list[SchedulingMemberInfoModel]: The parsed response data.
        """
        return self._parse_many(SchedulingMemberInfoModel, super().make_request("GET", data=data, params=params).json())
