...
from pyconnectwise.models.manage.BoardTypeInfoModel import BoardTypeInfoModel
...
class ServiceInfoBoardtypesEndpoint(ConnectWiseEndpoint):
    ...
    def paginated(self, page: int, page_size: int, params: dict[str, int | str] = {}) -> PaginatedResponse[BoardTypeInfoModel]:
        """
        ...
        Returns:
            PaginatedResponse[BoardTypeInfoModel]: The initialized PaginatedResponse object.
        """
        params["page"] = page
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[BoardTypeInfoModel]:
        """
        ...
        Parameters:
            ...
            params (dict[str, int | str]): The parameters to send in the request query string.
        Returns:
            list[BoardTypeInfoModel]: The parsed response data.
        """
        return self._parse_many(BoardTypeInfoModel, super().make_request("GET", data=data, params=params).json())
