...
from pyconnectwise.endpoints.manage.SystemEmailConnectorsIdParsingStylesIdEndpoint import SystemEmailConnectorsIdParsingStylesIdEndpoint
from pyconnectwise.endpoints.manage.SystemEmailConnectorsIdParsingStylesCountEndpoint import SystemEmailConnectorsIdParsingStylesCountEndpoint
...
class SystemEmailConnectorsIdParsingStylesEndpoint(ConnectWiseEndpoint):
    ...
    def paginated(self, page: int, page_size: int, params: dict[str, int | str] = {}) -> PaginatedResponse[EmailConnectorParsingStyleModel]:
        """
        Performs a GET request against the /system/emailConnectors/{parentId}/parsingStyles endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[EmailConnectorParsingStyleModel]:
        """
        Performs a GET request against the /system/emailConnectors/{parentId}/parsingStyles endpoint.
    ...
    def post(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> EmailConnectorParsingStyleModel:
        """
        Performs a POST request against the /system/emailConnectors/{parentId}/parsingStyles endpoint.
