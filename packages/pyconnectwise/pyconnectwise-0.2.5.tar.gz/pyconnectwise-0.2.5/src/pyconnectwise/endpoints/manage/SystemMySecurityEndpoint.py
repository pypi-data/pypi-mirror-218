...
from pyconnectwise.models.manage.MySecurityModel import MySecurityModel
...
class SystemMySecurityEndpoint(ConnectWiseEndpoint):
    ...
    def paginated(self, page: int, page_size: int, params: dict[str, int | str] = {}) -> PaginatedResponse[MySecurityModel]:
        ...
        Returns:
            PaginatedResponse[MySecurityModel]: The initialized PaginatedResponse object.
        """
        params["page"] = page
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[MySecurityModel]:
        """
