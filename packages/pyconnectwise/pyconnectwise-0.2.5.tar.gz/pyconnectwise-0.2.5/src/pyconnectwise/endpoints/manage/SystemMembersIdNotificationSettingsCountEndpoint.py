...
class SystemMembersIdNotificationSettingsCountEndpoint(ConnectWiseEndpoint):
    ...
    def paginated(self, page: int, page_size: int, params: dict[str, int | str] = {}) -> PaginatedResponse[CountModel]:
        """
        Performs a GET request against the /system/members/{parentId}/notificationSettings/count endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> CountModel:
        """
        Performs a GET request against the /system/members/{parentId}/notificationSettings/count endpoint.
