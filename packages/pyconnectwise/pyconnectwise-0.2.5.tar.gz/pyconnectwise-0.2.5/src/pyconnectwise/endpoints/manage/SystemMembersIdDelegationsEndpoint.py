...
from pyconnectwise.endpoints.manage.SystemMembersIdDelegationsCountEndpoint import SystemMembersIdDelegationsCountEndpoint
...
class SystemMembersIdDelegationsEndpoint(ConnectWiseEndpoint):
    ...
    def paginated(self, page: int, page_size: int, params: dict[str, int | str] = {}) -> PaginatedResponse[MemberDelegationModel]:
        """
        Performs a GET request against the /system/members/{parentId}/delegations endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[MemberDelegationModel]:
        """
        Performs a GET request against the /system/members/{parentId}/delegations endpoint.
        ...
        """
        return self._parse_many(MemberDelegationModel, super().make_request("GET", data=data, params=params).json())
        
    def post(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> MemberDelegationModel:
        """
        Performs a POST request against the /system/members/{parentId}/delegations endpoint.
        ...
        """
        return self._parse_one(MemberDelegationModel, super().make_request("POST", data=data, params=params).json())
