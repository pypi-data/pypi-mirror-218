...
from pyconnectwise.endpoints.manage.CompanyContactsDepartmentsInfoCountEndpoint import CompanyContactsDepartmentsInfoCountEndpoint
...
class CompanyContactsDepartmentsInfoEndpoint(ConnectWiseEndpoint):
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[ContactDepartmentInfoModel]:
        """
