...
class ProjectTicketsIdProductsEndpoint(ConnectWiseEndpoint):
    ...
    def paginated(self, page: int, page_size: int, params: dict[str, int | str] = {}) -> PaginatedResponse[ProductReferenceModel]:
        """
        Performs a GET request against the /project/tickets/{parentId}/products endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[ProductReferenceModel]:
        """
        Performs a GET request against the /project/tickets/{parentId}/products endpoint.
        ...
        """
        return self._parse_many(ProductReferenceModel, super().make_request("GET", data=data, params=params).json())
