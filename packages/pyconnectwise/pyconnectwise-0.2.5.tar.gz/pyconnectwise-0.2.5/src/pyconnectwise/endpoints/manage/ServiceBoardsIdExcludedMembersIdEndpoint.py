...
class ServiceBoardsIdExcludedMembersIdEndpoint(ConnectWiseEndpoint):
    ...
    def paginated(self, page: int, page_size: int, params: dict[str, int | str] = {}) -> PaginatedResponse[BoardExcludedMemberModel]:
        """
        Performs a GET request against the /service/boards/{parentId}/excludedMembers/{id} endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> BoardExcludedMemberModel:
        """
        Performs a GET request against the /service/boards/{parentId}/excludedMembers/{id} endpoint.
        ...
        """
        return self._parse_one(BoardExcludedMemberModel, super().make_request("GET", data=data, params=params).json())
        
    def delete(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> GenericMessageModel:
        """
        Performs a DELETE request against the /service/boards/{parentId}/excludedMembers/{id} endpoint.
