...
class CompanyPortalConfigurationsIdOpportunitySetupsIdEndpoint(ConnectWiseEndpoint):
    ...
    def paginated(self, page: int, page_size: int, params: dict[str, int | str] = {}) -> PaginatedResponse[PortalConfigurationOpportunitySetupModel]:
        """
        Performs a GET request against the /company/portalConfigurations/{parentId}/opportunitySetups/{id} endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> PortalConfigurationOpportunitySetupModel:
        """
        Performs a GET request against the /company/portalConfigurations/{parentId}/opportunitySetups/{id} endpoint.
        ...
        """
        return self._parse_one(PortalConfigurationOpportunitySetupModel, super().make_request("GET", data=data, params=params).json())
        
    def put(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> PortalConfigurationOpportunitySetupModel:
        """
        Performs a PUT request against the /company/portalConfigurations/{parentId}/opportunitySetups/{id} endpoint.
    ...
    def patch(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> PortalConfigurationOpportunitySetupModel:
        """
        Performs a PATCH request against the /company/portalConfigurations/{parentId}/opportunitySetups/{id} endpoint.
