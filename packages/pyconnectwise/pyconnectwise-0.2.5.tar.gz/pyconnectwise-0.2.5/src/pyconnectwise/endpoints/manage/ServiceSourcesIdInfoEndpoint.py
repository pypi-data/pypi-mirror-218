...
from pyconnectwise.models.manage.SourceInfoModel import SourceInfoModel
...
class ServiceSourcesIdInfoEndpoint(ConnectWiseEndpoint):
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> SourceInfoModel:
        ...
        """
        return self._parse_one(SourceInfoModel, super().make_request("GET", data=data, params=params).json())
