...
from pyconnectwise.models.manage.TimeZoneSetupInfoModel import TimeZoneSetupInfoModel
...
class SystemTimeZoneSetupsInfoEndpoint(ConnectWiseEndpoint):
    ...
    def paginated(self, page: int, page_size: int, params: dict[str, int | str] = {}) -> PaginatedResponse[TimeZoneSetupInfoModel]:
        ...
        Returns:
            PaginatedResponse[TimeZoneSetupInfoModel]: The initialized PaginatedResponse object.
        """
        params["page"] = page
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[TimeZoneSetupInfoModel]:
        """
        ...
        Parameters:
            ...
            params (dict[str, int | str]): The parameters to send in the request query string.
        Returns:
            list[TimeZoneSetupInfoModel]: The parsed response data.
        """
        return self._parse_many(TimeZoneSetupInfoModel, super().make_request("GET", data=data, params=params).json())
