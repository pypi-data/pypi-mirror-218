...
from pyconnectwise.models.manage.TimePeriodSetupDefaultsModel import TimePeriodSetupDefaultsModel
...
class TimeTimePeriodSetupsDefaultEndpoint(ConnectWiseEndpoint):
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> TimePeriodSetupDefaultsModel:
        ...
        """
        return self._parse_one(TimePeriodSetupDefaultsModel, super().make_request("GET", data=data, params=params).json())
