...
from pyconnectwise.endpoints.manage.MarketingCampaignsSubTypesCountEndpoint import MarketingCampaignsSubTypesCountEndpoint
...
class MarketingCampaignsSubTypesEndpoint(ConnectWiseEndpoint):
    ...
    def post(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> CampaignSubTypeModel:
        """
        ...
        """
        return self._parse_one(CampaignSubTypeModel, super().make_request("POST", data=data, params=params).json())
