...
from pyconnectwise.models.manage.ProjectTicketNoteModel import ProjectTicketNoteModel
...
class ProjectTicketsIdAllNotesEndpoint(ConnectWiseEndpoint):
    ...
    def paginated(self, page: int, page_size: int, params: dict[str, int | str] = {}) -> PaginatedResponse[ProjectTicketNoteModel]:
        ...
        Returns:
            PaginatedResponse[ProjectTicketNoteModel]: The initialized PaginatedResponse object.
        """
        params["page"] = page
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[ProjectTicketNoteModel]:
        """
        Performs a GET request against the /project/tickets/{parentId}/allNotes endpoint.
