...
from pyconnectwise.endpoints.manage.SystemLocationsIdWorkRolesCountEndpoint import SystemLocationsIdWorkRolesCountEndpoint
...
class SystemLocationsIdWorkRolesEndpoint(ConnectWiseEndpoint):
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[LocationWorkRoleModel]:
        ...
        """
        return self._parse_many(LocationWorkRoleModel, super().make_request("GET", data=data, params=params).json())
