...
from pyconnectwise.endpoints.manage.SalesOpportunitiesStatusesInfoCountEndpoint import SalesOpportunitiesStatusesInfoCountEndpoint
from pyconnectwise.models.manage.OpportunityStatusInfoModel import OpportunityStatusInfoModel
...
class SalesOpportunitiesStatusesInfoEndpoint(ConnectWiseEndpoint):
    ...
    def paginated(self, page: int, page_size: int, params: dict[str, int | str] = {}) -> PaginatedResponse[OpportunityStatusInfoModel]:
        ...
        Returns:
            PaginatedResponse[OpportunityStatusInfoModel]: The initialized PaginatedResponse object.
        """
        params["page"] = page
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[OpportunityStatusInfoModel]:
        ...
        Parameters:
            ...
            params (dict[str, int | str]): The parameters to send in the request query string.
        Returns:
            list[OpportunityStatusInfoModel]: The parsed response data.
        """
        return self._parse_many(OpportunityStatusInfoModel, super().make_request("GET", data=data, params=params).json())
