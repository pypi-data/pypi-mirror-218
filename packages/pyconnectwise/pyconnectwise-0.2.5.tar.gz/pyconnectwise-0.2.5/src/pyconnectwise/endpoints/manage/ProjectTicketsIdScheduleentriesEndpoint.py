...
from pyconnectwise.endpoints.manage.ProjectTicketsIdScheduleentriesCountEndpoint import ProjectTicketsIdScheduleentriesCountEndpoint
...
class ProjectTicketsIdScheduleentriesEndpoint(ConnectWiseEndpoint):
    ...
    def paginated(self, page: int, page_size: int, params: dict[str, int | str] = {}) -> PaginatedResponse[ScheduleEntryReferenceModel]:
        """
        Performs a GET request against the /project/tickets/{parentId}/scheduleentries endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[ScheduleEntryReferenceModel]:
        """
        Performs a GET request against the /project/tickets/{parentId}/scheduleentries endpoint.
