...
from pyconnectwise.endpoints.manage.ServiceTicketsIdTimeentriesCountEndpoint import ServiceTicketsIdTimeentriesCountEndpoint
...
class ServiceTicketsIdTimeentriesEndpoint(ConnectWiseEndpoint):
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[TimeEntryReferenceModel]:
        """
        Performs a GET request against the /service/tickets/{parentId}/timeentries endpoint.
        ...
        """
        return self._parse_many(TimeEntryReferenceModel, super().make_request("GET", data=data, params=params).json())
