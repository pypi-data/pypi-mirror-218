...
from pyconnectwise.endpoints.manage.SystemWorkflowsTableTypesIdInfoEndpoint import SystemWorkflowsTableTypesIdInfoEndpoint
...
class SystemWorkflowsTableTypesIdEndpoint(ConnectWiseEndpoint):
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> WorkflowTableTypeModel:
        """
        ...
        Parameters:
            ...
            params (dict[str, int | str]): The parameters to send in the request query string.
        Returns:
            WorkflowTableTypeModel: The parsed response data.
        """
        return self._parse_one(WorkflowTableTypeModel, super().make_request("GET", data=data, params=params).json())
