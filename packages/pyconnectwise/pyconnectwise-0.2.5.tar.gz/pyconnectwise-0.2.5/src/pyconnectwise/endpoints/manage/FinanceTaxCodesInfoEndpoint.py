...
from pyconnectwise.models.manage.TaxCodeInfoModel import TaxCodeInfoModel
...
class FinanceTaxCodesInfoEndpoint(ConnectWiseEndpoint):
    ...
    def paginated(self, page: int, page_size: int, params: dict[str, int | str] = {}) -> PaginatedResponse[TaxCodeInfoModel]:
        ...
        Returns:
            PaginatedResponse[TaxCodeInfoModel]: The initialized PaginatedResponse object.
        """
        params["page"] = page
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[TaxCodeInfoModel]:
        """
        ...
        Parameters:
            ...
            params (dict[str, int | str]): The parameters to send in the request query string.
        Returns:
            list[TaxCodeInfoModel]: The parsed response data.
        """
        return self._parse_many(TaxCodeInfoModel, super().make_request("GET", data=data, params=params).json())
