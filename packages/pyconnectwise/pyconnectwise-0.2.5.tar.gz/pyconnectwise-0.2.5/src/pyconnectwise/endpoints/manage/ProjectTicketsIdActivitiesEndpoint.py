...
class ProjectTicketsIdActivitiesEndpoint(ConnectWiseEndpoint):
    ...
    def paginated(self, page: int, page_size: int, params: dict[str, int | str] = {}) -> PaginatedResponse[ActivityReferenceModel]:
        """
        Performs a GET request against the /project/tickets/{parentId}/activities endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[ActivityReferenceModel]:
        """
        Performs a GET request against the /project/tickets/{parentId}/activities endpoint.
