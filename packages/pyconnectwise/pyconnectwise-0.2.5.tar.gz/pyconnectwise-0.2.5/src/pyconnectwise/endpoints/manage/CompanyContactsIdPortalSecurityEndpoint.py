...
from pyconnectwise.models.manage.PortalSecurityModel import PortalSecurityModel
...
class CompanyContactsIdPortalSecurityEndpoint(ConnectWiseEndpoint):
    ...
    def paginated(self, page: int, page_size: int, params: dict[str, int | str] = {}) -> PaginatedResponse[PortalSecurityModel]:
        ...
        Returns:
            PaginatedResponse[PortalSecurityModel]: The initialized PaginatedResponse object.
        """
        params["page"] = page
