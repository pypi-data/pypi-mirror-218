...
class MarketingCampaignsTypesIdSubTypesIdEndpoint(ConnectWiseEndpoint):
    ...
    def paginated(self, page: int, page_size: int, params: dict[str, int | str] = {}) -> PaginatedResponse[CampaignSubTypeModel]:
        """
        Performs a GET request against the /marketing/campaigns/types/{parentId}/subTypes/{id} endpoint and returns an initialized PaginatedResponse object.
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> CampaignSubTypeModel:
        """
        Performs a GET request against the /marketing/campaigns/types/{parentId}/subTypes/{id} endpoint.
