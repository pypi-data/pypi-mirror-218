...
from pyconnectwise.endpoints.manage.ProcurementOnhandserialnumbersCountEndpoint import ProcurementOnhandserialnumbersCountEndpoint
from pyconnectwise.models.manage.OnHandSerialNumberModel import OnHandSerialNumberModel
...
class ProcurementOnhandserialnumbersEndpoint(ConnectWiseEndpoint):
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[OnHandSerialNumberModel]:
        ...
        """
        return self._parse_many(OnHandSerialNumberModel, super().make_request("GET", data=data, params=params).json())
