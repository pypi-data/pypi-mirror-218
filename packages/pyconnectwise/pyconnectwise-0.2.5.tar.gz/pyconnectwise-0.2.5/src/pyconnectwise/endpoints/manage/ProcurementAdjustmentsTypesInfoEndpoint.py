...
from pyconnectwise.endpoints.manage.ProcurementAdjustmentsTypesInfoCountEndpoint import ProcurementAdjustmentsTypesInfoCountEndpoint
...
class ProcurementAdjustmentsTypesInfoEndpoint(ConnectWiseEndpoint):
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[AdjustmentTypeInfoModel]:
        """
