...
from pyconnectwise.models.manage.ManagementLogDocumentInfoModel import ManagementLogDocumentInfoModel
...
class CompanyManagementIdLogsEndpoint(ConnectWiseEndpoint):
    ...
    def paginated(self, page: int, page_size: int, params: dict[str, int | str] = {}) -> PaginatedResponse[ManagementLogDocumentInfoModel]:
        ...
        Returns:
            PaginatedResponse[ManagementLogDocumentInfoModel]: The initialized PaginatedResponse object.
        """
        params["page"] = page
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[ManagementLogDocumentInfoModel]:
        """
        ...
        Parameters:
            ...
            params (dict[str, int | str]): The parameters to send in the request query string.
        Returns:
            list[ManagementLogDocumentInfoModel]: The parsed response data.
        """
        return self._parse_many(ManagementLogDocumentInfoModel, super().make_request("GET", data=data, params=params).json())
