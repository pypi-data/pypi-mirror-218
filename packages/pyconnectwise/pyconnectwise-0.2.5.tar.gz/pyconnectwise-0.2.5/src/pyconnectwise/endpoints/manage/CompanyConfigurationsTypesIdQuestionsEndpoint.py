...
from pyconnectwise.endpoints.manage.CompanyConfigurationsTypesIdQuestionsIdEndpoint import CompanyConfigurationsTypesIdQuestionsIdEndpoint
from pyconnectwise.endpoints.manage.CompanyConfigurationsTypesIdQuestionsCountEndpoint import CompanyConfigurationsTypesIdQuestionsCountEndpoint
...
class CompanyConfigurationsTypesIdQuestionsEndpoint(ConnectWiseEndpoint):
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[ConfigurationTypeQuestionModel]:
        ...
        """
        return self._parse_many(ConfigurationTypeQuestionModel, super().make_request("GET", data=data, params=params).json())
    ...
    def post(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> ConfigurationTypeQuestionModel:
        ...
        """
        return self._parse_one(ConfigurationTypeQuestionModel, super().make_request("POST", data=data, params=params).json())
