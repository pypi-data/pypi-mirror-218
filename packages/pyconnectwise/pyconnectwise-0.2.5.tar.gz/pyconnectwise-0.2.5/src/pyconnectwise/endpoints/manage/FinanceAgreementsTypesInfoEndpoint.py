...
from pyconnectwise.endpoints.manage.FinanceAgreementsTypesInfoCountEndpoint import FinanceAgreementsTypesInfoCountEndpoint
...
class FinanceAgreementsTypesInfoEndpoint(ConnectWiseEndpoint):
    ...
    def get(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[AgreementTypeInfoModel]:
        """
