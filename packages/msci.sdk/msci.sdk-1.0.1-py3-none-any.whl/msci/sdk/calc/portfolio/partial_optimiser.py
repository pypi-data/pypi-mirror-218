...
from .utils.enums import ExposureGroupBy
...
class PartialOptimizationNode:
    ...
    class MinimizeTrackingError(BaseDataClassValidator):
        ...
        def body(self):
            ...
            return {
                "nodeInfo": "MinimizeTrackingError",
                "node": {
    ...
    class LimitClimateValueAtRisk(BaseDataClassValidator):
        ...
        def body(self):
            ...
            return {
                "nodeInfo": "LimitClimateValueAtRisk",
                "node": {
