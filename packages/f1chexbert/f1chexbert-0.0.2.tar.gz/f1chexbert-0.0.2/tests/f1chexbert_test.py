...
def test_f1chexbert():
    ...
    expected_output = (0.6, np.array([1., 0., 0., 1., 1.], dtype=np.float32),
                       {'Enlarged Cardiomediastinum': {'precision': 0.0, 'recall': 0.0, 'f1-score': 0.0, 'support': 0},
                        'Cardiomegaly': {'precision': 0.0, 'recall': 0.0, 'f1-score': 0.0, 'support': 2},
                        'Lung Opacity': {'precision': 0.0, 'recall': 0.0, 'f1-score': 0.0, 'support': 1},
                        'Lung Lesion': {'precision': 0.0, 'recall': 0.0, 'f1-score': 0.0, 'support': 1},
                        'Edema': {'precision': 0.0, 'recall': 0.0, 'f1-score': 0.0, 'support': 0},
                        'Consolidation': {'precision': 1.0, 'recall': 1.0, 'f1-score': 1.0, 'support': 1},
                        'Pneumonia': {'precision': 0.0, 'recall': 0.0, 'f1-score': 0.0, 'support': 0},
                        'Atelectasis': {'precision': 0.0, 'recall': 0.0, 'f1-score': 0.0, 'support': 0},
                        'Pneumothorax': {'precision': 0.0, 'recall': 0.0, 'f1-score': 0.0, 'support': 0},
                        'Pleural Effusion': {'precision': 0.0, 'recall': 0.0, 'f1-score': 0.0, 'support': 0},
                        'Pleural Other': {'precision': 0.0, 'recall': 0.0, 'f1-score': 0.0, 'support': 0},
                        'Fracture': {'precision': 0.0, 'recall': 0.0, 'f1-score': 0.0, 'support': 0},
                        'Support Devices': {'precision': 0.0, 'recall': 0.0, 'f1-score': 0.0, 'support': 0},
                        'No Finding': {'precision': 0.5, 'recall': 1.0, 'f1-score': 0.6666666666666666, 'support': 1},
                        'micro avg': {'precision': 0.4, 'recall': 0.3333333333333333, 'f1-score': 0.3636363636363636,
                                      'support': 6},
                        'macro avg': {'precision': 0.10714285714285714, 'recall': 0.14285714285714285,
                                      'f1-score': 0.11904761904761904, 'support': 6},
                        'weighted avg': {'precision': 0.25, 'recall': 0.3333333333333333,
                                         'f1-score': 0.27777777777777773, 'support': 6},
                        'samples avg': {'precision': 0.4, 'recall': 0.4, 'f1-score': 0.4, 'support': 6}},
                       {'Cardiomegaly': {'precision': 0.0, 'recall': 0.0, 'f1-score': 0.0, 'support': 2},
                        'Edema': {'precision': 0.0, 'recall': 0.0, 'f1-score': 0.0, 'support': 0},
                        'Consolidation': {'precision': 1.0, 'recall': 1.0, 'f1-score': 1.0, 'support': 1},
                        'Atelectasis': {'precision': 0.0, 'recall': 0.0, 'f1-score': 0.0, 'support': 0},
                        ...
                        'micro avg': {'precision': 0.3333333333333333, 'recall': 0.3333333333333333,
                                      'f1-score': 0.3333333333333333, 'support': 3},
                        'macro avg': {'precision': 0.2, 'recall': 0.2, 'f1-score': 0.2, 'support': 3},
                        'weighted avg': {'precision': 0.3333333333333333, 'recall': 0.3333333333333333,
                                         'f1-score': 0.3333333333333333, 'support': 3},
                        'samples avg': {'precision': 0.2, 'recall': 0.2, 'f1-score': 0.2, 'support': 3}})
