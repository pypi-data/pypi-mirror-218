...
# def process_parcel(parcel, sourceSR, raster, work_dir, parcel_column):
#     parcel_locations = self.get_parcel_locations(parcel, sourceSR, raster, Path(work_dir))
#     if parcel_column is not None:
#         return str(parcel.GetField(parcel_column)), parcel_locations
#     else:
#         return parcel.GetFID(), parcel_locations
...
class ObjectLayer:
    ...
    def get_raster_parcel_values(self, parcel_id, input_array):
        mask_index = get_parcel_indices(parcel_id)
