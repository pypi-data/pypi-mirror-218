...
class EntityTC(CubicWebTC):
    ...
    def test_fetch_rql(self):
        ...
        for rdef, card in [
            ...
            (
                peschema.subjrels["connait"].relation_definition(peschema, peschema),
                "11",
            ),
            (
                peschema.subjrels["evaluee"].relation_definition(
                    peschema, Note.e_schema
                ),
                "1*",
            ),
            (
                seschema.subjrels["evaluee"].relation_definition(
