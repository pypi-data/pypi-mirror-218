...
def get_extra_and_output_project(
    ...
    kid_app_info, priority = get_kid_app_and_priority(primary_items, project)

    project_name_details = get_project_name_details(primary_items, project_name)

    final_project_line = get_final_project_line(
        project_name_details, launcher_task_info, priority, kid_app_info, blank
    )

    return handle_single_project(primary_items, project_name, final_project_line)


def get_kid_app_and_priority(primary_items, project):
    ...
    return kid_app_info, priority


def get_project_name_details(primary_items, project_name):
    return format_html(
        primary_items["colors_to_use"],
        "project_color",
        "",
...
def get_final_project_line(
    ...
    return final_project_line


def handle_single_project(primary_items, project_name, final_project_line):
...
def get_project_name(project: defusedxml.ElementTree.XML) -> str:
