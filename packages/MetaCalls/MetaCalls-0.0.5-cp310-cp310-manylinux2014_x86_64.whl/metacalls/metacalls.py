...
class MetaCalls(Methods, Scaffold):
    """MetaCalls Client, the main means
    for interacting with Group Calls.

    Attributes:
        active_calls (List of :obj:`~metacalls.types.GroupCall`):
            Get a list of active (Playing / Paused) group calls
        calls (List of :obj:`~metacalls.types.GroupCall`):
    ...
    def __init__(
        ...
        self._env_checker = Environment(
            ...
            self._REQUIRED_METAGRAM_VERSION,
