...
class CaptureAVDeviceDesktop(InputStream):
    ...
    Parameters:
        audio_info (:obj: `~metacalls.media_devices.DeviceInfo()`):
            The audio device capturing params
        screen_info (:obj: `~metacalls.media_devices.ScreenManager()`):
        ...
        video_parameters (:obj:`~metacalls.types.VideoParameters()`):
