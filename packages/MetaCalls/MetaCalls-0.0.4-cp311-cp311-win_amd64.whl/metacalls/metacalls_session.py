...
class MetaCallsSession:
    notice_displayed = False

    async def start(self):
        if not self.notice_displayed:
            MetaCallsSession.notice_displayed = True
            print(
                f'MetaCalls v{__version__}, Copyright (C) '
                f'2022-2023 AyiinXd <https://github.com/AyiinXd>\n'
            ...
            try:
                ...
                if VersionManager.version_tuple(remote_ver) > \
                    ...
                    text = f'Update Available!\n' \
                           f'New MetaCalls v{remote_readable_ver} ' \
                           f'is now available!\n'
