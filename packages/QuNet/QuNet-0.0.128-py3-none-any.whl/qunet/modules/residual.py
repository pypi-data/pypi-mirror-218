...
from .total    import get_activation, get_norm, get_dropout
...
class Residual(nn.Module):
    ...
    ```
    """
    def __init__(self, block, E, Eout=None, stride=1, res = 1, gamma=0.1, drop=0., drop_d=1, dim=1,
        ...
        self.p     = 0
        self.drop  = get_dropout(drop_d, drop)
