...
class ResidualSkip(nn.Sequential):
    """
    ...
    def __init__(self, Ein, Eout, norm, stride=1, dim=1):                
        ...
        if Ein != Eout or stride > 1:
            assert dim in [1,2], f"Wrong dim={dim} in ResidualSkip  {Ein}->{Eout}, stride={stride}"
...
class Residual(nn.Module):
    ...
    def __init__(self, block, E, Eout=None, stride=1, 
        ...
        self.align = ResidualSkip (E, Eout, norm_align, stride, dim)        
