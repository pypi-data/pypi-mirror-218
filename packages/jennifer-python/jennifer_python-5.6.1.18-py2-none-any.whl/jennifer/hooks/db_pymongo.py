        ...
        try:
            ...
            if agent is not None:
                ...
                if o is not None:
                    ...
                    pi = o.profiler.start_query(REMOTE_CALL_TYPE_MONGODB, self.collection + '.find(' + parameter + ')',
                                                self.host, self.port)
        ...
        try:
            ...
            if agent is not None:
                ...
                if o is not None:
                    ...
                    pi = o.profiler.start_query(REMOTE_CALL_TYPE_MONGODB,
                                                self.collection +
...
def hook(pymongo_module):
    ...
    if str(pymongo_module.MongoClient).startswith('jennifer.hooks') is True:
        return False
