...
class Agent(object):
    ...
    @staticmethod
    def gen_new_txid():
        return int(str(int(random() * 10000000)) + str(Agent.current_time())) & 0xffffffffffffffff
            ...
            try:
                ...
                if cmd == b'connected':
                    try:
                        ...
                        print('Jennifer Python Agent Inst ID = ', param.get('inst_id'), ', Version =', jennifer.__version__)
