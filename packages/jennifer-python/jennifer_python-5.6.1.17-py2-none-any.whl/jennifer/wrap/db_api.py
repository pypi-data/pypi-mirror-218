    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            if o is not None and operation is not None:
                ...
                pi = o.profiler.start_query(self.db_type, operation, self.host, self.port, parameters, self.paramstyle)
        except Exception as e:
            pass
...
class ConnectionProxy(Proxy):
    ...
    def cursor(self, *args, **kwargs):
        return CursorProxy(self._origin.cursor(*args, **kwargs), self.host, self.port, self.paramstyle, self, self.db_type)
