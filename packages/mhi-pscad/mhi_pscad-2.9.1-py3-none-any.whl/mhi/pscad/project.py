...
class GlobalSubstitution:
    ...
    @requires('5.0.2')
    def save_set(self, filename: str, set_name: str = None) -> None:
        """
        ...
        self._prj._gs_save(filename, False)         # pylint: disable=protected-access

    @requires('5.0.2')
    def load_set(self, filename: str, set_name: str = None) -> None:
        """
        ...
        if set_name:
            self.active_set = set_name
        self._prj._gs_load(filename, False, True)   # pylint: disable=protected-access

    @requires('5.0.2')
    def append_set(self, filename: str, set_name: str = None) -> None:
        """
        ...
        if set_name:
            self.active_set = set_name
        self._prj._gs_load(filename, False, False)  # pylint: disable=protected-access
    ...
    def save_all_sets(self, filename: str) -> None:
        ...
        self._prj._gs_save(filename, True)          # pylint: disable=protected-access
    ...
    def load_all_sets(self, filename: str) -> None:
        ...
        self._prj._gs_load(filename, True, True)    # pylint: disable=protected-access
    ...
    def append_all_sets(self, filename: str) -> None:
        ...
        self._prj._gs_load(filename, True, False)   # pylint: disable=protected-access
