...
class DafYomiBavli(LimudCalculator):
    ...
    def starting_page(self, _, unit_name: str) -> int:
        if unit_name == 'kinnim':
            return 23
    ...
    def cycle_end_calculation(self, start_date: JewishDate, iteration: int) -> JewishDate:  # type: ignore[override]
    ...
    def cycle_units_calculation(self, cycle: Cycle) -> dict:
        ...
        assert cycle.iteration is not None
