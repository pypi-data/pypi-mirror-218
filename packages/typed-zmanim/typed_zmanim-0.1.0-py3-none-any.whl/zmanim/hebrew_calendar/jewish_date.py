...
class JewishDate:
    ...
    def __init__(self, *args, **kwargs):
        ...
        elif len(args) == 1 and isinstance(args[0], datetime_date):
            self.date = args[0]
    ...
    @property
    def gregorian_date(self) -> datetime_date:
    ...
    @classmethod
    def from_date(cls, date: datetime_date) -> 'JewishDate':
        return cls(date)
    ...
    def __sub__(self, subtrahend: Union[int, timedelta, 'JewishDate', datetime_date]):
        ...
        elif isinstance(subtrahend, datetime_date):
    ...
    def cheshvan_kislev_kviah(self, year: Optional[int] = None) -> str:
        ...
        return list(self.CHESHVAN_KISLEV_KEVIAH)[year_type].name
    ...
    def _gregorian_date_to_abs_date(self, gregorian_date: datetime_date) -> int:
        return gregorian_date.toordinal()

    def _gregorian_date_from_abs_date(self, absolute_date: int) -> datetime_date:
        return datetime_date.fromordinal(absolute_date)
