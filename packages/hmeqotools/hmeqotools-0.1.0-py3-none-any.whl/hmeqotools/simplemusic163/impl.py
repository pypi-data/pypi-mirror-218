...
class ImplSongInfo(Impl):

    def __init__(self, json_data):
        Impl.__init__(self, json_data)
        self.json = json_data
...
class ImplAlbumArt(Impl):

    def __init__(self, text: str):
        Impl.__init__(self, text)
        self.text = text
