...
typedef enum PndCommandEnum {
  ...
  PndCommandCtrlBoxPower,  // For CtrlBox power status
} PndCommandEnum;
...
typedef void (*GroupFeedbackHandlerFunction)(PndGroupFeedbackPtr fbk,
                                             void *user_data);
 ...
 */
PndStatusCode pndLookupSetLookupFrequencyHz(PndLookupPtr lookup,
 ...
 */
PndStatusCode pndLookupEntryListGetName(PndLookupEntryListPtr lookup_list,
 ...
 * @returns PndStatusSuccess on success，PndStatusFailure on failed.
 */
PndStatusCode pndLookupEntryListGetFamily(PndLookupEntryListPtr lookup_list,
                                          size_t index, char *family,
                                          size_t *length);
 ...
 * @returns PndStatusSuccess on success，PndStatusFailure on failed.
 */
PndStatusCode pndLookupEntryListGetSerialNumber(
    PndLookupEntryListPtr lookup_list, size_t index, char *serialNumber,
    size_t *length);
 ...
 */
PndFeedbackPtr pndGroupFeedbackGetModuleFeedback(PndGroupFeedbackPtr feedback,
                                                 size_t module_index);
 ...
 */
PndGroupPtr pndGroupCreateFromFamily(PndLookupPtr lookup, const char *family,
                                     int32_t timeout_ms);
 ...
 * a failure code.
 */
PndStatusCode pndGroupSendCommand(PndGroupPtr group,
                                  PndGroupCommandPtr command);
 ...
 */
PndStatusCode pndGroupSetCommandLifetime(PndGroupPtr group,
                                         int32_t lifetime_ms);
 ...
 * @returns PndStatusSuccess on success，PndStatusFailure on failed.
 */
PndStatusCode pndGroupSetFeedbackFrequencyHz(PndGroupPtr group,
                                             const float frequency);
 ...
 * @returns PndStatusSuccess on success，PndStatusFailure on failed.
 */
PndStatusCode pndGroupSendFeedbackRequest(
    PndGroupPtr group, PndFeedbackCode feedbackCode = PndFeedbackAll);
 ...
 * @returns PndStatusSuccess on success，PndStatusFailure on failed.
 */
PndStatusCode pndGroupGetNextFeedback(PndGroupPtr group,
                                      PndGroupFeedbackPtr feedback,
                                      int32_t timeout_ms);

// TODO:
PndStatusCode pndGroupRegisterFeedbackHandler(
    PndGroupPtr group, GroupFeedbackHandlerFunction handler, void *user_data);
 ...
 */
PndCommandPtr pndGroupCommandGetModuleCommand(PndGroupCommandPtr command,
                                              size_t module_index);
 ...
 * @returns The command corresponding to the module at index \c module_index.
 */
bool pndGroupCommandSetType(PndGroupCommandPtr command,
                            PndCommandEnum command_enum);
/**
 ...
 */
PndStatusCode pndSetLogLevel(const char *mode);
 ...
 */
PndStatusCode pndGetLibraryVersion(int32_t *major, int32_t *minor,
                                   int32_t *revision);
