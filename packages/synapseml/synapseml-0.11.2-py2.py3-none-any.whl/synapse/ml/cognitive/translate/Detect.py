...
class Detect(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Detect_867dea923765_error",
        handler=None,
        outputCol="Detect_867dea923765_output",
        ...
        self._setDefault(errorCol="Detect_867dea923765_error")
        self._setDefault(outputCol="Detect_867dea923765_output")
