...
class DictionaryLookup(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DictionaryLookup_860661e2d112_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryLookup_860661e2d112_output",
        ...
        self._setDefault(errorCol="DictionaryLookup_860661e2d112_error")
        self._setDefault(outputCol="DictionaryLookup_860661e2d112_output")
