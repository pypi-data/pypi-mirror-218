...
class Transliterate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="Transliterate_6d2367fe9c39_error",
        fromScript=None,
        fromScriptCol=None,
        handler=None,
        language=None,
        languageCol=None,
        outputCol="Transliterate_6d2367fe9c39_output",
        ...
        self._setDefault(errorCol="Transliterate_6d2367fe9c39_error")
        self._setDefault(outputCol="Transliterate_6d2367fe9c39_output")
