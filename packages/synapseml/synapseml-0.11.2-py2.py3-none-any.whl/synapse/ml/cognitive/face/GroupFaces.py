...
class GroupFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="GroupFaces_33b41b6fc184_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        outputCol="GroupFaces_33b41b6fc184_output",
        ...
        self._setDefault(errorCol="GroupFaces_33b41b6fc184_error")
        self._setDefault(outputCol="GroupFaces_33b41b6fc184_output")
