...
class IdentifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="IdentifyFaces_647f0b102eb7_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        ...
        outputCol="IdentifyFaces_647f0b102eb7_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="IdentifyFaces_647f0b102eb7_error")
        self._setDefault(outputCol="IdentifyFaces_647f0b102eb7_output")
