...
class GenerateThumbnails(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="GenerateThumbnails_a4e9846f5fef_error",
        handler=None,
        height=None,
        heightCol=None,
        imageBytes=None,
        ...
        imageUrl=None,
        imageUrlCol=None,
        outputCol="GenerateThumbnails_a4e9846f5fef_output",
        smartCropping=None,
        ...
        self._setDefault(errorCol="GenerateThumbnails_a4e9846f5fef_error")
        self._setDefault(outputCol="GenerateThumbnails_a4e9846f5fef_output")
