...
class AnalyzeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        details=None,
        detailsCol=None,
        errorCol="AnalyzeImage_2d3f572947a0_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="AnalyzeImage_2d3f572947a0_output",
        ...
        self._setDefault(errorCol="AnalyzeImage_2d3f572947a0_error")
        self._setDefault(outputCol="AnalyzeImage_2d3f572947a0_output")
