...
class DescribeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="DescribeImage_1e5c5a0c8429_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        outputCol="DescribeImage_1e5c5a0c8429_output",
        ...
        self._setDefault(errorCol="DescribeImage_1e5c5a0c8429_error")
        self._setDefault(outputCol="DescribeImage_1e5c5a0c8429_output")
