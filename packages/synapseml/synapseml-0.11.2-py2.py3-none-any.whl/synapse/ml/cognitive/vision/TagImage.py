...
class TagImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="TagImage_748d0dfab6a3_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="TagImage_748d0dfab6a3_output",
        ...
        self._setDefault(errorCol="TagImage_748d0dfab6a3_error")
        self._setDefault(outputCol="TagImage_748d0dfab6a3_output")
