...
class ListCustomModels(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="ListCustomModels_099af99d1a9d_error",
        handler=None,
        op=None,
        opCol=None,
        outputCol="ListCustomModels_099af99d1a9d_output",
        ...
        self._setDefault(errorCol="ListCustomModels_099af99d1a9d_error")
        self._setDefault(outputCol="ListCustomModels_099af99d1a9d_output")
