...
class GetCustomModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="GetCustomModel_b7650bdef3c2_error",
        handler=None,
        includeKeys=None,
        includeKeysCol=None,
        modelId=None,
        modelIdCol=None,
        outputCol="GetCustomModel_b7650bdef3c2_output",
        ...
        self._setDefault(errorCol="GetCustomModel_b7650bdef3c2_error")
        self._setDefault(outputCol="GetCustomModel_b7650bdef3c2_output")
