...
class SpeakerEmotionInference(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="SpeakerEmotionInference_c65774409fa2_error",
        handler=None,
        locale=None,
        localeCol=None,
        outputCol="SpeakerEmotionInference_c65774409fa2_output",
        ...
        self._setDefault(errorCol="SpeakerEmotionInference_c65774409fa2_error")
        self._setDefault(outputCol="SpeakerEmotionInference_c65774409fa2_output")
