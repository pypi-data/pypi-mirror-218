...
class OpenAIPrompt(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIPrompt_810c2abcbfbb_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAIPrompt_810c2abcbfbb_output",
        postProcessing="",
        ...
        self._setDefault(errorCol="OpenAIPrompt_810c2abcbfbb_error")
        self._setDefault(outputCol="OpenAIPrompt_810c2abcbfbb_output")
