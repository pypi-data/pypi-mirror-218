...
class OpenAICompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAICompletion_cdc9deb741ca_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAICompletion_cdc9deb741ca_output",
        ...
        self._setDefault(errorCol="OpenAICompletion_cdc9deb741ca_error")
        self._setDefault(outputCol="OpenAICompletion_cdc9deb741ca_output")
