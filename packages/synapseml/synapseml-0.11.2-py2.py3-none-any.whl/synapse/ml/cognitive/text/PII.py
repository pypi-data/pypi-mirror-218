...
class PII(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="PII_bafab9d036c7_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="PII_bafab9d036c7_output",
        piiCategories=None,
        ...
        self._setDefault(errorCol="PII_bafab9d036c7_error")
        self._setDefault(outputCol="PII_bafab9d036c7_output")
