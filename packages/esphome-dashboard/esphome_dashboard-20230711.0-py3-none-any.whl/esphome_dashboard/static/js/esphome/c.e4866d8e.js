import{I as e,r as t,b as i,d as s,m as o,i as a,n,s as r,x as d,X as l,j as c,D as h}from"./index-2bed5a1a.js";import"./c.8b0a585f.js";import{c as p,s as m}from"./c.2f7aed52.js";import{o as u}from"./c.75f3beac.js";import{c as y}from"./c.440fff61.js";import{s as _}from"./c.a6e96e5a.js";let f=class extends r{constructor(){super(...arguments),this._state="ask",this._busy=!1,this._apiKey=null,this._cleanSSIDBlur=e=>{const t=e.target;t.value=t.value.trim()}}render(){let e,t;return"ask"===this._state?(e="Adopt device",t=d`
        <div>
    ...
    `}firstUpdated(e){super.firstUpdated(e),this._needsWifiSecrets&&p().then((e=>{this._hasWifiSecrets=e}))}updated(e){if(super.updated(e),e.has("_state")&&"ask"===this._state&&this.device.friendly_name){const e=this._inputName;e.value=this.device.friendly_name,e.updateComplete.then((()=>e.focus()))}}get _needsWifiSecrets(){return"wifi"===this.device.network}_handleClose(){this.parentNode.removeChild(this)}async _handleAdopt(){this._error=void 0;const e=!!this.device.friendly_name,t=this._needsWifiSecrets&&!1===this._hasWifiSecrets,i=!e||this._inputName.reportValidity(),s=!t||this._inputSSID.reportValidity();if(i)if(s){if(t){this._busy=!0;try{await m(this._inputSSID.value,this._inputPassword.value)}catch(e){return console.error(e),this._busy=!1,void(this._error="Failed to store Wi-Fi credentials")}}this._busy=!0;try{let t=this.device;e&&(t={...t,friendly_name:this._inputName.value},this._nameOverride=t.friendly_name);const i=await l(t);this._configFilename=i.configuration,c(this,"adopted"),this._apiKey=await h(this._configFilename),this._state="adopted"}catch(e){this._busy=!1,this._error="Failed to import device"}}else this._inputSSID.focus();else this._inputName.focus()}async _handleInstall(){u(this._configFilename,"OTA"),this.shadowRoot.querySelector("mwc-dialog").close()}async _handleCopyApiKey(){var e;y(this._apiKey),this._inputApiKeyBanner.style.setProperty("display","flex"),await _(3e3),null===(e=this._inputApiKeyBanner)||void 0===e||e.style.setProperty("display","none")}};f.styles=[e,t`
      :host {
...
//# sourceMappingURL=c.e4866d8e.js.map
