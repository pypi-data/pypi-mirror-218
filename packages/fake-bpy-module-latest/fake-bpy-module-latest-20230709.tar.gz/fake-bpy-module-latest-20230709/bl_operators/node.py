...
class NODE_OT_panel_add(NodePanelOperator, bpy_types.Operator):
    bl_idname = None
    ''' '''
...
class NODE_OT_panel_move(NodePanelOperator, bpy_types.Operator):
    bl_idname = None
    ''' '''
...
class NODE_OT_panel_remove(NodePanelOperator, bpy_types.Operator):
    bl_idname = None
    ''' '''
