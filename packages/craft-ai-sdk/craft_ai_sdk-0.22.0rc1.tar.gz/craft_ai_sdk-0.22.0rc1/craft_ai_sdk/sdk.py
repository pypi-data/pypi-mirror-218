...
class CraftAiSdk:
    ...
    _version = "0.22.0rc1"  # Would be better to share it somewhere
...
/executions/{execution_id}/outputs/{output_name}"
    ...
    def list_pipeline_executions(self, pipeline_name):
        ...
        Returns:
            ...
            * ``"pipeline_name"`` (:obj:`str`): Name of the pipeline used for the
              execution.
            * ``"deployment_id"`` (:obj:`str`): Id of the deployment used for the
              execution.
    ...
    def get_pipeline_execution(self, pipeline_name, execution_id):
        ...
        Returns:
            ...
            * ``"end_date"`` (:obj:`str`): Date of completion of the pipeline
              execution.
            * ``"created_by"`` (:obj:`str`): Name of the user who created the
              pipeline execution.
            * ``"pipeline_name"`` (:obj:`str`): Name of the pipeline used for the
              execution.
            * ``"deployment_id"`` (:obj:`str`): Id of the deployment used for the
...
'periodic'."
    ...
    def list_deployments(self):
        ...
        Returns:
            ...
            * ``"pipeline_id"`` (:obj:`str`): ID of the pipeline associated to the
              deployment.
    ...
    @experimental
    @log_func_result("Pipeline list metric definition")
    def record_list_metric_values(self, name, values):
        """Add values to a pipeline metric list. Note that this function can only be used
        inside a step code.
