...
class ResponseReducedPipelineStepExecution(object):
    ...
    def __init__(self, created_dt=None, histories=None, id=None, judgment_result=None, status=None, step_key=None, step_spec_id=None, step_type=None, sub_pipeline_execution=None, title=None, local_vars_configuration=None):  # noqa: E501
