...
class ResponseRunExecution(object):
    ...
    def __init__(self, arguments=None, artifacts=None, create_dt=None, id=None, pipeline_step_execution=None, run_spec=None, status=None, status_last_updated=None, workload=None, local_vars_configuration=None):  # noqa: E501
