...
class OrmOrganizationKernelCluster(object):
    ...
    def __init__(self, allowed_node_ids=None, created_dt=None, edges=None, id=None, immutable_slug=None, kernel_cluster_id=None, organization_id=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
