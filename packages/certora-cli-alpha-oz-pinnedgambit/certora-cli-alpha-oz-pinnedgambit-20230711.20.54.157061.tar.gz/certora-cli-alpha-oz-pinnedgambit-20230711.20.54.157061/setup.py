...
if __name__ == "__main__":
    setuptools.setup(
        name="certora-cli-alpha-oz-pinnedgambit",
        version="20230711.20.54.157061",
        author="Certora",
        author_email="support@certora.com",
        description="Runner for the Certora Prover",
        long_description="Commit 1ab912c. Build and Run scripts for executing the Certora Prover on Solidity smart contracts.",
        long_description_content_type="text/markdown",
        url="https://pypi.org/project/certora-cli-alpha-oz-pinnedgambit",
