...
class LocalBrowserWidget extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.MainAreaWidget {
    constructor(options) {
        ...
        const reloadButton = new _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.ToolbarButton({
            label: 'Reload',
            icon: _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_1__.jupyterIcon,
            onClick: () => {
                this.toolbarChanged();
            }
        });
...
class SelectWidget extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.ReactWidget {
    ...
    render() {
        ...
        return react__WEBPACK_IMPORTED_MODULE_4___default().createElement("select", { onChange: evt => this.onChange(evt) }, values);
    }
}
class PathWidget extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.ReactWidget {
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_4___default().createElement("input", { type: "text", value: this._value, onChange: evt => this.onChange(evt) }));
    }
}
class ReloadWidget extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.ReactWidget {
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_4___default().createElement("button", { "aria-label": "Reload", onClick: evt => {
                this._onClick();
            } },
            react__WEBPACK_IMPORTED_MODULE_4___default().createElement("svg", { style: { width: '16px', height: '16px' }, viewBox: "0 0 24 24" },
                react__WEBPACK_IMPORTED_MODULE_4___default().createElement("path", { fill: "currentColor", d: "M2 12C2 16.97 6.03 21 11 21C13.39 21 15.68 20.06 17.4 18.4L15.9 16.9C14.63 18.25 12.86 19 11 19C4.76 19 1.64 11.46 6.05 7.05C10.46 2.64 18 5.77 18 12H15L19 16H19.1L23 12H20C20 7.03 15.97 3 11 3C6.03 3 2 7.03 2 12Z" }))));
    }
}
...
//# sourceMappingURL=lib_index_js.7df68cc0bacbddb1774d.js.map