...
class SelectWidget extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.ReactWidget {
    ...
    render() {
        ...
        return react__WEBPACK_IMPORTED_MODULE_4___default().createElement(_jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_1__.HTMLSelect, null);
        /*const values = [];
        for (const [value, label] of this._values) {
          values.push(
...
//# sourceMappingURL=lib_index_js.482abf9339c01e5ba6c3.js.map