...
class PathWidget extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.ReactWidget {
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_4___default().createElement("input", { type: "text", value: this._value, onChange: evt => this.onChange(evt), className: "jp-Default bp1-input" }));
    }
}
...
//# sourceMappingURL=lib_index_js.0260d483d18d1b5881ab.js.map