...
try:
    import paddleocr.paddleocr  # pip install paddleocr
except ModuleNotFoundError:
    logger.error(f"import paddleocr时出错，模块不存在")
...
if __name__ == "__main__":
    ...
    text = ocr(r"D:\迅雷下载\chinese_tra.jpg", method="paddleocr", paragraph=True)
    print(text)
