...
class PollResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrography.raw.base.PollResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`PollAnswerVoters <pyrography.raw.base.PollAnswerVoters>`, *optional*):
            N/A
        ...
        solution_entities (List of :obj:`MessageEntity <pyrography.raw.base.MessageEntity>`, *optional*):
            N/A
