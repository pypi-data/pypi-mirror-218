...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrography.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <pyrography.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <pyrography.raw.base.SecureValue>`):
            N/A
