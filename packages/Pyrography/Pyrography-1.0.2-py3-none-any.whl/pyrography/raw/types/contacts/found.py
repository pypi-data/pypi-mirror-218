...
class Found(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrography.raw.base.contacts.Found`.
    ...
    Parameters:
        my_results (List of :obj:`Peer <pyrography.raw.base.Peer>`):
            N/A

        results (List of :obj:`Peer <pyrography.raw.base.Peer>`):
            N/A
