...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrography.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <pyrography.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <pyrography.raw.base.PopularContact>`):
            N/A
