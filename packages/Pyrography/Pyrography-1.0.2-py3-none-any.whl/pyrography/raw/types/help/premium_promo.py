...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrography.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <pyrography.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <pyrography.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <pyrography.raw.base.PremiumSubscriptionOption>`):
            N/A
