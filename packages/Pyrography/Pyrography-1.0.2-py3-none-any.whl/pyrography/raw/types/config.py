...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrography.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <pyrography.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <pyrography.raw.base.Reaction>`, *optional*):
            N/A
