...
class PhoneCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrography.raw.base.PhoneCall`.
    ...
    Parameters:
        ...
        protocol (:obj:`PhoneCallProtocol <pyrography.raw.base.PhoneCallProtocol>`):
            N/A

        connections (List of :obj:`PhoneConnection <pyrography.raw.base.PhoneConnection>`):
            N/A
