...
class ChannelAdminLogEventActionParticipantToggleBan(TLObject):  # type: ignore
    ...
    Parameters:
        prev_participant (:obj:`ChannelParticipant <pyrography.raw.base.ChannelParticipant>`):
            N/A

        new_participant (:obj:`ChannelParticipant <pyrography.raw.base.ChannelParticipant>`):
            N/A
