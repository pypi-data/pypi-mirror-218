...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrography.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <pyrography.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <pyrography.raw.base.MessagePeerReaction>`, *optional*):
            N/A
