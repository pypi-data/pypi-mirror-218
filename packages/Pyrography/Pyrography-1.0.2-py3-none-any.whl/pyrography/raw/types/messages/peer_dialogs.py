...
class PeerDialogs(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrography.raw.base.messages.PeerDialogs`.
    ...
    Parameters:
        dialogs (List of :obj:`Dialog <pyrography.raw.base.Dialog>`):
            N/A

        messages (List of :obj:`Message <pyrography.raw.base.Message>`):
            N/A
