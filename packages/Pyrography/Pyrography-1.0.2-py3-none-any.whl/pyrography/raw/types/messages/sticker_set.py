...
class StickerSet(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrography.raw.base.messages.StickerSet`.
    ...
    Parameters:
        ...
        keywords (List of :obj:`StickerKeyword <pyrography.raw.base.StickerKeyword>`):
            N/A

        documents (List of :obj:`Document <pyrography.raw.base.Document>`):
            N/A
