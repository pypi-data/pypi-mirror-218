...
class SearchResultsCalendar(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrography.raw.base.messages.SearchResultsCalendar`.
    ...
    Parameters:
        ...
        periods (List of :obj:`SearchResultsCalendarPeriod <pyrography.raw.base.SearchResultsCalendarPeriod>`):
            N/A
