...
class BotResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrography.raw.base.messages.BotResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`BotInlineResult <pyrography.raw.base.BotInlineResult>`):
            N/A
        ...
        switch_pm (:obj:`InlineBotSwitchPM <pyrography.raw.base.InlineBotSwitchPM>`, *optional*):
            N/A

        switch_webview (:obj:`InlineBotWebView <pyrography.raw.base.InlineBotWebView>`, *optional*):
            N/A
