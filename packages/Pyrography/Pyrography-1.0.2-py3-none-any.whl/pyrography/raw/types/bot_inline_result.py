...
class BotInlineResult(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrography.raw.base.BotInlineResult`.
    ...
    Parameters:
        ...
        send_message (:obj:`BotInlineMessage <pyrography.raw.base.BotInlineMessage>`):
            N/A
        ...
        thumb (:obj:`WebDocument <pyrography.raw.base.WebDocument>`, *optional*):
            N/A

        content (:obj:`WebDocument <pyrography.raw.base.WebDocument>`, *optional*):
            N/A
