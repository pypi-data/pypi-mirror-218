...
class ExportedChatlistInvite(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrography.raw.base.chatlists.ExportedChatlistInvite`.
    ...
    Parameters:
        filter (:obj:`DialogFilter <pyrography.raw.base.DialogFilter>`):
            N/A

        invite (:obj:`ExportedChatlistInvite <pyrography.raw.base.ExportedChatlistInvite>`):
            N/A
