...
class ChatlistInviteAlready(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrography.raw.base.chatlists.ChatlistInvite`.
    ...
    Parameters:
        ...
        missing_peers (List of :obj:`Peer <pyrography.raw.base.Peer>`):
            N/A

        already_peers (List of :obj:`Peer <pyrography.raw.base.Peer>`):
            N/A
