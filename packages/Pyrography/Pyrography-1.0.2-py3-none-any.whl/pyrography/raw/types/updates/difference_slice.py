...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrography.raw.base.updates.Difference`.
    ...
    Parameters:
        new_messages (List of :obj:`Message <pyrography.raw.base.Message>`):
            N/A

        new_encrypted_messages (List of :obj:`EncryptedMessage <pyrography.raw.base.EncryptedMessage>`):
            N/A

        other_updates (List of :obj:`Update <pyrography.raw.base.Update>`):
            N/A
        ...
        intermediate_state (:obj:`updates.State <pyrography.raw.base.updates.State>`):
            N/A
