...
class Photo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrography.raw.base.Photo`.
    ...
    Parameters:
        ...
        sizes (List of :obj:`PhotoSize <pyrography.raw.base.PhotoSize>`):
            N/A
        ...
        video_sizes (List of :obj:`VideoSize <pyrography.raw.base.VideoSize>`, *optional*):
            N/A
