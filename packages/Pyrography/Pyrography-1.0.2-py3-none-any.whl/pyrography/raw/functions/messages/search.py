...
class Search(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        filter (:obj:`MessagesFilter <pyrography.raw.base.MessagesFilter>`):
            N/A
        ...
        from_id (:obj:`InputPeer <pyrography.raw.base.InputPeer>`, *optional*):
            N/A
    ...
    Returns:
        :obj:`messages.Messages <pyrography.raw.base.messages.Messages>`
    """
