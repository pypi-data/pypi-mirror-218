...
class SendPaymentForm(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        credentials (:obj:`InputPaymentCredentials <pyrography.raw.base.InputPaymentCredentials>`):
            N/A
    ...
    Returns:
        :obj:`payments.PaymentResult <pyrography.raw.base.payments.PaymentResult>`
    """
