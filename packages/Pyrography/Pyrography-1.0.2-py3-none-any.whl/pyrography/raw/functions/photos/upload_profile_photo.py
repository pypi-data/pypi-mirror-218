...
class UploadProfilePhoto(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        bot (:obj:`InputUser <pyrography.raw.base.InputUser>`, *optional*):
            N/A

        file (:obj:`InputFile <pyrography.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <pyrography.raw.base.InputFile>`, *optional*):
            N/A

        video_start_ts (``float`` ``64-bit``, *optional*):
            N/A

        video_emoji_markup (:obj:`VideoSize <pyrography.raw.base.VideoSize>`, *optional*):
            N/A

    Returns:
        :obj:`photos.Photo <pyrography.raw.base.photos.Photo>`
    """
