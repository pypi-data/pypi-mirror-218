...
from pyrography.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "pyrography.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~pyrography.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~pyrography.handlers.MessageHandler` the *update* argument will be a :obj:`~pyrography.types.Message`; in a :obj:`~pyrography.handlers.CallbackQueryHandler` the *update* will be a :obj:`~pyrography.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~pyrography.filters.command` or :meth:`~pyrography.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~pyrography.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~pyrography.types.Document` objects."""
...
"""Filter messages that contain :obj:`~pyrography.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~pyrography.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~pyrography.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~pyrography.types.Game` objects."""
...
"""Filter messages that contain :obj:`~pyrography.types.Video` objects."""
...
"""Filter messages that contain :obj:`~pyrography.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~pyrography.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~pyrography.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~pyrography.types.Location` objects."""
...
"""Filter messages that contain :obj:`~pyrography.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~pyrography.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~pyrography.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~pyrography.types.Message`.
    ...
    async def func(flt, client: pyrography.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~pyrography.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~pyrography.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~pyrography.types.InlineQuery`: The filter will match ``query``.
