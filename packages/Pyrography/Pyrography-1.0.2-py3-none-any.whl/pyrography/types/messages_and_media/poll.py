...
import pyrography
from pyrography import raw, enums, utils
...
class Poll(Object, Update):
    ...
    Parameters:
        ...
        options (List of :obj:`~pyrography.types.PollOption`):
        ...
        explanation_entities (List of :obj:`~pyrography.types.MessageEntity`, *optional*):
