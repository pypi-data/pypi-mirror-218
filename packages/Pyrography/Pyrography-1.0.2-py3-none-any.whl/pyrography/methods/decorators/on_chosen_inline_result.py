...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        :obj:`~pyrography.handlers.ChosenInlineResultHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrography.Client):
                self.add_handler(pyrography.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyrography.handlers.ChosenInlineResultHandler(func, self),
