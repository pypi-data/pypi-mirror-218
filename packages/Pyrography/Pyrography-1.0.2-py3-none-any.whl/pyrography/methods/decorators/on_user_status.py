...
class OnUserStatus:
    def on_user_status(
        ...
        :obj:`~pyrography.handlers.UserStatusHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrography.Client):
                self.add_handler(pyrography.handlers.UserStatusHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyrography.handlers.UserStatusHandler(func, self),
