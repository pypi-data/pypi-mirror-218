...
class OnMessage:
    def on_message(
        ...
        :obj:`~pyrography.handlers.MessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrography.Client):
                self.add_handler(pyrography.handlers.MessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyrography.handlers.MessageHandler(func, self),
