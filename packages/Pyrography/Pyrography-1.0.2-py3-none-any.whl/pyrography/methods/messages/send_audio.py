...
import pyrography
from pyrography import StopTransmission, enums
from pyrography import raw
from pyrography import types
from pyrography import utils
from pyrography.errors import FilePartMissing
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~pyrography.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~pyrography.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~pyrography.Client.stop_transmission`, None is returned.
