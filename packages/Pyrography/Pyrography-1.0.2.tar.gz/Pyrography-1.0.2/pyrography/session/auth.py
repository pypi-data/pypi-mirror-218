...
from pyrography.connection import Connection
from pyrography.crypto import aes, rsa, prime
from pyrography.errors import SecurityCheckMismatch
from pyrography.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "pyrography.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
