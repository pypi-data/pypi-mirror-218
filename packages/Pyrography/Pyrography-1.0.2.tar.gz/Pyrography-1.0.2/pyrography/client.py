...
from pyrography.crypto import aes
from pyrography.errors import CDNFileHashMismatch
from pyrography.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    BadRequest
)
from pyrography.handlers.handler import Handler
from pyrography.methods import Methods
from pyrography.session import Auth, Session
from pyrography.storage import FileStorage, MemoryStorage
from pyrography.types import User, TermsOfService
from pyrography.utils import ainput
...
class Client(Methods):
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~pyrography.Client.export_session_string` before stopping the client to get a session string you can
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~pyrography.enums.ParseMode`):
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except pyrography.StopTransmission:
                raise
            except Exception as e:
                log.exception(e)
            finally:
