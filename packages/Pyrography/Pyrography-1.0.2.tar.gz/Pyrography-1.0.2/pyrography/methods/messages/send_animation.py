...
class SendAnimation:
    async def send_animation(
        ...
        Returns:
            :obj:`~pyrography.types.Message` | ``None``: On success, the sent animation message is returned, otherwise,
            in case the upload is deliberately stopped with :meth:`~pyrography.Client.stop_transmission`, None is
            returned.
