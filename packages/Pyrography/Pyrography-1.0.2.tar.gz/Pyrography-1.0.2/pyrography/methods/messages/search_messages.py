...
class SearchMessages:
    ...
    async def search_messages(
        ...
        If you want to get the messages count only, see :meth:`~pyrography.Client.search_messages_count`.
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~pyrography.types.Message` objects.
