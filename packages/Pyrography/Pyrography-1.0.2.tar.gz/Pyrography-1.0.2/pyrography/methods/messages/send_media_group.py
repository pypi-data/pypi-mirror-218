...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~pyrography.types.InputMediaPhoto`, :obj:`~pyrography.types.InputMediaVideo`, :obj:`~pyrography.types.InputMediaAudio` and :obj:`~pyrography.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~pyrography.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from pyrography.types import InputMediaPhoto, InputMediaVideo
