...
from pyrography.file_id import FileId, FileType, PHOTO_TYPES
...
class DownloadMedia:
    async def download_media(
        ...
        Parameters:
            message (:obj:`~pyrography.types.Message` | ``str``):
        ...
        Returns:
            ...
            :meth:`~pyrography.Client.stop_transmission`, None is returned.
