...
class OnInlineQuery:
    def on_inline_query(
        ...
        :obj:`~pyrography.handlers.InlineQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrography.Client):
                self.add_handler(pyrography.handlers.InlineQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyrography.handlers.InlineQueryHandler(func, self),
