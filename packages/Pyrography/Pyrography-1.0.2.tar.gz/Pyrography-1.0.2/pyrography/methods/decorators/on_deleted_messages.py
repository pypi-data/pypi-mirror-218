...
class OnDeletedMessages:
    def on_deleted_messages(
        ...
        :obj:`~pyrography.handlers.DeletedMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrography.Client):
                self.add_handler(pyrography.handlers.DeletedMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyrography.handlers.DeletedMessagesHandler(func, self),
