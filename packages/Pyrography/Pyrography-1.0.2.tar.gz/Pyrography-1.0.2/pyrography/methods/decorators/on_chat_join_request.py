...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~pyrography.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrography.Client):
                self.add_handler(pyrography.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyrography.handlers.ChatJoinRequestHandler(func, self),
