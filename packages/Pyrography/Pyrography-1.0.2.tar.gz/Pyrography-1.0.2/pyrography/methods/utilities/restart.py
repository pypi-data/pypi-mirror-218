...
class Restart:
    async def restart(
        ...
        This method will first call :meth:`~pyrography.Client.stop` and then :meth:`~pyrography.Client.start` in a row in
        ...
        Returns:
            :obj:`~pyrography.Client`: The restarted client itself.
