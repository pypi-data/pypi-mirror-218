...
class ChatJoinRequest(Object, Update):
    ...
    Parameters:
        chat (:obj:`~pyrography.types.Chat`):
        ...
        invite_link (:obj:`~pyrography.types.ChatInviteLink`, *optional*):
    ...
    async def approve(self) -> bool:
        """Bound method *approve* of :obj:`~pyrography.types.ChatJoinRequest`.
    ...
    async def decline(self) -> bool:
        """Bound method *decline* of :obj:`~pyrography.types.ChatJoinRequest`.
