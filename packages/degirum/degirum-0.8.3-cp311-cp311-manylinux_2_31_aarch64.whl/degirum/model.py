...
from .postprocessor import create_postprocessor, _create_overlay_color_dataset, InferenceResults
...
class Model(ABC):
    ...
    def _get_device_list(self, sys_info: dict) -> list:
        ...
        if "Devices" in sys_info:
            ...
            if self._model_parameters.DeviceType in devices:
                return list(range(len(devices[self._model_parameters.DeviceType])))
        return []
