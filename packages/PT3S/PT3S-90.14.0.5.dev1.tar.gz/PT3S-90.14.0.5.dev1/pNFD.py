...
def pNFD_FW(     
                ...
                # Ergebnis: Groesse: Standard: so wie die Sachdaten (diese werden dann komplett ueberzeichnet) ...
                ,ms_FWVB_Erg=-1
                # -2: konst. Groesse 
        ...
        try:
            ...
            colors=cmap_ROHR(np.arange(cmap_ROHR.N))
            attr_colors_ROHR_Sach_patches = [ mpatches.Patch(color=colors[i], label=attr_colors_ROHR_Sach_patches_fmt.format(value) ) for (i,value) in zip([0
                                                                                                     ,int(cmap_ROHR.N/4)
                                                                                                     ,int(cmap_ROHR.N/2)
                                                                                                     ,int(cmap_ROHR.N*3/4)
                                                                                                     ,cmap_ROHR.N-1],[norm_min_ROHR_Sach,
                                                                                                                      norm_min_ROHR_Sach+norm_diff_ROHR_Sach/4,
                                                                                                                      norm_min_ROHR_Sach+norm_diff_ROHR_Sach/2,
                                                                                                                      norm_min_ROHR_Sach+norm_diff_ROHR_Sach*3/4,                                                                                                            
                                                                                                                      norm_max_ROHR_Sach])
                                                                                                                      ]
            ...
            if attr_colors_ROHR_Erg != None:
                ...
                df.plot(ax = ax
                         ,zorder = 4#3
                         ,linewidth = norm_ROHR_lws_Erg(df[attr_lws_ROHR_Erg]) * fac_lws_ROHR
                ...
                colors=cmap_ROHRErg(np.arange(cmap_ROHRErg.N))
                attr_colors_ROHR_Erg_patches = [ mpatches.Patch(color=colors[i], label=attr_colors_ROHR_Erg_patches_fmt.format(value) ) for (i,value) in zip([0
                                                                                                          ,int(cmap_ROHRErg.N/4)
                                                                                                          ,int(cmap_ROHRErg.N/2)
                                                                                                          ,int(cmap_ROHRErg.N*3/4)
                                                                                                          ,cmap_ROHRErg.N-1],[norm_min_ROHR_Erg,
                                                                                                                           norm_min_ROHR_Erg+norm_diff_ROHR_Erg/4,
                                                                                                                           norm_min_ROHR_Erg+norm_diff_ROHR_Erg/2,
                                                                                                                           norm_min_ROHR_Erg+norm_diff_ROHR_Erg*3/4,                                                                                                            
                                                                                                                           norm_max_ROHR_Erg])
                                                                                                                           ]                
            ...
            if not gdf_FWVB.empty:
                ...
                if attr_colors_FWVB_Sach != None:
                    ...
                    colors=cmap_FWVB(np.arange(cmap_FWVB.N))
                    attr_colors_FWVB_Sach_patches = [ mpatches.Patch(color=colors[i], label=attr_colors_FWVB_Sach_patches_fmt.format(value) ) for (i,value) in zip([0
                                                                                                              ,int(cmap_FWVB.N/4)
                                                                                                              ,int(cmap_FWVB.N/2)
                                                                                                              ,int(cmap_FWVB.N*3/4)
                                                                                                              ,cmap_FWVB.N-1],[norm_min_FWVB_Sach,
                                                                                                                               norm_min_FWVB_Sach+norm_diff_FWVB_Sach/4,
                                                                                                                               norm_min_FWVB_Sach+norm_diff_FWVB_Sach/2,
                                                                                                                               norm_min_FWVB_Sach+norm_diff_FWVB_Sach*3/4,                                                                                                            
                                                                                                                               norm_max_FWVB_Sach])
                                                                                                                               ]                    
                #attr_colors_FWVB_Erg_patches=[]
                if attr_colors_FWVB_Erg != None:
                    ...
                    if colors_FWVB_ErgNeg != None and minValue <0:
                        ...
                        gdf_FWVB.plot(ax = ax
                                    ...
                                    ,color = cmap_FWVBErg(norm_FWVBErg_color(gdf_FWVB[attr_colors_FWVB_Erg].astype(float))) 
                                    )    


                        colors=cmap_FWVBErg(np.arange(cmap_FWVBErg.N))
                        attr_colors_FWVB_Erg_patches = [ mpatches.Patch(color=colors[i], label=attr_colors_FWVB_Erg_patches_fmt.format(value) ) for (i,value) in zip([0
                                                                                                                ,int(cmap_FWVBErg.N/4)
                                                                                                                ,int(cmap_FWVBErg.N/2)
                                                                                                                ,int(cmap_FWVBErg.N*3/4)
                                                                                                                ,cmap_FWVBErg.N-1],[norm_min_FWVB_Erg,
                                                                                                                                 norm_min_FWVB_Erg+norm_diff_FWVB_Erg/4,
                                                                                                                                 norm_min_FWVB_Erg+norm_diff_FWVB_Erg/2,
                                                                                                                                 norm_min_FWVB_Erg+norm_diff_FWVB_Erg*3/4,                                                                                                            
                                                                                                                                 norm_max_FWVB_Erg])
                                                                                                                                 ] 
