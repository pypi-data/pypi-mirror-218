...
_KUBERNETESSECRET = DESCRIPTOR.message_types_by_name['KubernetesSecret']
...
KubernetesSecret = _reflection.GeneratedProtocolMessageType('KubernetesSecret', (_message.Message,), {
  'DESCRIPTOR' : _KUBERNETESSECRET,
  '__module__' : 'prodvana.common_config.env_pb2'
  # @@protoc_insertion_point(class_scope:prodvana.common_config.KubernetesSecret)
  })
_sym_db.RegisterMessage(KubernetesSecret)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _ENVVALUE._serialized_start=86
  _ENVVALUE._serialized_end=276
  _SECRET._serialized_start=278
  _SECRET._serialized_end=334
  _KUBERNETESSECRET._serialized_start=336
  _KUBERNETESSECRET._serialized_end=406
