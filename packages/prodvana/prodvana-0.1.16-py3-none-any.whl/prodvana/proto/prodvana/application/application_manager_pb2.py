...
_LISTAPPLICATIONSREQ = DESCRIPTOR.message_types_by_name['ListApplicationsReq']
_LISTAPPLICATIONSRESP = DESCRIPTOR.message_types_by_name['ListApplicationsResp']
_GETAPPLICATIONREQ = DESCRIPTOR.message_types_by_name['GetApplicationReq']
_GETAPPLICATIONRESP = DESCRIPTOR.message_types_by_name['GetApplicationResp']
_CONFIGUREAPPLICATIONREQ = DESCRIPTOR.message_types_by_name['ConfigureApplicationReq']
_CONFIGUREAPPLICATIONRESP = DESCRIPTOR.message_types_by_name['ConfigureApplicationResp']
_VALIDATECONFIGUREAPPLICATIONRESP = DESCRIPTOR.message_types_by_name['ValidateConfigureApplicationResp']
_GETAPPLICATIONCONFIGREQ = DESCRIPTOR.message_types_by_name['GetApplicationConfigReq']
_GETAPPLICATIONCONFIGRESP = DESCRIPTOR.message_types_by_name['GetApplicationConfigResp']
_DELETEAPPLICATIONREQ = DESCRIPTOR.message_types_by_name['DeleteApplicationReq']
_DELETEAPPLICATIONRESP = DESCRIPTOR.message_types_by_name['DeleteApplicationResp']
_GETAPPLICATIONMETRICSREQ = DESCRIPTOR.message_types_by_name['GetApplicationMetricsReq']
_GETAPPLICATIONMETRICSRESP = DESCRIPTOR.message_types_by_name['GetApplicationMetricsResp']
_GETAPPLICATIONINSIGHTSREQ = DESCRIPTOR.message_types_by_name['GetApplicationInsightsReq']
_GETAPPLICATIONINSIGHTSRESP = DESCRIPTOR.message_types_by_name['GetApplicationInsightsResp']
_SNOOZEAPPLICATIONINSIGHTREQ = DESCRIPTOR.message_types_by_name['SnoozeApplicationInsightReq']
_SNOOZEAPPLICATIONINSIGHTRESP = DESCRIPTOR.message_types_by_name['SnoozeApplicationInsightResp']
_GETAPPLICATIONMETADATAREQ = DESCRIPTOR.message_types_by_name['GetApplicationMetadataReq']
_GETAPPLICATIONMETADATARESP = DESCRIPTOR.message_types_by_name['GetApplicationMetadataResp']
_SETAPPLICATIONMETADATAREQ = DESCRIPTOR.message_types_by_name['SetApplicationMetadataReq']
_SETAPPLICATIONMETADATARESP = DESCRIPTOR.message_types_by_name['SetApplicationMetadataResp']
ListApplicationsReq = _reflection.GeneratedProtocolMessageType('ListApplicationsReq', (_message.Message,), {
  'DESCRIPTOR' : _LISTAPPLICATIONSREQ,
  '__module__' : 'prodvana.application.application_manager_pb2'
  # @@protoc_insertion_point(class_scope:prodvana.application.ListApplicationsReq)
  })
_sym_db.RegisterMessage(ListApplicationsReq)

ListApplicationsResp = _reflection.GeneratedProtocolMessageType('ListApplicationsResp', (_message.Message,), {
  'DESCRIPTOR' : _LISTAPPLICATIONSRESP,
  '__module__' : 'prodvana.application.application_manager_pb2'
  # @@protoc_insertion_point(class_scope:prodvana.application.ListApplicationsResp)
  })
_sym_db.RegisterMessage(ListApplicationsResp)

GetApplicationReq = _reflection.GeneratedProtocolMessageType('GetApplicationReq', (_message.Message,), {
  'DESCRIPTOR' : _GETAPPLICATIONREQ,
  '__module__' : 'prodvana.application.application_manager_pb2'
  # @@protoc_insertion_point(class_scope:prodvana.application.GetApplicationReq)
  })
_sym_db.RegisterMessage(GetApplicationReq)

GetApplicationResp = _reflection.GeneratedProtocolMessageType('GetApplicationResp', (_message.Message,), {
  'DESCRIPTOR' : _GETAPPLICATIONRESP,
  '__module__' : 'prodvana.application.application_manager_pb2'
  # @@protoc_insertion_point(class_scope:prodvana.application.GetApplicationResp)
  })
_sym_db.RegisterMessage(GetApplicationResp)

ConfigureApplicationReq = _reflection.GeneratedProtocolMessageType('ConfigureApplicationReq', (_message.Message,), {
  'DESCRIPTOR' : _CONFIGUREAPPLICATIONREQ,
  '__module__' : 'prodvana.application.application_manager_pb2'
  # @@protoc_insertion_point(class_scope:prodvana.application.ConfigureApplicationReq)
  })
_sym_db.RegisterMessage(ConfigureApplicationReq)

ConfigureApplicationResp = _reflection.GeneratedProtocolMessageType('ConfigureApplicationResp', (_message.Message,), {
  'DESCRIPTOR' : _CONFIGUREAPPLICATIONRESP,
  '__module__' : 'prodvana.application.application_manager_pb2'
  # @@protoc_insertion_point(class_scope:prodvana.application.ConfigureApplicationResp)
  })
_sym_db.RegisterMessage(ConfigureApplicationResp)

ValidateConfigureApplicationResp = _reflection.GeneratedProtocolMessageType('ValidateConfigureApplicationResp', (_message.Message,), {
  'DESCRIPTOR' : _VALIDATECONFIGUREAPPLICATIONRESP,
  '__module__' : 'prodvana.application.application_manager_pb2'
  # @@protoc_insertion_point(class_scope:prodvana.application.ValidateConfigureApplicationResp)
  })
_sym_db.RegisterMessage(ValidateConfigureApplicationResp)

GetApplicationConfigReq = _reflection.GeneratedProtocolMessageType('GetApplicationConfigReq', (_message.Message,), {
  'DESCRIPTOR' : _GETAPPLICATIONCONFIGREQ,
  '__module__' : 'prodvana.application.application_manager_pb2'
  # @@protoc_insertion_point(class_scope:prodvana.application.GetApplicationConfigReq)
  })
_sym_db.RegisterMessage(GetApplicationConfigReq)

GetApplicationConfigResp = _reflection.GeneratedProtocolMessageType('GetApplicationConfigResp', (_message.Message,), {
  'DESCRIPTOR' : _GETAPPLICATIONCONFIGRESP,
  '__module__' : 'prodvana.application.application_manager_pb2'
  # @@protoc_insertion_point(class_scope:prodvana.application.GetApplicationConfigResp)
  })
_sym_db.RegisterMessage(GetApplicationConfigResp)

DeleteApplicationReq = _reflection.GeneratedProtocolMessageType('DeleteApplicationReq', (_message.Message,), {
  'DESCRIPTOR' : _DELETEAPPLICATIONREQ,
  '__module__' : 'prodvana.application.application_manager_pb2'
  # @@protoc_insertion_point(class_scope:prodvana.application.DeleteApplicationReq)
  })
_sym_db.RegisterMessage(DeleteApplicationReq)

DeleteApplicationResp = _reflection.GeneratedProtocolMessageType('DeleteApplicationResp', (_message.Message,), {
  'DESCRIPTOR' : _DELETEAPPLICATIONRESP,
  '__module__' : 'prodvana.application.application_manager_pb2'
  # @@protoc_insertion_point(class_scope:prodvana.application.DeleteApplicationResp)
  })
_sym_db.RegisterMessage(DeleteApplicationResp)

GetApplicationMetricsReq = _reflection.GeneratedProtocolMessageType('GetApplicationMetricsReq', (_message.Message,), {
  'DESCRIPTOR' : _GETAPPLICATIONMETRICSREQ,
  '__module__' : 'prodvana.application.application_manager_pb2'
  # @@protoc_insertion_point(class_scope:prodvana.application.GetApplicationMetricsReq)
  })
_sym_db.RegisterMessage(GetApplicationMetricsReq)

GetApplicationMetricsResp = _reflection.GeneratedProtocolMessageType('GetApplicationMetricsResp', (_message.Message,), {
  'DESCRIPTOR' : _GETAPPLICATIONMETRICSRESP,
  '__module__' : 'prodvana.application.application_manager_pb2'
  # @@protoc_insertion_point(class_scope:prodvana.application.GetApplicationMetricsResp)
  })
_sym_db.RegisterMessage(GetApplicationMetricsResp)

GetApplicationInsightsReq = _reflection.GeneratedProtocolMessageType('GetApplicationInsightsReq', (_message.Message,), {
  'DESCRIPTOR' : _GETAPPLICATIONINSIGHTSREQ,
  '__module__' : 'prodvana.application.application_manager_pb2'
  # @@protoc_insertion_point(class_scope:prodvana.application.GetApplicationInsightsReq)
  })
_sym_db.RegisterMessage(GetApplicationInsightsReq)

GetApplicationInsightsResp = _reflection.GeneratedProtocolMessageType('GetApplicationInsightsResp', (_message.Message,), {
  'DESCRIPTOR' : _GETAPPLICATIONINSIGHTSRESP,
  '__module__' : 'prodvana.application.application_manager_pb2'
  # @@protoc_insertion_point(class_scope:prodvana.application.GetApplicationInsightsResp)
  })
_sym_db.RegisterMessage(GetApplicationInsightsResp)

SnoozeApplicationInsightReq = _reflection.GeneratedProtocolMessageType('SnoozeApplicationInsightReq', (_message.Message,), {
  'DESCRIPTOR' : _SNOOZEAPPLICATIONINSIGHTREQ,
  '__module__' : 'prodvana.application.application_manager_pb2'
  # @@protoc_insertion_point(class_scope:prodvana.application.SnoozeApplicationInsightReq)
  })
_sym_db.RegisterMessage(SnoozeApplicationInsightReq)

SnoozeApplicationInsightResp = _reflection.GeneratedProtocolMessageType('SnoozeApplicationInsightResp', (_message.Message,), {
  'DESCRIPTOR' : _SNOOZEAPPLICATIONINSIGHTRESP,
  '__module__' : 'prodvana.application.application_manager_pb2'
  # @@protoc_insertion_point(class_scope:prodvana.application.SnoozeApplicationInsightResp)
  })
_sym_db.RegisterMessage(SnoozeApplicationInsightResp)

GetApplicationMetadataReq = _reflection.GeneratedProtocolMessageType('GetApplicationMetadataReq', (_message.Message,), {
  'DESCRIPTOR' : _GETAPPLICATIONMETADATAREQ,
  '__module__' : 'prodvana.application.application_manager_pb2'
  # @@protoc_insertion_point(class_scope:prodvana.application.GetApplicationMetadataReq)
  })
_sym_db.RegisterMessage(GetApplicationMetadataReq)

GetApplicationMetadataResp = _reflection.GeneratedProtocolMessageType('GetApplicationMetadataResp', (_message.Message,), {
  'DESCRIPTOR' : _GETAPPLICATIONMETADATARESP,
  '__module__' : 'prodvana.application.application_manager_pb2'
  # @@protoc_insertion_point(class_scope:prodvana.application.GetApplicationMetadataResp)
  })
_sym_db.RegisterMessage(GetApplicationMetadataResp)

SetApplicationMetadataReq = _reflection.GeneratedProtocolMessageType('SetApplicationMetadataReq', (_message.Message,), {
  'DESCRIPTOR' : _SETAPPLICATIONMETADATAREQ,
  '__module__' : 'prodvana.application.application_manager_pb2'
  # @@protoc_insertion_point(class_scope:prodvana.application.SetApplicationMetadataReq)
  })
_sym_db.RegisterMessage(SetApplicationMetadataReq)

SetApplicationMetadataResp = _reflection.GeneratedProtocolMessageType('SetApplicationMetadataResp', (_message.Message,), {
  'DESCRIPTOR' : _SETAPPLICATIONMETADATARESP,
  '__module__' : 'prodvana.application.application_manager_pb2'
  # @@protoc_insertion_point(class_scope:prodvana.application.SetApplicationMetadataResp)
  })
_sym_db.RegisterMessage(SetApplicationMetadataResp)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _LISTAPPLICATIONSREQ._serialized_start=497
  _LISTAPPLICATIONSREQ._serialized_end=536
  _LISTAPPLICATIONSRESP._serialized_start=538
  _LISTAPPLICATIONSRESP._serialized_end=617
  _GETAPPLICATIONREQ._serialized_start=619
  _GETAPPLICATIONREQ._serialized_end=668
