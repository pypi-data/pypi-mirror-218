...
_ORGANIZATIONUSERMETADATA = DESCRIPTOR.message_types_by_name['OrganizationUserMetadata']
OrganizationUserMetadata = _reflection.GeneratedProtocolMessageType('OrganizationUserMetadata', (_message.Message,), {
  'DESCRIPTOR' : _ORGANIZATIONUSERMETADATA,
  '__module__' : 'prodvana.organization.user_metadata_pb2'
  # @@protoc_insertion_point(class_scope:prodvana.organization.OrganizationUserMetadata)
  })
_sym_db.RegisterMessage(OrganizationUserMetadata)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _ORGANIZATIONUSERMETADATA._serialized_start=130
  _ORGANIZATIONUSERMETADATA._serialized_end=356
