...
_GETRELEASECHANNELCONFIGREQ = DESCRIPTOR.message_types_by_name['GetReleaseChannelConfigReq']
_GETRELEASECHANNELCONFIGRESP = DESCRIPTOR.message_types_by_name['GetReleaseChannelConfigResp']
...
GetReleaseChannelConfigReq = _reflection.GeneratedProtocolMessageType('GetReleaseChannelConfigReq', (_message.Message,), {
  'DESCRIPTOR' : _GETRELEASECHANNELCONFIGREQ,
  '__module__' : 'prodvana.release_channel.release_channel_manager_pb2'
  # @@protoc_insertion_point(class_scope:prodvana.release_channel.GetReleaseChannelConfigReq)
  })
_sym_db.RegisterMessage(GetReleaseChannelConfigReq)

GetReleaseChannelConfigResp = _reflection.GeneratedProtocolMessageType('GetReleaseChannelConfigResp', (_message.Message,), {
  'DESCRIPTOR' : _GETRELEASECHANNELCONFIGRESP,
  '__module__' : 'prodvana.release_channel.release_channel_manager_pb2'
  # @@protoc_insertion_point(class_scope:prodvana.release_channel.GetReleaseChannelConfigResp)
  })
_sym_db.RegisterMessage(GetReleaseChannelConfigResp)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CONFIGURERELEASECHANNELREQ._serialized_start=304
