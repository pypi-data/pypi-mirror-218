...
class CiscoDeviceSupport(ChangeLoggedModel):
    ...
    def save(self, *args, **kwargs):
        ...
        cisco_device_type_support_obj = CiscoDeviceTypeSupport.objects.select_related().get(name=device_type_obj.model)
        ...
        self.end_of_routine_failure_analysis_date = cisco_device_type_support_obj.end_of_routine_failure_analysis_date
