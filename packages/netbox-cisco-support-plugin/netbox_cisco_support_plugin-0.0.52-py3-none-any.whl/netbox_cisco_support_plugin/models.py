...
class CiscoDeviceTypeSupport(ChangeLoggedModel):
    ...
    def save(self, *args, **kwargs):
        ...
        # Set the name from the device_type name
        self.name = device_type_obj.name
        # Set the pid from the device_type part_number
...
class CiscoDeviceSupport(ChangeLoggedModel):
    ...
    def save(self, *args, **kwargs):
        ...
        # Set the name from the device_type model
        self.name = device_obj.model
        # Set the pid from the device_type part_number
        self.serial = device_obj.part_number
