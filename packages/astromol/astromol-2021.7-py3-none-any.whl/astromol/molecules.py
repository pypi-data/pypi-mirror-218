...
CO = Molecule(
    ...
    ppd_isos=[
                ...
                Molecule(
                            formula="13C17O",
                            table_formula=r'^{13}C^{17}O',
                            ppd_d_refs="Booth et al. 2019 ApJL 882, L31",
                            ppd_d_bib_ids=["2019ApJ...882L..31B"],
                ),
                Molecule(
                            formula="13C18O",
                            table_formula=r'^{13}C^{18}O',
                            ppd_d_refs="Zhang et al. 2017 Nature Ast. 1, 0130",
                            ppd_d_bib_ids=["2017NatAs...1E.130Z"],
                ),
    ],
    ppd_isos_refs='"[13CO]" Sargent & Beckwith 1987 ApJ 323, 294 "[C18O]" Dutrey et al. 1994 A&A 286, 149 "[C17O]" Smith et al. 2009 ApJ 701, 163; Guilloteau et al. 2013 A&A 549, A92 "[13C17O]" Booth et al. 2019 ApJL 882, L31 "[13C18O]" Zhang et al. 2017 Nature Ast. 1, 0130',
    exo=True,
    ...
    change_log = {
    				...
    				'2021.7.0' : 'Added 17C13O and 13C18O in disks'
    			}
)
H2 = Molecule(
    name="hydrogen",
...
PN = Molecule(
    ...
    exgal=True,
    exgal_d_refs = "Haasler et al. 2022 A&A 659, A158",
    exgal_d_bib_ids = ["2022A&A...659A.158H"],
    exgal_sources = "NGC 253",
    Bcon=23495,
    mua=2.7,
    census_version='2021.7.0',
...
HCOp = Molecule(
    ...
    ppd_isos= [
                ...
                Molecule(
                            formula='HC18O+',
                            table_formula = r"HC^{18}O+",
                            ppd_d_refs = "Furuya et al. 2022 ApJ 926, 148",
                            ppd_d_bib_ids = ["2022ApJ...926..148F"]
                ),
                
        ],
    ppd_isos_refs='[DCO+] van Dishoeck et al. 2003 A&A 400, L1 [H13CO+] van Zadelhoff et al. 2001 A&A 377, 566; van Dishoeck et al. 2003 A&A 400, L1 [HC18O+] Furuya et al. 2022 ApJ 926, 148',
    exgal=True,
    ...
    change_log = {
				'2018.0.0' : 'Initial Entry',
				'2021.7.0' : 'HC18O+ detected in protoplanetary disk.',
    }
)
HCN = Molecule(
...
HSO = Molecule(
    ...
    label="HSO",
    astromol_name="HSO",
    sources=[B1b,TMC1,L183,L483,L1495B,L1527,Lupus1A],
    telescopes=[Yebes40,IRAM30],
    wavelengths=["cm","mm"],
    d_refs="Marcelino et al. 2023 A&A 674, L13",
    d_ref_bib_ids = ["2023A&A...674L..13M"],
    l_refs="Cazzoli et al. 2016 A&A 591, A126",
    l_ref_bib_ids = ["2016A&A...591A.126C"],
    notes = "Suggestions for the appropriate chemical name for this species are welcome.",
    Acon=299484,
    Bcon=20503,
    Ccon=19136,
    mua=2.18,
...
CH2CN = Molecule(
    ...
    exgal_sources="PKS 1830-211 LOS",
    ppd=True,
    ppd_d_refs="Canta et al. 2021 ApJ 922, 62",
    ppd_d_bib_ids=["2021ApJ...922...62C"],    
    isotopologues='HDCCN',
...
NaCCCN = Molecule(
    name="sodium cyanoacetylide",
    formula="NaCCCN",
    year=2023,
    label="NaCCCN",
    astromol_name="NaCCCN",
    sources=[IRC10216],
    telescopes=[Yebes40],
    wavelengths=["cm"],
    d_refs="Cabezas et al. 2023 A&A 672, L12",
    d_ref_bib_ids=["2023A&A...672L..12C"],
    l_refs="Cabezas et al. 2019 J Chem Phys 151, 054312",
    l_ref_bib_ids=["2019JChPh.151e4312C"],
    notes= None,
    Bcon=1321,
    mua=13.6,
    census_version='2021.7.0',
...
MgC3Np = Molecule(
    name="magnesium cyanoethynyl cation",
    formula="MgC3N+",
    table_formula="MgC3N+",
    year=2023,
    label="MgC3N+",
    astromol_name="MgC3Np",
    sources=[IRC10216],
    telescopes=[Yebes40],
    wavelengths=["cm"],
    d_refs="Cernicharo et al. 2023 A&A 672, L13",
    d_ref_bib_ids = ["2023A&A...672L..13C"],
    l_refs="Cernicharo et al. 2023 A&A 672, L13",
    l_ref_bib_ids = ["2023A&A...672L..13C"],
...
HCCNCHp = Molecule(
    name="protonated isocyanoacetylene",
    formula="HCCNCH+",
    table_formula="HCCNCH+",
    year=2022,
    label="HCCNCH+",
    astromol_name="HCCNCHp",
    sources=[TMC1],
    telescopes=[Yebes40],
    wavelengths=["cm"],
    d_refs="Agundez et al. 2022 A&A 659, L9",
    d_ref_bib_ids = ["2022A&A...659L...9A"],
    l_refs="Agundez et al. 2022 A&A 659, L9",
    l_ref_bib_ids = ["2022A&A...659L...9A"],
    notes = "Detection based on calculations",
    Bcon=4664,
    mua=3.45,
    census_version='2021.7.0',
...
HMgCCCN = Molecule(
    name="hydrido magnesium cyanoacetylide",
    formula="HMgCCCN",
    table_formula="HMgCCCN",
    year=2023,
    label="HMgCCCN",
    astromol_name="HMgCCCN",
    sources=[IRC10216],
    telescopes=[Yebes40],
    wavelengths=["cm"],
    d_refs="Cabezas et al. 2023 A&A 672, L12",
    d_ref_bib_ids = ["2023A&A...672L..12C"],
    l_refs="Cabezas et al. 2023 A&A 672, L12",
    l_ref_bib_ids = ["2023A&A...672L..12C"],
    notes = "Detection based on calculations",
    Bcon=1320,
    mua=4.5,
    census_version='2021.7.0',
...
MgC4Hp = Molecule(
    name="magnesium butadiynyl cation",
    formula="MgC4H+",
    table_formula="MgC4H+",
    year=2023,
    label="MgC4H+",
    astromol_name="MgC4Hp",
    sources=[IRC10216],
    telescopes=[Yebes40,IRAM30],
    wavelengths=["cm","mm"],
    d_refs="Cernicharo et al. 2023 A&A 672, L13",
...
H2C5 = Molecule(
    name="magnesium cyanobutadiynyl cation",
    formula="H2C5",
    table_formula="l-H2C5",
    year=2021,
    label="l-H2C5",
    astromol_name="H2C5",
    sources=[TMC1],
    telescopes=[Yebes40],
    wavelengths=["cm"],
    d_refs="Cabezas et al. 2021 A&A 650, L9",
    d_ref_bib_ids = ["2021A&A...650L...9C"],
    l_refs="McCarthy et al. 1997 Science 275, 518",
    l_ref_bib_ids = ["1997Sci...275..518M"],
    notes = "Dipole moment from Maluendes & McLean 1992 Chem Phys Lett 200, 511",
    Acon=277600,
    Bcon=2305,
    Ccon=2286,
    mua=5.9,
...
C7Nm = Molecule(
    ...
    telescopes=[Yebes40],
    wavelengths=["cm"],
    d_refs="Cernicharo et al. 2023 A&A 670, L19",
    d_ref_bib_ids = ["2023A&A...670L..19C"],
    l_refs="Cernicharo et al. 2023 A&A 670, L19",
    l_ref_bib_ids = ["2023A&A...670L..19C"],
    notes = "Detection based on calculations",
    Bcon=583,
    mua=7.5,
    census_version='2021.7.0',
...
CH3CHCO = Molecule(
    name="methyl ketene",
    formula="CH3CHCO",
    table_formula="CH3CHCO",
    year=2023,
    label="CH3CHCO",
    astromol_name="CH3CHCO",
    sources=[TMC1],
    telescopes=[Yebes40],
    wavelengths=["cm"],
    d_refs="Fuentetaja et al. 2023 A&A 671, L6",
    d_ref_bib_ids = ["2023A&A...671L...6F"],
    l_refs="Bermudez et al. 2018 A&A 619, A92",
    l_ref_bib_ids = ["2018A&A...619A..92B"],
    notes = None,
    Acon=38587,
    Bcon=4774,
    Ccon=4139,
...
MgC6Hp = Molecule(
    name="magnesium hexatriynyl cation",
    formula="MgC6H+",
    table_formula="MgC6H+",
    year=2023,
    label="MgC6H+",
    astromol_name="MgC6Hp",
    sources=[IRC10216],
    telescopes=[Yebes40],
    wavelengths=["cm"],
    d_refs="Cernicharo et al. 2023 A&A 672, L13",
...
H2CCCHC3N = Molecule(
    name="cyanoacetyleneallene",
    formula="H2CCCHC3N",
    table_formula="H2CCCHC3N",
    year=2021,
    label="H2CCCHC3N",
    astromol_name="H2CCCHC3N",
    sources=[TMC1],
    telescopes=[GBT],
    wavelengths=["cm"],
    d_refs="Shingledecker et al. 2021 A&A 652, L12",
    d_ref_bib_ids = ["2021A&A...652L..12S"],
    l_refs="McCarthy et al. 2020 J Phys Chem A 124, 5170",
    l_ref_bib_ids = ["2020JPCA..124.5170M"],
    notes = None,
    Acon=15353,
    Bcon=954,
    Ccon=903,
...
C10Hm = Molecule(
    ...
    telescopes=[GBT],
    wavelengths=["cm"],
    d_refs="Remijan et al. 2023 ApJL 944, L45",
    d_ref_bib_ids = ["2023ApJ...944L..45R"],
    l_refs="Remijan et al. 2023 ApJL 944, L45",
    l_ref_bib_ids = ["2023ApJ...944L..45R"],
    notes = "Detection based on calculations.  Dipole moment from Blanksby et al. 2001 MNRAS 328, 89",
    Bcon=300,
    mua=12.7,
    census_version='2021.7.0',
    change_log = {
...
C4H5CN = Molecule(
    name="E-1-cyano-1,3-butadiene",
    formula="C4H5CN",
    table_formula="C4H5CN",
    year=2023,
    label="C4H5CN",
    astromol_name="C4H5CN",
    sources=[TMC1],
    telescopes=[GBT],
    wavelengths=["cm"],
    d_refs="Cooke et al. 2023 ApJ 948, 133",
    d_ref_bib_ids = ["2023ApJ...948..133C"],
    l_refs="McCarthy et al. 2020 J Phys Chem A 124, 5170; Zdanovskaia et al. 2021 JACS 143, 9551",
    l_ref_bib_ids = ["2020JPCA..124.5170M","Zdanovskaia:2021:9551"],
    notes = None,
    Acon=26243,
    Bcon=1444,
	Ccon=1368,
...
C2H5OCH3 = Molecule(
    ...
    formula="C2H5OCH3",
    table_formula="C2H5OCH3",
    year=2018,
    label="C2H5OCH3",
    astromol_name="C2H5OCH3",
    sources=[Orion],
    telescopes=[ALMA],
    wavelengths=["mm"],
    d_refs="Tercero et al. 2018 A&A 620, L6",
    d_ref_bib_ids = ["2018A&A...620L...6T"],
    l_refs="Hyashi & Kuwada 1975 J Mol Struct. 28, 147; Fuchs et al. 2003 ApJS 144, 277",
    l_ref_bib_ids = ["1975JMoSt..28..147H", "2003ApJS..144..277F"],
    notes = "A tentative detection was claimed in 2005 (Fuchs et al. 2005 A&A 444, 521) and disputed in Carroll et al. 2015 ApJ 799, 15.  Although they do not claim it in the paper as confirmation or a first detection, convincing lines are shown in Tercero et al. 2018 A&A 620, L6.",
    Acon=27992,
    Bcon=4159,
    Ccon=3891,
    mua=0.146,
...
C5H5CCH1 = Molecule(
    ...
    telescopes=[Yebes40],
    wavelengths=["cm"],
    d_refs="Cernicharo et al. 2021 A&A 655, L1",
    d_ref_bib_ids = ["2021A&A...655L...1C"],
    l_refs="McCarthy et al. 2020 J Phys Chem A 124, 5170",
    l_ref_bib_ids = ["2020JPCA..124.5170M"],
    notes = "",
    Acon=8374,
...
C9H7CN = Molecule(
    name="2-cyanoindene",
    formula="C9H7CN",
    table_formula="2-C9H7CN",
    year=2022,
    label="C9H7CN",
    astromol_name="C9H7CN",
    cyclic=True,
    pah=True,
    sources=[TMC1],
    telescopes=[GBT],
    wavelengths=["cm"],
    d_refs="Sita et al. 2022 ApJL 938, L12",
    d_ref_bib_ids = ["2022ApJ...938L..12S"],
    l_refs="Sita et al. 2022 ApJL 938, L12",
    l_ref_bib_ids = ["2022ApJ...938L..12S"],
    notes = "",
    Acon=3754,
    Bcon=676,
    Ccon=575,
