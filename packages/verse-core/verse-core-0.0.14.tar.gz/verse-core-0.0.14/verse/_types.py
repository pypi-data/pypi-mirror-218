...
class Key:
    key: ValueType | RefType

    def __init__(self, key: ValueType | RefType):
        self.key = key
...
class Update:
    ...
    def __init__(self, operations: Optional[List[UpdateOperation]] = None):
    ...
    def set(self, field: str, value: ExpressionType):
        self.operations.append(UpdateOperation(field, UpdateOp.SET, value))

    def add(self, field: str, value: ExpressionType):
        self.operations.append(UpdateOperation(field, UpdateOp.ADD, value))

    def replace(self, field: str, value: ExpressionType):
        self.operations.append(UpdateOperation(field, UpdateOp.REPLACE, value))

    def remove(self, field: str):
        self.operations.append(UpdateOperation(field, UpdateOp.REMOVE))

    def move(self, field: str, dest: str):
        self.operations.append(UpdateOperation(field, UpdateOp.MOVE, dest))

    def array_add(self, field: str, value: ExpressionType):
        self.operations.append(
            UpdateOperation(field, UpdateOp.ARRAY_ADD, value)
        )

    def array_remove(self, field: str, value: ExpressionType):
        self.operations.append(
            UpdateOperation(field, UpdateOp.ARRAY_REMOVE, value)
        )

    def array_union(self, field: str, value: ExpressionType):
        self.operations.append(
            UpdateOperation(field, UpdateOp.ARRAY_UNION, value)
        )

    def __str__(self) -> str:
        return f"{', '.join(str(o) for o in self.operations)}"
...
class UpdateOperation:
    ...
    def __init__(self, field: str, op: UpdateOp, *args: ExpressionType):
        self.field = field
        self.op = op
        self.args = args
    ...
    def __str__(self) -> str:
        ...
        return f"{self.field}={self.op.value}({_str_args})"
