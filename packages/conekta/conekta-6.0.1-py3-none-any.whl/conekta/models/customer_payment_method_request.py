...
class CustomerPaymentMethodRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomerPaymentMethodRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomerPaymentMethodRequest:
        """Create an instance of CustomerPaymentMethodRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomerPaymentMethodRequest.parse_obj(obj)

        _obj = CustomerPaymentMethodRequest.parse_obj({
            "type": obj.get("type")
        })
        return _obj
