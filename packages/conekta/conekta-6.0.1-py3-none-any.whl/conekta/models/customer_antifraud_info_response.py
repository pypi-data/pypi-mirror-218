...
class CustomerAntifraudInfoResponse(BaseModel):
    ...
    __properties = ["first_paid_at", "account_created_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomerAntifraudInfoResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomerAntifraudInfoResponse:
        """Create an instance of CustomerAntifraudInfoResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomerAntifraudInfoResponse.parse_obj(obj)

        _obj = CustomerAntifraudInfoResponse.parse_obj({
