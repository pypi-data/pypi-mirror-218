...
class PaymentMethodSpeiRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymentMethodSpeiRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaymentMethodSpeiRequest:
        """Create an instance of PaymentMethodSpeiRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymentMethodSpeiRequest.parse_obj(obj)

        _obj = PaymentMethodSpeiRequest.parse_obj({
            "type": obj.get("type"),
