...
class GetTransactionsResponseAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransactionsResponseAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransactionsResponseAllOf:
        """Create an instance of GetTransactionsResponseAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransactionsResponseAllOf.parse_obj(obj)
