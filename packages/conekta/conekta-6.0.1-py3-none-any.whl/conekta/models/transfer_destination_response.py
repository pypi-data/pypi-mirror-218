...
class TransferDestinationResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransferDestinationResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransferDestinationResponse:
        """Create an instance of TransferDestinationResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransferDestinationResponse.parse_obj(obj)

        _obj = TransferDestinationResponse.parse_obj({
