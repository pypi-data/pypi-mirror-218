...
class PaymentMethodCashRequestAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymentMethodCashRequestAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaymentMethodCashRequestAllOf:
        """Create an instance of PaymentMethodCashRequestAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymentMethodCashRequestAllOf.parse_obj(obj)

        _obj = PaymentMethodCashRequestAllOf.parse_obj({
