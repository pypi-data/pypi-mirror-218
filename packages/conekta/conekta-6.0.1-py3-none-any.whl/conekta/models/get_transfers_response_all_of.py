...
class GetTransfersResponseAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTransfersResponseAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTransfersResponseAllOf:
        """Create an instance of GetTransfersResponseAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetTransfersResponseAllOf.parse_obj(obj)

        _obj = GetTransfersResponseAllOf.parse_obj({
