...
class CustomerFiscalEntitiesResponseAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomerFiscalEntitiesResponseAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomerFiscalEntitiesResponseAllOf:
        """Create an instance of CustomerFiscalEntitiesResponseAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomerFiscalEntitiesResponseAllOf.parse_obj(obj)

        _obj = CustomerFiscalEntitiesResponseAllOf.parse_obj({
