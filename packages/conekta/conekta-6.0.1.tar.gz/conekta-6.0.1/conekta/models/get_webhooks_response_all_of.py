...
class GetWebhooksResponseAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWebhooksResponseAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWebhooksResponseAllOf:
        """Create an instance of GetWebhooksResponseAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWebhooksResponseAllOf.parse_obj(obj)

        _obj = GetWebhooksResponseAllOf.parse_obj({
