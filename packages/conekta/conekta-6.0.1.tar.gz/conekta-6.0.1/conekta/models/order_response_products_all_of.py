...
class OrderResponseProductsAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderResponseProductsAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderResponseProductsAllOf:
        """Create an instance of OrderResponseProductsAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderResponseProductsAllOf.parse_obj(obj)

        _obj = OrderResponseProductsAllOf.parse_obj({
