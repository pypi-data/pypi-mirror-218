...
class CustomerInfoResponse(BaseModel):
    ...
    __properties = ["name", "email", "phone", "corporate", "object"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomerInfoResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomerInfoResponse:
        """Create an instance of CustomerInfoResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomerInfoResponse.parse_obj(obj)

        _obj = CustomerInfoResponse.parse_obj({
            "name": obj.get("name"),
            "email": obj.get("email"),
            "phone": obj.get("phone"),
