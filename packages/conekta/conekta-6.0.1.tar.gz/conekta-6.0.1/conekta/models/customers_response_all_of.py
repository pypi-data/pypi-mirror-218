...
class CustomersResponseAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomersResponseAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomersResponseAllOf:
        """Create an instance of CustomersResponseAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomersResponseAllOf.parse_obj(obj)

        _obj = CustomersResponseAllOf.parse_obj({
