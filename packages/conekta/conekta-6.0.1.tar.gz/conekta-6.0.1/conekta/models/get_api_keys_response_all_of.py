...
class GetApiKeysResponseAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetApiKeysResponseAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetApiKeysResponseAllOf:
        """Create an instance of GetApiKeysResponseAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetApiKeysResponseAllOf.parse_obj(obj)

        _obj = GetApiKeysResponseAllOf.parse_obj({
