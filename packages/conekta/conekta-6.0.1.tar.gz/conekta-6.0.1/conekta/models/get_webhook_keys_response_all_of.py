...
class GetWebhookKeysResponseAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetWebhookKeysResponseAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetWebhookKeysResponseAllOf:
        """Create an instance of GetWebhookKeysResponseAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWebhookKeysResponseAllOf.parse_obj(obj)

        _obj = GetWebhookKeysResponseAllOf.parse_obj({
