...
class OrderResponseDiscountLinesAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderResponseDiscountLinesAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderResponseDiscountLinesAllOf:
        """Create an instance of OrderResponseDiscountLinesAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderResponseDiscountLinesAllOf.parse_obj(obj)

        _obj = OrderResponseDiscountLinesAllOf.parse_obj({
