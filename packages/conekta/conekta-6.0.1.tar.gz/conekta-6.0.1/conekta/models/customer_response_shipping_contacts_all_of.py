...
class CustomerResponseShippingContactsAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomerResponseShippingContactsAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomerResponseShippingContactsAllOf:
        """Create an instance of CustomerResponseShippingContactsAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomerResponseShippingContactsAllOf.parse_obj(obj)

        _obj = CustomerResponseShippingContactsAllOf.parse_obj({
