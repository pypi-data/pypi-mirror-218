...
class BalancesApi(object):
    ...
    @validate_arguments
    def get_balance(self, accept_language : Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None, **kwargs) -> BalanceResponse:  # noqa: E501
        ...
        >>> thread = api.get_balance(accept_language, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_balance_with_http_info(accept_language, **kwargs)  # noqa: E501

    @validate_arguments
    def get_balance_with_http_info(self, accept_language : Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get a company's balance  # noqa: E501
        ...
        >>> thread = api.get_balance_with_http_info(accept_language, async_req=True)
        >>> result = thread.get()
