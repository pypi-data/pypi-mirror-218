...
```python
pip install tester-package-sdk==1.1.2
```

You can also view the package at:
https://pypi.python.org/pypi/tester-package-sdk/1.1.2

## Initialize the API Client

**_Note:_** Documentation for the client can be found [here.](https://www.github.com/sdks-io/new-repository-python-one/tree/1.1.2/doc/client.md)
...
* [Pet](https://www.github.com/sdks-io/new-repository-python-one/tree/1.1.2/doc/controllers/pet.md)
* [Store](https://www.github.com/sdks-io/new-repository-python-one/tree/1.1.2/doc/controllers/store.md)
* [User](https://www.github.com/sdks-io/new-repository-python-one/tree/1.1.2/doc/controllers/user.md)

## Classes Documentation

* [Utility Classes](https://www.github.com/sdks-io/new-repository-python-one/tree/1.1.2/doc/utility-classes.md)
* [HttpResponse](https://www.github.com/sdks-io/new-repository-python-one/tree/1.1.2/doc/http-response.md)
* [HttpRequest](https://www.github.com/sdks-io/new-repository-python-one/tree/1.1.2/doc/http-request.md)
