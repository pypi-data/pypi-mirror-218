...
def bootstrap_cia(
    ...
    Returns:
        A tuple (means, half_widths, variance_bootstrap_means, variance_of_values) where
        means is an array of the means of the bootstrap means, half_widths is an array of the half widths of the confidence intervals, variance_bootstrap_means is an array of the variances of the bootstrap means, and variance_of_values is an array of the variances of the values returned by process_samples.
