...
def connected_watts_strogatz_graph(
    n: int, k: int, p: float, tries: int = 100, seed=None
): ...
@py_random_state(2)
def random_regular_graph(d: int, n, seed=None): ...
@py_random_state(2)
def barabasi_albert_graph(
    n: int, m: int, seed=None, initial_graph: Graph | None = None
) -> Graph: ...
@py_random_state(4)
def dual_barabasi_albert_graph(
    n: int, m1: int, m2: int, p: float, seed=None, initial_graph: Graph | None = None
) -> Graph: ...
@py_random_state(4)
def extended_barabasi_albert_graph(
    n: int, m: int, p: float, q: float, seed=None
) -> Graph: ...
@py_random_state(3)
...
def random_powerlaw_tree_sequence(
    n: int, gamma: float = 3, seed=None, tries: int = 100
): ...
@py_random_state(3)
