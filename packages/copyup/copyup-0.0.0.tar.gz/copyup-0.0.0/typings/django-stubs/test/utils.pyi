...
_DecoratedTest = Union[Callable[..., Any], _TestClass]
...
class override_system_checks(TestContextDecorator):
    ...
    deployment_checks: Optional[List[Callable[..., Any]]] = ...
    def __init__(
        self,
        new_checks: List[Callable[..., Any]],
        deployment_checks: Optional[List[Callable[..., Any]]] = ...,
...
class ignore_warnings(TestContextDecorator):
    ...
    def __init__(self, **kwargs: Any) -> None: ...
    catch_warnings: ContextManager[Optional[List[Any]]] = ...
...
def register_lookup(
    ...
    *lookups: Type[Union[Lookup[Any], Transform]],
