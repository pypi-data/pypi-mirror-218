...
from asposepdf.Assist import Rectangle
...
class PdfFileSignature(Facade):
    ...
    def sign(self, page: int, SigReason: str, SigContact: str, SigLocation: str, visible: bool, annotRect: Rectangle):
        """!
    ...
    def signWithCertificate(self, page: int, visible: bool, annotRect: Rectangle, certificate: Signature):
        """!
