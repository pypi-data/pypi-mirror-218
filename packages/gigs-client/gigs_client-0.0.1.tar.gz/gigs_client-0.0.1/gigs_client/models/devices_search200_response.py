...
class DevicesSearch200Response(BaseModel):
    """
    DevicesSearch200Response
    """
    object: Optional[Any] = Field(..., description="Type of object is always `list`.")
    items: Optional[Any] = Field(..., description="List of objects of type `device`.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DevicesSearch200Response:
        """Create an instance of DevicesSearch200Response from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DevicesSearch200Response:
        """Create an instance of DevicesSearch200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DevicesSearch200Response.parse_obj(obj)

        _obj = DevicesSearch200Response.parse_obj({
