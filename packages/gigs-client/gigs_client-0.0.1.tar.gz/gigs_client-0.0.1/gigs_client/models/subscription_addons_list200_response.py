...
class SubscriptionAddonsList200Response(BaseModel):
    """
    SubscriptionAddonsList200Response
    """
    object: Optional[Any] = Field(..., description="Type of object is always `list`.")
    items: Optional[Any] = Field(..., description="List of objects of type `subscriptionAddon`.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubscriptionAddonsList200Response:
        """Create an instance of SubscriptionAddonsList200Response from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubscriptionAddonsList200Response:
        """Create an instance of SubscriptionAddonsList200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubscriptionAddonsList200Response.parse_obj(obj)

        _obj = SubscriptionAddonsList200Response.parse_obj({
