...
class SubscriptionUsageList200Response(BaseModel):
    """
    SubscriptionUsageList200Response
    """
    object: Optional[Any] = Field(..., description="Type of object is always `list`.")
    items: Optional[Any] = Field(..., description="List of objects of type `usageRecord`.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubscriptionUsageList200Response:
        """Create an instance of SubscriptionUsageList200Response from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubscriptionUsageList200Response:
        """Create an instance of SubscriptionUsageList200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubscriptionUsageList200Response.parse_obj(obj)

        _obj = SubscriptionUsageList200Response.parse_obj({
