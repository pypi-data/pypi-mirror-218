...
class PlansSearch200Response(BaseModel):
    """
    PlansSearch200Response
    """
    object: Optional[Any] = Field(..., description="Type of object is always `list`.")
    items: Optional[Any] = Field(..., description="List of objects of type `plan`.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PlansSearch200Response:
        """Create an instance of PlansSearch200Response from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PlansSearch200Response:
        """Create an instance of PlansSearch200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PlansSearch200Response.parse_obj(obj)

        _obj = PlansSearch200Response.parse_obj({
