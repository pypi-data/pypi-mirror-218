...
class Porting(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Porting:
        """Create an instance of Porting from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Porting:
        """Create an instance of Porting from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Porting.parse_obj(obj)

        _obj = Porting.parse_obj({
