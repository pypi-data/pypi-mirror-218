...
class SubscriptionCurrentPeriod(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubscriptionCurrentPeriod:
        """Create an instance of SubscriptionCurrentPeriod from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubscriptionCurrentPeriod:
        """Create an instance of SubscriptionCurrentPeriod from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubscriptionCurrentPeriod.parse_obj(obj)

        _obj = SubscriptionCurrentPeriod.parse_obj({
