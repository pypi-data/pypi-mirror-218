...
class SubscriptionAddonAddon(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubscriptionAddonAddon:
        """Create an instance of SubscriptionAddonAddon from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubscriptionAddonAddon:
        """Create an instance of SubscriptionAddonAddon from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubscriptionAddonAddon.parse_obj(obj)

        _obj = SubscriptionAddonAddon.parse_obj({
