...
class AddonsList200Response(BaseModel):
    """
    AddonsList200Response
    """
    object: Optional[Any] = Field(..., description="Type of object is always `list`.")
    items: Optional[Any] = Field(..., description="List of objects of type `addon`.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddonsList200Response:
        """Create an instance of AddonsList200Response from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddonsList200Response:
        """Create an instance of AddonsList200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddonsList200Response.parse_obj(obj)

        _obj = AddonsList200Response.parse_obj({
