...
class SubscriptionSim(BaseModel):
    """
    SubscriptionSim
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubscriptionSim:
        """Create an instance of SubscriptionSim from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubscriptionSim:
        """Create an instance of SubscriptionSim from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubscriptionSim.parse_obj(obj)

        _obj = SubscriptionSim.parse_obj({
