...
class SubscriptionsSearch200Response(BaseModel):
    """
    SubscriptionsSearch200Response
    """
    object: Optional[Any] = Field(..., description="Type of object is always `list`.")
    items: Optional[Any] = Field(..., description="List of objects of type `subscription`.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubscriptionsSearch200Response:
        """Create an instance of SubscriptionsSearch200Response from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubscriptionsSearch200Response:
        """Create an instance of SubscriptionsSearch200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubscriptionsSearch200Response.parse_obj(obj)

        _obj = SubscriptionsSearch200Response.parse_obj({
