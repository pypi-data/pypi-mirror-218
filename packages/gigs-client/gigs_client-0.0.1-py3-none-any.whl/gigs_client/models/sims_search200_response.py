...
class SimsSearch200Response(BaseModel):
    """
    SimsSearch200Response
    """
    object: Optional[Any] = Field(..., description="Type of object is always `list`.")
    items: Optional[Any] = Field(..., description="List of objects of type `sim`.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SimsSearch200Response:
        """Create an instance of SimsSearch200Response from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SimsSearch200Response:
        """Create an instance of SimsSearch200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SimsSearch200Response.parse_obj(obj)

        _obj = SimsSearch200Response.parse_obj({
