...
class ProjectsList200Response(BaseModel):
    ...
    items: Optional[Any] = Field(..., description="List of objects of type `project`.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProjectsList200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProjectsList200Response:
        """Create an instance of ProjectsList200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProjectsList200Response.parse_obj(obj)

        _obj = ProjectsList200Response.parse_obj({
