...
class SubscriptionChangesList200Response(BaseModel):
    """
    SubscriptionChangesList200Response
    """
    object: Optional[Any] = Field(..., description="Type of object is always `list`.")
    items: Optional[Any] = Field(..., description="List of objects of type `subscriptionChange`.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubscriptionChangesList200Response:
        """Create an instance of SubscriptionChangesList200Response from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubscriptionChangesList200Response:
        """Create an instance of SubscriptionChangesList200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubscriptionChangesList200Response.parse_obj(obj)

        _obj = SubscriptionChangesList200Response.parse_obj({
