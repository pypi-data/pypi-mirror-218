...
class PortingsUpdateRequest(BaseModel):
    """
    ...
    phone_number: Optional[Any] = Field(None, alias="phoneNumber", description="The phone number to port in E.164 format. This is only updatable when the porting is in a status of: draft")
    provider: Optional[Any] = Field(None, description="The ID of the recipient network provider. This is only updatable when the porting is in a status of: draft")
    __properties = ["accountNumber", "accountPin", "birthday", "donorProvider", "firstName", "lastName", "phoneNumber", "provider"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PortingsUpdateRequest:
        """Create an instance of PortingsUpdateRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PortingsUpdateRequest:
        """Create an instance of PortingsUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PortingsUpdateRequest.parse_obj(obj)

        _obj = PortingsUpdateRequest.parse_obj({
