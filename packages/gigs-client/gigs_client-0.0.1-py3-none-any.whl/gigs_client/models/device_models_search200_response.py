...
class DeviceModelsSearch200Response(BaseModel):
    """
    DeviceModelsSearch200Response
    """
    object: Optional[Any] = Field(..., description="Type of object is always `list`.")
    items: Optional[Any] = Field(..., description="List of objects of type `deviceModel`.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeviceModelsSearch200Response:
        """Create an instance of DeviceModelsSearch200Response from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeviceModelsSearch200Response:
        """Create an instance of DeviceModelsSearch200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeviceModelsSearch200Response.parse_obj(obj)

        _obj = DeviceModelsSearch200Response.parse_obj({
