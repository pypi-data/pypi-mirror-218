...
class ServiceProvidersList200Response(BaseModel):
    """
    ServiceProvidersList200Response
    """
    object: Optional[Any] = Field(..., description="Type of object is always `list`.")
    items: Optional[Any] = Field(..., description="List of objects of type `serviceProvider`.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServiceProvidersList200Response:
        """Create an instance of ServiceProvidersList200Response from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServiceProvidersList200Response:
        """Create an instance of ServiceProvidersList200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServiceProvidersList200Response.parse_obj(obj)

        _obj = ServiceProvidersList200Response.parse_obj({
