...
class UserAddressesList200Response(BaseModel):
    """
    UserAddressesList200Response
    """
    object: Optional[Any] = Field(..., description="Type of object is always `list`.")
    items: Optional[Any] = Field(..., description="List of objects of type `userAddress`.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserAddressesList200Response:
        """Create an instance of UserAddressesList200Response from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserAddressesList200Response:
        """Create an instance of UserAddressesList200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserAddressesList200Response.parse_obj(obj)

        _obj = UserAddressesList200Response.parse_obj({
