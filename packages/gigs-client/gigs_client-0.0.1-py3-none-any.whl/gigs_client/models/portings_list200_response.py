...
class PortingsList200Response(BaseModel):
    """
    PortingsList200Response
    """
    object: Optional[Any] = Field(..., description="Type of object is always `list`.")
    items: Optional[Any] = Field(..., description="List of objects of type `porting`.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PortingsList200Response:
        """Create an instance of PortingsList200Response from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PortingsList200Response:
        """Create an instance of PortingsList200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PortingsList200Response.parse_obj(obj)

        _obj = PortingsList200Response.parse_obj({
