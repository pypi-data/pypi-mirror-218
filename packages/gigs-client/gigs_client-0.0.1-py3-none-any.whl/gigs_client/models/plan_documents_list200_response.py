...
class PlanDocumentsList200Response(BaseModel):
    """
    PlanDocumentsList200Response
    """
    object: Optional[Any] = Field(..., description="Type of object is always `list`.")
    items: Optional[Any] = Field(..., description="List of objects of type `planDocument`.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PlanDocumentsList200Response:
        """Create an instance of PlanDocumentsList200Response from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PlanDocumentsList200Response:
        """Create an instance of PlanDocumentsList200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PlanDocumentsList200Response.parse_obj(obj)

        _obj = PlanDocumentsList200Response.parse_obj({
