...
def main():
    ...
    parser.add_argument('concrete_host', type=str,
                        help='Output concrete redis server host')
    parser.add_argument('concrete_port', type=int,
                        help='Output concrete redis server port')
    parser.add_argument('concrete_key', type=str,
                        help='Output concrete redis key')
    parser.add_argument('--left-to-right', action='store_true',
                        help='Append concrete communications to right of list '
