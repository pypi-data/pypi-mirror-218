...
from v_quantum_annealing.utils.decorator import deprecated_alias
...
class SQASampler(BaseSampler):
    ...
    def __init__(self):
        ...
        self._make_system = {"singlespinflip": cxxvqa.system.make_transverse_ising}
        self._algorithm = {
    ...
    def _convert_validation_schedule(self, schedule, beta):
        ...
        if isinstance(schedule[0], cxxvqa.utility.TransverseFieldSchedule):
            return schedule
        ...
        if len(schedule[0]) == 2:
            ...
            # convert to list of cxxvqa.utility.TransverseFieldSchedule
            cxxvqa_schedule = []
            for s, one_mc_step in schedule:
                _schedule = cxxvqa.utility.TransverseFieldSchedule()
    ...
    def sample(
        self,
        bqm: Union[
            "v_quantum_annealing.model.model.BinaryQuadraticModel", dimod.BinaryQuadraticModel
        ],
        ...
        Args:
            bqm (v_quantum_annealing.BinaryQuadraticModel) binary quadratic model
        ...
        Examples:
            ...
            for Ising case::
                ...
                >>> h = {0: -1, 1: -1, 2: 1, 3: 1}
                >>> J = {(0, 1): -1, (3, 4): -1}
                >>> sampler = v_quantum_annealing.SQASampler()
        ...
        ising_graph, offset = bqm.get_cxxvqa_ising_graph()
...
def linear_ising_schedule(model, beta, gamma, num_sweeps):
    ...
    Args:
        model (:class:`v_quantum_annealing.model.model.BinaryQuadraticModel`): BinaryQuadraticModel
        beta (float): inverse temperature
    ...
    Returns:
        generated schedule
    """
    schedule = cxxvqa.utility.make_transverse_field_schedule_list(
