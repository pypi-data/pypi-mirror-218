...
class CloudRegisterView(core.SmartHomeControllerView):
    ...
    async def post(self, request: web.Request):
        ...
        if location_info := await core.LocationInfo.async_detect_location_info(
            core.HttpClient.async_get_clientsession(shc)
        ):
            client_metadata = {
