...
class Const:
    """ "Constants for the Media Source Component."""

    MEDIA_MIME_TYPES: typing.Final = ("audio", "video", "image")
    MEDIA_CLASS_MAP: typing.Final = {
        "audio": core.MediaPlayer.MediaClass.MUSIC,
