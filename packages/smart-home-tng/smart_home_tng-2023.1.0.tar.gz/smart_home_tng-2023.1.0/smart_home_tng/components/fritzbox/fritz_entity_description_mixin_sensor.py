...
from ... import core
from .fritz_entity_description_mixin_base import FritzEntityDescriptionMixinBase
...
class FritzEntityDescriptionMixinSensor(FritzEntityDescriptionMixinBase):
    ...
    native_value: typing.Callable[[fritz.FritzhomeDevice], core.StateType | dt.datetime]
