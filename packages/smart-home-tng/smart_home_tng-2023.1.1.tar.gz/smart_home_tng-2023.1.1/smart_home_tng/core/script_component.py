...
class ScriptComponent(SmartHomeControllerComponent):
    ...
    def entities_in_script(self, script_entity_id: str) -> list[str]:
        """Return all entities that are referenced by the script."""

    @abc.abstractmethod
    def devices_in_script(self, script_entity_id: str) -> list[str]:
        """Return all devices that are referenced by the script."""
