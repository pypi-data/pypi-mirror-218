...
class MainConfig(Config):
    ...
    def merge(
        ...
        if project_alias:
            ...
            if project_alias not in self.config['projects']:
                self.config['projects'][project_alias] = {}

            project_config = self.config['projects'][project_alias]
            if project_id:
    ...
    def project(self, alias):
        ...
        return ProjectConfig(
            ...
            parent=self,
            alias=alias,
            config=self.config['projects'][alias]
        )


class ProjectConfig(Config):
    def __init__(self, path, parent, alias, config):
    ...
    def _get_missing_option_message(self, key):
        return f"Configuration option '{key}' in project '{self.alias}' " \
