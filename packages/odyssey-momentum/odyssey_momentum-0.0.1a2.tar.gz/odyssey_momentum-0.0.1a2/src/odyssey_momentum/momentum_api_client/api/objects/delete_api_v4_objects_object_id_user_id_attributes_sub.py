...
from ...models.node_api_remove_object_user_attribute_sub_value_body import NodeApiRemoveObjectUserAttributeSubValueBody
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: NodeApiRemoveObjectUserAttributeSubValueBody,
) -> dict[str, Any]:
