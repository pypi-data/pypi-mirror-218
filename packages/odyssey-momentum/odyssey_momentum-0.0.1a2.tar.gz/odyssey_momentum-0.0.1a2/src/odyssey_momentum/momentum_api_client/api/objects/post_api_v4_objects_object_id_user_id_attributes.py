...
from ...models.node_api_set_object_user_attributes_value_in_body import NodeApiSetObjectUserAttributesValueInBody
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: NodeApiSetObjectUserAttributesValueInBody,
) -> dict[str, Any]:
