...
from ...models.node_api_timeline_add_for_object_in_body import NodeApiTimelineAddForObjectInBody
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: NodeApiTimelineAddForObjectInBody,
) -> dict[str, Any]:
    url = f"{client.base_url}/api/v4/objects/{object_id}/timeline"
