...
T = TypeVar("T", bound="NodeApiSetUserAttributeSubValueBody")


@attr.s(auto_attribs=True)
class NodeApiSetUserAttributeSubValueBody:
    """
    Attributes:
        attribute_name (str):
        plugin_id (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        node_api_set_user_attribute_sub_value_body = cls(
            attribute_name=attribute_name,
            plugin_id=plugin_id,
            sub_attribute_key=sub_attribute_key,
            sub_attribute_value=sub_attribute_value,
        ...
        node_api_set_user_attribute_sub_value_body.additional_properties = d
        return node_api_set_user_attribute_sub_value_body
