...
T = TypeVar("T", bound="NodeApiNewsfeedOverviewOut")


@attr.s(auto_attribs=True)
class NodeApiNewsfeedOverviewOut:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        node_api_newsfeed_overview_out = cls(
        ...
        node_api_newsfeed_overview_out.additional_properties = d
        return node_api_newsfeed_overview_out
