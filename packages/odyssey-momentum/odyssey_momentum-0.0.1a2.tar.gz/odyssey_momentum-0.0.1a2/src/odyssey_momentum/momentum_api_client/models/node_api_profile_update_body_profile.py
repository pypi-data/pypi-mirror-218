...
T = TypeVar("T", bound="NodeApiProfileUpdateBodyProfile")


@attr.s(auto_attribs=True)
class NodeApiProfileUpdateBodyProfile:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        node_api_profile_update_body_profile = cls(
        ...
        node_api_profile_update_body_profile.additional_properties = d
        return node_api_profile_update_body_profile
