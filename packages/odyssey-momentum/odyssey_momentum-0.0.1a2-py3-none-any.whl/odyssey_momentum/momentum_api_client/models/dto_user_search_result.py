...
T = TypeVar("T", bound="DtoUserSearchResult")


@attr.s(auto_attribs=True)
class DtoUserSearchResult:
    """
    Attributes:
        id (Union[Unset, str]):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        dto_user_search_result.additional_properties = d
        return dto_user_search_result
