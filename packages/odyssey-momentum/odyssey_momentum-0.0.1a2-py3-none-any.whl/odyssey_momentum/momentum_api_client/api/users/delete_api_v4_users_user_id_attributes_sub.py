...
from ...models.node_api_remove_user_attribute_sub_value_body import NodeApiRemoveUserAttributeSubValueBody
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: NodeApiRemoveUserAttributeSubValueBody,
) -> dict[str, Any]:
