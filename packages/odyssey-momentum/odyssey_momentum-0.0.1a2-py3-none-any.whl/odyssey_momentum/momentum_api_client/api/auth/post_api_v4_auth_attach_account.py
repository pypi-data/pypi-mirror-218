...
from ...models.node_api_attach_account_in_body import NodeApiAttachAccountInBody
...
def _get_kwargs(
    *,
    client: Client,
    json_body: NodeApiAttachAccountInBody,
) -> dict[str, Any]:
    url = f"{client.base_url}/api/v4/auth/attach-account"
