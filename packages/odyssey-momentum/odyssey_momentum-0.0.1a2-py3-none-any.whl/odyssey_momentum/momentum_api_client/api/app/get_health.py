...
def _parse_response(*, client: Client, response: httpx.Response) -> GetHealthResponse200 | None:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[GetHealthResponse200]:
    return Response(
