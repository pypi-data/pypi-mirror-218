...
from ...models.node_api_remove_object_attribute_sub_value_body import NodeApiRemoveObjectAttributeSubValueBody
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: NodeApiRemoveObjectAttributeSubValueBody,
) -> dict[str, Any]:
