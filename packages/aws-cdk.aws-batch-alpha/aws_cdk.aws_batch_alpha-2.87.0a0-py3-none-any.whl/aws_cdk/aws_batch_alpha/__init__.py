...
class _IEcsContainerDefinitionProxy(
    ...
    def secrets(
        ...
        :stability: experimental
        '''
        return typing.cast(typing.Optional[typing.Mapping[builtins.str, _aws_cdk_aws_secretsmanager_ceddda9d.ISecret]], jsii.get(self, "secrets"))
