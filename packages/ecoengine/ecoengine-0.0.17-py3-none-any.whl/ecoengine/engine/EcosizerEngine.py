...
class EcosizerEngine:
    ...
    def getSimResult(self, initPV=None, initST=None, minuteIntervals = 1, nDays = 3, kWhCalc = False, kGDiff = False, optimizeNLS = False):
        ...
        if kGDiff:
            ...
            print("self.system.doLoadShift", self.system.doLoadShift)
            print(self.system.getSizingResults())
            print("nls_system.doLoadShift", nls_system.doLoadShift)
            print(nls_system.getSizingResults())
