...
class UserRelateType(models.Model):
    ...
    id = models.AutoField(verbose_name='ID', primary_key=True)
    relate_key = models.CharField(verbose_name='关系搜索key', max_length=50, blank=True, null=True, default="", help_text='')
    relate_name = models.CharField(verbose_name='关系搜索名称', max_length=50, blank=True, null=True, default="", help_text='')
...
class UserRelateToUser(models.Model):
    ...
    id = models.AutoField(verbose_name='ID', primary_key=True)
    user = models.ForeignKey(BaseInfo, verbose_name='关系人', blank=True, null=True, help_text='', on_delete=models.DO_NOTHING)
...
class UserBankCards(models.Model):
    ...
    id = models.AutoField(verbose_name='ID', primary_key=True)
    user = models.ForeignKey(to="BaseInfo", verbose_name='开户人', blank=True, null=True, help_text='', on_delete=models.DO_NOTHING)
    ...
    is_default = models.IntegerField(verbose_name='是否是默认支付', choices=is_default_choices, blank=True, null=True, help_text='')
    sort = models.IntegerField(verbose_name='排序', blank=True, null=True, help_text='')
