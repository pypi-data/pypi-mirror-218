...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='data/yolov5s.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/object.yaml', help='dataset.yaml path')
