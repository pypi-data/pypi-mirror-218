...
class Flywheel:
    ...
    def upload_output_to_collection_analysis(self, cid, analysis_id, file, signed=True, **kwargs):  # noqa: E501
        """Upload an output file to analysis.
    ...
    def _ticketed_upload(self, ctype, cid, fname, metadata=None, ticket="", **params):
        ...
        if "x_accept_feature" in params:
            header_kwargs["x-accept-feature"] = params["x_accept_feature"]
