...
class DataHandler:
    ...
    def read(self, filename: str, folder: str = "input", in_attr: bool = False, **kwargs: Any) -> pd.DataFrame:
        ...
        logger.info(msg=f"START loading {os.path.join(self.data_folder, folder, filename)}", important=True)
        ...
        logger.info(msg=f"DONE loading {os.path.join(self.data_folder, folder, filename)}", important=True)
    ...
    def write(
        ...
        logger.info(msg=f"DONE writing {os.path.join(self.data_folder, folder, filename)}", important=True)
