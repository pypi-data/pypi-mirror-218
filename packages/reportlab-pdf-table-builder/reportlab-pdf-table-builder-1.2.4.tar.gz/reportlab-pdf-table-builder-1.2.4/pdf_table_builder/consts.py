...
TABLE_ROW_TYPE_IMAGE = 'row_type_image'
...
IMAGE_DOC_POSITION = 'image_doc_position'
IMAGE_DOC_POSITION_BEFORE_TABLE = 'image_doc_position_before_table'
IMAGE_DOC_POSITION_AFTER_TABLE = 'image_doc_position_after_table'
