  ...
  ;
    ...
    def upload_plugin(
        ...
        with open(install_script, "w", encoding="utf-8") as setup_script:
            ...
            # Look for a folder named 'functions', and if it exists, load all the functions in it
        ...
        if os.environ.get('OMNATA_LATEST_PLUGIN_INFO_DATABASE',None) is not None:
            ...
            self.session.sql(f"""create schema if not exists {os.environ['OMNATA_LATEST_PLUGIN_INFO_DATABASE']}.{plugin_fqn}""").collect()
