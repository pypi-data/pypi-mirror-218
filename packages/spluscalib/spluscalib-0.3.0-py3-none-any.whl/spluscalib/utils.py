...
def download_sdss16(save_file, image = None, fieldID_catalog = None):
    ...
    columns = ['RA_ICRS', 'DE_ICRS', 'objID', 'umag', 'e_umag', 'gmag',
               'e_gmag', 'rmag', 'e_rmag', 'imag', 'e_imag', 'zmag', 'e_zmag',
               'pmRA', 'pmDE', 'MJD']
    ...
    ###############################################
    # Covert coordinates from EPOCH MJD to J2000
    print("Converting coordinates to J2000")

    ra_icrs = catalog.columns['RA_ICRS']
    de_icrs = catalog.columns['DE_ICRS']
    pmra = catalog.columns['pmRA']
    pmde = catalog.columns['pmDE']
    mjd = catalog.columns['MJD']
    ...
    ##############################
    # Add RA and DEC J2000 columns
    catalog['SDSS_RAJ2000'] = ra
    catalog['SDSS_DEJ2000'] = de
...
def download_gaia3(save_file, image = None, fieldID_catalog = None):
    """
