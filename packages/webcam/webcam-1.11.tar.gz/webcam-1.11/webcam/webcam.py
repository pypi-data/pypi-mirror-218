...
class Webcam:
    def __init__(
        ...
        :param homography_matrix: np.ndarray or list[list[float, ...], ...] or None. The homography matrix to warp the frames with. 3x3 matrix.
    ...
    def read(self, transform: bool = True) -> Tuple[bool, Optional[np.ndarray]]:
        """
    ...
    def _calculate_frame_size_keeping_aspect_ratio(self, h: Optional[int], w: Optional[int]) -> Tuple[int, int]:
        """
    ...
    def _calculate_and_set_desired_resolution(self, h: Optional[int] = None, w: Optional[int] = None) -> Tuple[int, int]:
        """
    ...
    def get_magnification_hw(self, x: Optional[Union[int, float]] = None,
                                   y: Optional[Union[int, float]] = None) -> float:
        """
    ...
    def get_line_hw_magnification(self, line_xyxy: Union[np.ndarray, Tuple[Union[int, float]],
                                                                      List[Union[int, float]]],
                                  space: str = OUTPUT) -> Tuple[float, float]:
        """
        ...
        :param line_xyxy: tuple, list or np.ndarray. The line to measure, in the format (x1, y1, x2, y2).
    ...
    def output_space_points_to_input_space(self, points_xy: Union[np.ndarray,
                                                                  Tuple[Union[float, int]],
                                                                  List[Union[float, int]]]) -> np.ndarray:
        """
