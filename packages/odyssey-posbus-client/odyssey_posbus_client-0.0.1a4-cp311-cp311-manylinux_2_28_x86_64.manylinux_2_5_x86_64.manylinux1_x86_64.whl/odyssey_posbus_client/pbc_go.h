...
extern long unsigned int posbus_LockObjectResponse_State_Get(long long int handle);
extern void posbus_LockObjectResponse_State_Set(long long int handle, long unsigned int val);
