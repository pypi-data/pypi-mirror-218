...
class LockObjectResponse(go.GoClass):
	...
	@property
	def state(self):
		return _pbc.posbus_LockObjectResponse_State_Get(self.handle)
	@state.setter
	def state(self, value):
		if isinstance(value, go.GoClass):
			_pbc.posbus_LockObjectResponse_State_Set(self.handle, value.handle)
		else:
			_pbc.posbus_LockObjectResponse_State_Set(self.handle, value)
	@property
	def lock_owner(self):
