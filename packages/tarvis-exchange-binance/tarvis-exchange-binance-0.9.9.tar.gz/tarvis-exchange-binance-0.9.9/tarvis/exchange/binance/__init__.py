...
class BinanceExchange(Exchange):
                ...
                if symbol_to_assets is None:
                    ...
                    for instrument in instruments:
                        ...
                        if include_instrument:
                            ...
                            symbol_to_assets[symbol] = (base_asset, quote_asset)
                            assets_to_symbol[(base_asset, quote_asset)] = symbol

                    # Spot and margin share the same instruments
                    if self._version in [BinanceVersion.SPOT, BinanceVersion.MARGIN]:
    ...
    def place_order(
        ...
        increasing_position: bool = False,
    ):
        symbol = self._convert_assets_to_symbol(base_asset, quote_asset)
