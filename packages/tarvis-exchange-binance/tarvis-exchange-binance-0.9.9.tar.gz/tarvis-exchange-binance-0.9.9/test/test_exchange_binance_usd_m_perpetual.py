...
_TEST_CREDENTIALS = "binance_usd_m_perpetual_test_credentials"
...
exchange = BinanceExchange(_TEST_CREDENTIALS, BinanceVersion.USD_M_PERPETUAL)
...
def test_get_policy():
    ...
    assert trading_policy._quantity_decimals == 3
    # noinspection PyProtectedMember
    assert trading_policy._price_decimals == 1
