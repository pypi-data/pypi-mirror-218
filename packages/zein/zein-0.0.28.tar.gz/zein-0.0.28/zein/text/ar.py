...
class ar():
    def __init__(self, path: object = os.path.join(
        ...
        self.model_path_prompt_vectorizer = os.path.join(self.base_dir, 'models', 'prompt_vectorizer.pkl')
        self.prompt_vectorizer = pickle.load(open(self.model_path_prompt_vectorizer, "rb"))

        self.model_path_prompt_model = os.path.join(self.base_dir, 'models', 'prompt_svm_model.pkl')
