...
class Cirbe(KaitaiStruct):
    ...
    class SohAttCtrlT(KaitaiStruct):
        ...
        def _read(self):
            ...
            self._io.align_to_byte()
            self.sun_source_failover = self._io.read_u1()
            self.sun_avoid_flag = self._io.read_u1()
            self.padding_0 = self._io.read_bits_int_be(1) != 0
            self._io.align_to_byte()
            self.on_sun_flag = self._io.read_u1()
            self.momentum_too_high = self._io.read_u1()
            self.att_ctrl_active = self._io.read_u1()
