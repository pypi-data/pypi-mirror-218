...
def __get_dataname(dataAddress: str) -> str:
    endpoint = __get_api_endpoint()
    api = endpoint+'/dataset/data/name?data_address='+dataAddress
    resp = requests.get(endpoint+'/dataset/data/name?data_address='+dataAddress)
