...
def create_dataset(filepath: str, name: str, description: str) -> int:
    apiToken = __get_api_token()
    datasetDataID = __create_datasetdata(filepath=filepath, token=apiToken)
    datasetID = __create_dataset(name=name, description=description, dataID=datasetDataID, token=apiToken)
    return datasetID
...
def __create_dataset(name: str, description: str, dataID: int, token: str) -> int:
...
def __create_datasetdata(filepath: str, token: str) -> int:
