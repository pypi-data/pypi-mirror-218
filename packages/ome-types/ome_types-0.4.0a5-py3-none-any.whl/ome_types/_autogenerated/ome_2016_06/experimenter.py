...
class Experimenter(OMEType):
    ...
    annotation_ref:
    id:
    first_name: First name, sometime called christian name or given name
        or forename. [plain text string]
    middle_name: Any other names. [plain text string]
    last_name: A person's last name sometimes called surname or family
        name. [plain text string]
    email: A person's email address. [valid email address as string]
    institution: A person's Institution The organizing structure that
        people belong to other than groups.  A university, or company,
        etc. We do not specify a department element, and do not mean for
        Institution to be used in this way. We simply wish to say XXX at
        YYY.  Where YYY has a better chance of being tied to a
        geographically fixed location and of being more recognizable
        than a group of experimenters. [plain text string]
    user_name: This is the username of the experimenter (in a 'unix' or
