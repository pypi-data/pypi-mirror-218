...
from ome_types.model._shape_union import ShapeUnion
...
class ROI(OMEType):
    ...
    union:
    annotation_ref:
    description: A description for the ROI. [plain-text multi-line
        string]
    id:
    name: The Name identifies the ROI to the user. [plain-text string]
    """

    class Meta:
        namespace = "http://www.openmicroscopy.org/Schemas/OME/2016-06"

    union: ShapeUnion = Field(
        default_factory=ShapeUnion,
        metadata={
            "name": "Union",
            "type": "Element",
        }
