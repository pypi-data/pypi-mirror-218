...
from radgraph.allennlp.nn.util import get_lengths_from_binary_sequence_mask, viterbi_decode

from radgraph.allennlp_models.structured_prediction.metrics.srl_eval_scorer import (
    ...
    def forward(  # type: ignore
        ...
        if tags is not None:
            ...
            if not self.ignore_span_metric and self.span_metric is not None and not self.training:
                ...
                from radgraph.allennlp_models.structured_prediction.models.srl import (
