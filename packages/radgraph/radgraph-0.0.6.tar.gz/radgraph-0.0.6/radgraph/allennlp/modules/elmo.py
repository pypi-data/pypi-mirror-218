...
from radgraph.allennlp.data.token_indexers.elmo_indexer import (
    ELMoCharacterMapper,
    ELMoTokenCharactersIndexer,
)
from radgraph.allennlp.modules.elmo_lstm import ElmoLstm
...
class _ElmoBiLm(torch.nn.Module):
    ...
    def create_cached_cnn_embeddings(self, tokens: List[str]) -> None:
        ...
        from radgraph.allennlp.modules.token_embedders import Embedding  # type: ignore
