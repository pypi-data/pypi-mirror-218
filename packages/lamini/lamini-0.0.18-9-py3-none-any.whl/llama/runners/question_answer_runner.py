...
class QuestionAnswerModel:
    ...
    def get_answer(self, question: str) -> str:
        ...
        answer_object = self.llm(
            input=question_object, output_type=Answer, model_name=self.model_name
        )
    ...
    def get_answers(self, questions: List[str]) -> List[str]:
        ...
        answer_objects = self.llm(
            input=question_objects, output_type=Answer, model_name=self.model_name
        )
    ...
    def train(
        ...
        """
        qa_pairs = self.question_answer[:100]
