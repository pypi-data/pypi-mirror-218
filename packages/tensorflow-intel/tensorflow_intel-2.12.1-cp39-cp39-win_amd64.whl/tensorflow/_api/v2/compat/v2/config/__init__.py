...
from tensorflow.python.eager.polymorphic_function.quarantine import experimental_functions_run_eagerly
from tensorflow.python.eager.polymorphic_function.quarantine import experimental_run_functions_eagerly
