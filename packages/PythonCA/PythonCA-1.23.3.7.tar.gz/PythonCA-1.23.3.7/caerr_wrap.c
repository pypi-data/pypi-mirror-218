...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__caerr

#else
#  define SWIG_init    init_caerr

#endif
#define SWIG_name    "_caerr"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_ca_message(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ca_message",&obj0)) SWIG_fail;
  ecode1 = SWIG_AsVal_long(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "ca_message" "', argument " "1"" of type '" "long""'");
  } 
  arg1 = (long)(val1);
  result = (char *)ca_message(arg1);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"ca_message", _wrap_ca_message, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
